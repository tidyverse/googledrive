...
Use `drive_memo()` in combination with `cli_format_dribble()`, which formats individual Drive files and makes them into `"*"` bullets.
...
x <- dat[1, ]
drive_memo(c("File VERBED:", cli_format_dribble(x)))
