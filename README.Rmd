...
Revisions of Google Documents, Sheets, and Presentations can be published online. By default, `drive_publish()` will publish your most recent revision. Running this function will update a tibble in
your `gfile` object with publication information. You can also check your publication status by running `drive_check_publish()`.
