...
#'
#' @param dir A character string. The name of the folder you would like to create.
#' @param path A character string. The path where you would like the folder on your Google Drive.
#' @template verbose
#'
