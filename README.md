...
#> * <chr>                        <chr>         <list>
#> 1   def 0B0Gh-SuuA2nTem5fMkhUYmsyb1U    <list [30]>

## let's grab that file id and retrieve it that way
x$id
#> [1] "0B0Gh-SuuA2nTem5fMkhUYmsyb1U"
drive_get(x$id)
#> # A tibble: 1 x 3
#>    name                           id files_resource
#> * <chr>                        <chr>         <list>
...
#>                  name                           id files_resource
#> *               <chr>                        <chr>         <list>
#> 1 README-chickwts.csv 0B0Gh-SuuA2nTWkdyVjl4Rkcxc1k    <list [36]>
```
...
drive_chickwts <- drive_chickwts %>%
  drive_delete()
#> Files deleted:
#>   * README-chickwts.csv: 0B0Gh-SuuA2nTWkdyVjl4Rkcxc1k
...
#>                <dttm>    <chr>     <lgl>        <lgl>
#> 1 2017-06-28 10:15:28        1      TRUE         TRUE
```
...
drive_chickwts %>%
  drive_share_link()
#> [1] "https://docs.google.com/spreadsheets/d/1ShRTWdzIg2Uj-6DlmlLfHP84OB8KmPIloVZgYfpR6LA/edit?usp=drivesdk"
```
...
drive_chickwts %>%
  drive_delete()
#> Files deleted:
#>   * README-chickwts.csv: 1ShRTWdzIg2Uj-6DlmlLfHP84OB8KmPIloVZgYfpR6LA
boring %>%
  drive_delete()
#> Files deleted:
#>   * boring-text.txt: 0B0Gh-SuuA2nTMzkxTFpxcDhGZVE
```
