...
#> Local file:
#>   * /Users/jenny/resources/R/library_3.6/googledrive/extdata/chicken.csv
#> uploaded into Drive file:
#>   * README-chicken.csv: 1eWbJHTeOIWqAtF8UH59AsulMKPPx0Ho5
#> with MIME type:
#>   * text/csv
#> # A tibble: 1 x 3
#>   name               id                                drive_resource   
#> * <chr>              <chr>                             <list>           
#> 1 README-chicken.csv 1eWbJHTeOIWqAtF8UH59AsulMKPPx0Ho5 <named list [38]>
```
...
#>   * /Users/jenny/resources/R/library_3.6/googledrive/extdata/chicken.csv
#> uploaded into Drive file:
#>   * README-chicken-sheet: 1wJ5uR8lYxx_1TWS3VbtcPJeZpAWacwIr8DhILjVlWIw
#> with MIME type:
...
#> 1 README-chi… FALSE  1wJ5uR8lYxx_1TWS3Vb… <named list [3… <named list [2]>
```
...
#>   name        shared id                   drive_resource  permissions_reso…
#> * <chr>       <lgl>  <chr>                <list>          <list>           
#> 1 README-chi… TRUE   1wJ5uR8lYxx_1TWS3Vb… <named list [3… <named list [2]>
```
...
#> 1 READ… FALSE     TRUE   1wJ5… <named list [… <named list [2]>
...
#>   name  published shared id    drive_resource permissions_res…
#> * <chr> <lgl>     <lgl>  <chr> <list>         <list>          
#> 1 READ… TRUE      TRUE   1wJ5… <named list [… <named list [2]>
#> # … with 1 more variable: revision_resource <list>
```
