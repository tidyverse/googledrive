...
#'   that Drive does not have a 1-to-1 relationship between filepaths and files,
...
#'     zero or one, move a pre-existing file to the trash, then carry on. Throw
#'     an error if two or more pre-existing files are found,
