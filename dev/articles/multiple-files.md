...
#> Created Drive file:
#> • upload-into-me-article-demo <id: 1zGjkosacD39MwlFGxHTnJm1gJ32QGZsV>
#> With MIME type:
...
#>   <chr>           <drv_id>                          <list>           
#> 1 r_logo.jpg      1QOgSRDhkQh0UPUhNWbeqcSfm7YI4UzJi <named list [45]>
#> 2 r_about.html    1u8XSJeUQezp-dShWPRas073eDpZfH5tc <named list [44]>
#> 3 markdown.md     1B-5JVjrX_M-IzCq7APmvo8PvqTvLxuSW <named list [43]>
#> 4 imdb_latin1.csv 1qttcMruIUlXvNvvuWXexIpv_r3jml93V <named list [43]>
#> 5 chicken.txt     105FDSaT58AGekVE0cuvqnT-s_vLwlSXe <named list [44]>
#> 6 chicken.pdf     1TGe1H8hEdTpV0qeOTyZAnhNO0AhbkBpl <named list [44]>
#> 7 chicken.jpg     1wVCnbF2PZXogzZEATN3h2SNl_rHAvBWV <named list [45]>
#> 8 chicken.csv     1a3b3Oem4WyeNTMxnZlLAouyv0OUNN-r1 <named list [43]>
```
...
#>   name            id                                drive_resource   
#>   <chr>           <drv_id>                          <list>           
#> 1 chicken.csv     1a3b3Oem4WyeNTMxnZlLAouyv0OUNN-r1 <named list [43]>
#> 2 chicken.jpg     1wVCnbF2PZXogzZEATN3h2SNl_rHAvBWV <named list [45]>
#> 3 chicken.pdf     1TGe1H8hEdTpV0qeOTyZAnhNO0AhbkBpl <named list [43]>
#> 4 chicken.txt     105FDSaT58AGekVE0cuvqnT-s_vLwlSXe <named list [43]>
#> 5 imdb_latin1.csv 1qttcMruIUlXvNvvuWXexIpv_r3jml93V <named list [43]>
#> 6 markdown.md     1B-5JVjrX_M-IzCq7APmvo8PvqTvLxuSW <named list [43]>
#> 7 r_about.html    1u8XSJeUQezp-dShWPRas073eDpZfH5tc <named list [43]>
#> 8 r_logo.jpg      1QOgSRDhkQh0UPUhNWbeqcSfm7YI4UzJi <named list [45]>
```
...
#> 2026-02-23_chicken.csv
#> 2026-02-23_chicken.jpg
#> 2026-02-23_chicken.pdf
#> 2026-02-23_chicken.txt
#> 2026-02-23_imdb_latin1.csv
#> 2026-02-23_markdown.md
#> 2026-02-23_r_about.html
#> 2026-02-23_r_logo.jpg
files_dribble <- map2_dfr(files, new_names, drive_rename)
#> Original file:
#> • chicken.csv <id: 1a3b3Oem4WyeNTMxnZlLAouyv0OUNN-r1>
#> Has been renamed:
#> • 2026-02-23_chicken.csv <id: 1a3b3Oem4WyeNTMxnZlLAouyv0OUNN-r1>
#> Original file:
#> • chicken.jpg <id: 1wVCnbF2PZXogzZEATN3h2SNl_rHAvBWV>
#> Has been renamed:
#> • 2026-02-23_chicken.jpg <id: 1wVCnbF2PZXogzZEATN3h2SNl_rHAvBWV>
#> Original file:
#> • chicken.pdf <id: 1TGe1H8hEdTpV0qeOTyZAnhNO0AhbkBpl>
#> Has been renamed:
#> • 2026-02-23_chicken.pdf <id: 1TGe1H8hEdTpV0qeOTyZAnhNO0AhbkBpl>
#> Original file:
#> • chicken.txt <id: 105FDSaT58AGekVE0cuvqnT-s_vLwlSXe>
#> Has been renamed:
#> • 2026-02-23_chicken.txt <id: 105FDSaT58AGekVE0cuvqnT-s_vLwlSXe>
#> Original file:
#> • imdb_latin1.csv <id: 1qttcMruIUlXvNvvuWXexIpv_r3jml93V>
#> Has been renamed:
#> • 2026-02-23_imdb_latin1.csv <id: 1qttcMruIUlXvNvvuWXexIpv_r3jml93V>
#> Original file:
#> • markdown.md <id: 1B-5JVjrX_M-IzCq7APmvo8PvqTvLxuSW>
#> Has been renamed:
#> • 2026-02-23_markdown.md <id: 1B-5JVjrX_M-IzCq7APmvo8PvqTvLxuSW>
#> Original file:
#> • r_about.html <id: 1u8XSJeUQezp-dShWPRas073eDpZfH5tc>
#> Has been renamed:
#> • 2026-02-23_r_about.html <id: 1u8XSJeUQezp-dShWPRas073eDpZfH5tc>
#> Original file:
#> • r_logo.jpg <id: 1QOgSRDhkQh0UPUhNWbeqcSfm7YI4UzJi>
#> Has been renamed:
#> • 2026-02-23_r_logo.jpg <id: 1QOgSRDhkQh0UPUhNWbeqcSfm7YI4UzJi>
```
...
#>   name                       id       drive_resource   
#>   <chr>                      <drv_id> <list>           
#> 1 2026-02-23_r_logo.jpg      1QOgSRD… <named list [45]>
#> 2 2026-02-23_r_about.html    1u8XSJe… <named list [44]>
#> 3 2026-02-23_markdown.md     1B-5JVj… <named list [43]>
#> 4 2026-02-23_imdb_latin1.csv 1qttcMr… <named list [43]>
#> 5 2026-02-23_chicken.txt     105FDSa… <named list [44]>
#> 6 2026-02-23_chicken.pdf     1TGe1H8… <named list [44]>
#> 7 2026-02-23_chicken.jpg     1wVCnbF… <named list [45]>
#> 8 2026-02-23_chicken.csv     1a3b3Oe… <named list [43]>
```
...
#>   name                       id       drive_resource   
#>   <chr>                      <drv_id> <list>           
#> 1 2026-02-23_chicken.csv     1a3b3Oe… <named list [43]>
#> 2 2026-02-23_chicken.jpg     1wVCnbF… <named list [45]>
#> 3 2026-02-23_chicken.pdf     1TGe1H8… <named list [44]>
#> 4 2026-02-23_chicken.txt     105FDSa… <named list [44]>
#> 5 2026-02-23_imdb_latin1.csv 1qttcMr… <named list [43]>
#> 6 2026-02-23_markdown.md     1B-5JVj… <named list [43]>
#> 7 2026-02-23_r_about.html    1u8XSJe… <named list [44]>
#> 8 2026-02-23_r_logo.jpg      1QOgSRD… <named list [45]>
```
