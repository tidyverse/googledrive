...
#> • chicken-perm-article.txt <id: 19c1lwvYkyV_WPuI6zae5Agd3b0z6NEVK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  19c1lwv… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   19c1lwv… <named list>   <named list [2]>
```
