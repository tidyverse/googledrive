...
#> • chicken-perm-article.txt <id: 1_wA0KZMgrluejWi8PPUtSKKeAhy5u18r>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1_wA0KZ… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1_wA0KZ… <named list>   <named list [2]>
```
