...
#> • chicken-perm-article.txt <id: 1-wPjrXk3xQVpGdKh0BX43ZAMVJKuVA0e>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1-wPjrX… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1-wPjrX… <named list>   <named list [2]>
```
