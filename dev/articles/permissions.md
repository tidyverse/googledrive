...
#> • chicken-perm-article.txt <id: 1A2r412rs1h6df22qLKvq40Hd5gGou9bS>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1A2r412… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1A2r412… <named list>   <named list [2]>
```
