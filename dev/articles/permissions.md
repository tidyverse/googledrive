...
#> • chicken-perm-article.txt <id: 1n-1Q6nurOyHkaaq7WJyCzeVbzmdTx6q2>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1n-1Q6n… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1n-1Q6n… <named list>   <named list [2]>
```
