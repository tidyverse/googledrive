...
#> • chicken-perm-article.txt <id: 1PSX8fkXR0vBCfFOJ3sfycZvxYk0qPI7M>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1PSX8fk… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1PSX8fk… <named list>   <named list [2]>
```
