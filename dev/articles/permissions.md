...
#> • chicken-perm-article.txt <id: 16udSwOh7EFDa0rk-wLCAQUvn4DBCGZSf>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  16udSwO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   16udSwO… <named list>   <named list [2]>
```
