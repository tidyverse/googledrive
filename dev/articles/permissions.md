...
#> • chicken-perm-article.txt <id: 1dZYWO-fKBQyMqm0iqsG1BHCOce3CwD_0>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1dZYWO-… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1dZYWO-… <named list>   <named list [2]>
```
