...
#> • chicken-perm-article.txt <id: 10qnQK35z3YQbgM9-tO704ldH3eGZIZcZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10qnQK3… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10qnQK3… <named list>   <named list [2]>
```
