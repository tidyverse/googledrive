...
#> • chicken-perm-article.txt <id: 1PMq7P_UhXVReiFwbFQgK_jLL86EbBNes>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1PMq7P_… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1PMq7P_… <named list>   <named list [2]>
```
