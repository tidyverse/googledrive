...
#> • chicken-perm-article.txt <id: 1NK8PMOq882z2lHmTuKasZwFlXh91OXwd>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1NK8PMO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1NK8PMO… <named list>   <named list [2]>
```
