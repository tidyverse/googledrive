...
#> • chicken-perm-article.txt <id: 12lWzeKKY-A-X7MQi2UtIhKbAI7rU0K36>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  12lWzeK… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   12lWzeK… <named list>   <named list [2]>
```
