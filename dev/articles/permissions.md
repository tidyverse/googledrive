...
#> • chicken-perm-article.txt <id: 15WywG5TsBtCyGEj54AKnqai-HXm7UtC6>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  15WywG5… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   15WywG5… <named list>   <named list [2]>
```
