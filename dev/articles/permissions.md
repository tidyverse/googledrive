...
#> • chicken-perm-article.txt <id: 1BHpk-zw-Py2fStzQKsyfTxb78QW3Bnlt>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1BHpk-z… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1BHpk-z… <named list>   <named list [2]>
```
