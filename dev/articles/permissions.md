...
#> • chicken-perm-article.txt <id: 1Y7cGnLjyC7ev3YmjWmPsExSb8a7VmPoU>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Y7cGnL… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Y7cGnL… <named list>   <named list [2]>
```
