...
#> • chicken-perm-article.txt <id: 1oAR9iTH4MXsQsZHd_AbKi9uHisQIupLh>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1oAR9iT… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1oAR9iT… <named list>   <named list [2]>
```
