...
#> • chicken-perm-article.txt <id: 1u-ndImhiG4l4qhT2fE4vkjXbgkOD0X2n>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1u-ndIm… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1u-ndIm… <named list>   <named list [2]>
```
