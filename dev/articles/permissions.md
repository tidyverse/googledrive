...
#> • chicken-perm-article.txt <id: 1volz_gNtx4X6g4ogm6VD_YrNvb6fXHiv>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1volz_g… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1volz_g… <named list>   <named list [2]>
```
