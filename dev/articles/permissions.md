...
#> • chicken-perm-article.txt <id: 1ycwF8Z0ygQvtVXJV-7F-873TDVuYKIIN>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ycwF8Z… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ycwF8Z… <named list>   <named list [2]>
```
