...
#> • chicken-perm-article.txt <id: 1O7A3q2Hwr1t4iN0-yjpdXfz-A6PGN9BT>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1O7A3q2… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1O7A3q2… <named list>   <named list [2]>
```
