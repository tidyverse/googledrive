...
#> • chicken-perm-article.txt <id: 1MZTP5HjIlko3i3po8wdGNcj90DK8yMvw>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1MZTP5H… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1MZTP5H… <named list>   <named list [2]>
```
