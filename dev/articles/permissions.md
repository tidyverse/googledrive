...
#> • chicken-perm-article.txt <id: 1_g4hSgIGw9qcxzSC6o_rtjBj0OT1bVWk>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1_g4hSg… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1_g4hSg… <named list>   <named list [2]>
```
