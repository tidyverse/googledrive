...
#> • chicken-perm-article.txt <id: 1KKpRhCh6wi_6xjuPjf8RTaliEur2GBiv>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1KKpRhC… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1KKpRhC… <named list>   <named list [2]>
```
