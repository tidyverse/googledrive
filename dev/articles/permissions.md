...
#> • chicken-perm-article.txt <id: 1qpOTp9YXMjt7uPtwmjAdbjoxYz1H4CXr>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1qpOTp9… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1qpOTp9… <named list>   <named list [2]>
```
