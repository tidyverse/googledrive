...
#> • chicken-perm-article.txt <id: 1kZC69k_aMBS0veEBPJKJwMtfrYQE8ixh>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1kZC69k… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1kZC69k… <named list>   <named list [2]>
```
