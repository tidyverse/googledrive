...
#> • chicken-perm-article.txt <id: 1187FPFzIsoDrH1vvwdKCNR5AEhM7J3gU>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1187FPF… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1187FPF… <named list>   <named list [2]>
```
