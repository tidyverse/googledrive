...
#> • chicken-perm-article.txt <id: 1Ywm9zB2rmVXDYR_mWdVKO5gHzKv9k1Dl>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Ywm9zB… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Ywm9zB… <named list>   <named list [2]>
```
