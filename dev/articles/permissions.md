...
#> • chicken-perm-article.txt <id: 1bJzmEPG_AaYqkqQtlbj9_2zKoUS3aCFn>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1bJzmEP… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1bJzmEP… <named list>   <named list [2]>
```
