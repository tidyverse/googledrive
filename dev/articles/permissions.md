...
#> • chicken-perm-article.txt <id: 10dHUYj560iDZBpxslUPRpob4Jdm_07rq>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10dHUYj… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10dHUYj… <named list>   <named list [2]>
```
