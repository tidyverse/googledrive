...
#> • chicken-perm-article.txt <id: 1mf5gIyktb-JSPpH0Rb5MZA05Au5-zdzX>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1mf5gIy… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1mf5gIy… <named list>   <named list [2]>
```
