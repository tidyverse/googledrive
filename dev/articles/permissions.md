...
#> • chicken-perm-article.txt <id: 1-uiPv9Uja_n_iH5OAOBCTipfkHklYH1N>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1-uiPv9… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1-uiPv9… <named list>   <named list [2]>
```
