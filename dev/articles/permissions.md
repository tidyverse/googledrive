...
#> • chicken-perm-article.txt <id: 1hrmpNcL_CJ35p6m8yjVSpqa_ES0jUb5u>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1hrmpNc… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1hrmpNc… <named list>   <named list [2]>
```
