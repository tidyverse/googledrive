...
#> • chicken-perm-article.txt <id: 101uiafzfGmkDQNFGlo_ZGekZJ2j4OvGV>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  101uiaf… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   101uiaf… <named list>   <named list [2]>
```
