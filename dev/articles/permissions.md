...
#> • chicken-perm-article.txt <id: 1FF4dhx6zvzWA4s_qGNW-l7QmGnq82SzZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1FF4dhx… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1FF4dhx… <named list>   <named list [2]>
```
