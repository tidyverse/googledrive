...
#> • chicken-perm-article.txt <id: 1XU3UPbyLvWYu1cpmO1uWbXwnEf48aIkj>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1XU3UPb… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1XU3UPb… <named list>   <named list [2]>
```
