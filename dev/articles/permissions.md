...
#> • chicken-perm-article.txt <id: 1rbgzzaR5oyhd9TULjIRkOmGrI6jEc5t_>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1rbgzza… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1rbgzza… <named list>   <named list [2]>
```
