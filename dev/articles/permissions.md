...
#> • chicken-perm-article.txt <id: 14KqlDDOrpHxGC3nJXLZOXbQ5kMUVL5qY>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14KqlDD… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14KqlDD… <named list>   <named list [2]>
```
