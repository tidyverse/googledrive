...
#> • chicken-perm-article.txt <id: 1CsyGOUEnckTLFmeIhj_cHSiX2h_Rtzwr>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1CsyGOU… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1CsyGOU… <named list>   <named list [2]>
```
