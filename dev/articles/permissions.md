...
#> • chicken-perm-article.txt <id: 10GfCkYjPxVQI4fD2l2mN656rmaw7qHaF>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10GfCkY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10GfCkY… <named list>   <named list [2]>
```
