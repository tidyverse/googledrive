...
#> • chicken-perm-article.txt <id: 1qShz0o-Ie9KqaxKo7Vj5UEEf86H6947Z>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1qShz0o… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1qShz0o… <named list>   <named list [2]>
```
