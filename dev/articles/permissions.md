...
#> • chicken-perm-article.txt <id: 1Q4BfASElYD3AhKRn5w9zJMNieG6F1828>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Q4BfAS… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Q4BfAS… <named list>   <named list [2]>
```
