...
#> • chicken-perm-article.txt <id: 1QTqySWIkTsfn0NmsH7HDpfWde1pAawW5>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1QTqySW… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1QTqySW… <named list>   <named list [2]>
```
