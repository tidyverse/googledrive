...
#> • chicken-perm-article.txt <id: 1cMF3HOK8SY47cvjanueHWNAlu_HQVTIT>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1cMF3HO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1cMF3HO… <named list>   <named list [2]>
```
