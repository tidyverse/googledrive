...
#> • chicken-perm-article.txt <id: 1zi60POPq0I8GFFh2tRAgN1be62S_pjr7>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1zi60PO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1zi60PO… <named list>   <named list [2]>
```
