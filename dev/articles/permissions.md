...
#> • chicken-perm-article.txt <id: 1YGNb2aL2xwylUU91ESVCFew8b7ZI0bBy>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1YGNb2a… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1YGNb2a… <named list>   <named list [2]>
```
