...
#> • chicken-perm-article.txt <id: 1HjbSHeUBmOf1dlmvdoeWGje3gf8758Sv>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1HjbSHe… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1HjbSHe… <named list>   <named list [2]>
```
