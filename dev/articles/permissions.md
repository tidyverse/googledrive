...
#> • chicken-perm-article.txt <id: 1lUbS6W6GiN1QqKkOHgrAwPAWuQ9fTcGH>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1lUbS6W… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1lUbS6W… <named list>   <named list [2]>
```
