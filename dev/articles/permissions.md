...
#> • chicken-perm-article.txt <id: 1y2A-r5gPiz24jcIV6tEZXk77jXLGZ8NU>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1y2A-r5… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1y2A-r5… <named list>   <named list [2]>
```
