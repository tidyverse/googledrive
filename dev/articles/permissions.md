...
#> • chicken-perm-article.txt <id: 1RO9Z80C1HcM0Pk6YmeSpZM0SF6rvQ_Zi>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1RO9Z80… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1RO9Z80… <named list>   <named list [2]>
```
