...
#> • chicken-perm-article.txt <id: 1LJ2y0Uy9MoGwLAsTnqI4TwKf9fodWcNh>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LJ2y0U… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LJ2y0U… <named list>   <named list [2]>
```
