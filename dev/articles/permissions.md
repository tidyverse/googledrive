...
#> • chicken-perm-article.txt <id: 1SJl6bx6F745Te-1RPaj-A_ST2sgst255>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1SJl6bx… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1SJl6bx… <named list>   <named list [2]>
```
