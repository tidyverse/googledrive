...
#> • chicken-perm-article.txt <id: 1-K2ZMfN74hG14k2TW_a0UZkMHwUhmZvF>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1-K2ZMf… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1-K2ZMf… <named list>   <named list [2]>
```
