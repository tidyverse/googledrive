...
#> • chicken-perm-article.txt <id: 1fnCQOCAElCjkQx1XtjodzYGVQ7k9BB3p>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1fnCQOC… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1fnCQOC… <named list>   <named list [2]>
```
