...
#> • chicken-perm-article.txt <id: 14F0n2trlNv0bHmQHjw6EomYr9KRWizLK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14F0n2t… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14F0n2t… <named list>   <named list [2]>
```
