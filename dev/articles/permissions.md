...
#> • chicken-perm-article.txt <id: 1JaUdQiPU3gSeSLzy8l-7AICqZT-QSeXL>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1JaUdQi… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1JaUdQi… <named list>   <named list [2]>
```
