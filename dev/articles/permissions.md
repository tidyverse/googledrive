...
#> • chicken-perm-article.txt <id: 1BdL9kW9-FHKJ0f5-PXPLecsCuIRXAWlk>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1BdL9kW… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1BdL9kW… <named list>   <named list [2]>
```
