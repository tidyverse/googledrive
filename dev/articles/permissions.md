...
#> • chicken-perm-article.txt <id: 1eV64VeQ0pPwu0pDRAz3W2dALlYhgsQdr>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1eV64Ve… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1eV64Ve… <named list>   <named list [2]>
```
