...
#> • chicken-perm-article.txt <id: 1Xqpmz01_NCZugimoUYZ9LqPQ7XCkL5mn>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Xqpmz0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Xqpmz0… <named list>   <named list [2]>
```
