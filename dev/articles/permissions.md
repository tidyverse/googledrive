...
#> • chicken-perm-article.txt <id: 1Zc-Vy5Aw8IcMqllq3Shr7CWe419RWoMp>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Zc-Vy5… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Zc-Vy5… <named list>   <named list [2]>
```
