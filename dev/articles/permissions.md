...
#> • chicken-perm-article.txt <id: 1c5kikSDramLccMa1cLVNhbnOUt25v7qz>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1c5kikS… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1c5kikS… <named list>   <named list [2]>
```
