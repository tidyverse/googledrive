...
#> • chicken-perm-article.txt <id: 1NiqWEG-m7R_-cWyz9khhIJHXfs2a2HKH>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1NiqWEG… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1NiqWEG… <named list>   <named list [2]>
```
