...
#> • chicken-perm-article.txt <id: 1OYk4BMwSjPwq1moTHZXDBzaoI0sFuq5t>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1OYk4BM… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1OYk4BM… <named list>   <named list [2]>
```
