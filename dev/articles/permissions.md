...
#> • chicken-perm-article.txt <id: 1ySkUW8TNwIHdUlqCXUwEH4B9yjAb_cp2>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ySkUW8… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ySkUW8… <named list>   <named list [2]>
```
