...
#> • chicken-perm-article.txt <id: 1bvee48-EDlv8CJhHdYy7ozqK4TuGc0Sh>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1bvee48… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1bvee48… <named list>   <named list [2]>
```
