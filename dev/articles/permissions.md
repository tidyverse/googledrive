...
#> • chicken-perm-article.txt <id: 1xhZH6P-sDUei6frE1ZeEVN1BDEek51Dd>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1xhZH6P… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1xhZH6P… <named list>   <named list [2]>
```
