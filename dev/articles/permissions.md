...
#> • chicken-perm-article.txt <id: 1yc0elg8D598FI9hcqFkf95f5VZiy7L26>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1yc0elg… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1yc0elg… <named list>   <named list [2]>
```
