...
#> • chicken-perm-article.txt <id: 1K1gmSAJL1zBlaX1KOPVc6LJqy75j6-0O>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1K1gmSA… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1K1gmSA… <named list>   <named list [2]>
```
