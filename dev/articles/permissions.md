...
#> • chicken-perm-article.txt <id: 1LBP0W4h5hr0YcF8XeuxWFIET0IetgzzZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LBP0W4… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LBP0W4… <named list>   <named list [2]>
```
