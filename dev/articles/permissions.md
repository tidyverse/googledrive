...
#> • chicken-perm-article.txt <id: 14V9T5qJBgviIIKjIeW9bg5LNtsTHAIFf>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14V9T5q… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14V9T5q… <named list>   <named list [2]>
```
