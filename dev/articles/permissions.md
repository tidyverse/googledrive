...
#> • chicken-perm-article.txt <id: 14w8CmtPoGbtXfHFwZB9iDJxLTFRCRUnA>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14w8Cmt… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14w8Cmt… <named list>   <named list [2]>
```
