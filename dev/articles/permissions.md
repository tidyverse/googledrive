...
#> • chicken-perm-article.txt <id: 1otOlAGArJH_NYESLu4x7mumxiepPlIJW>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1otOlAG… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1otOlAG… <named list>   <named list [2]>
```
