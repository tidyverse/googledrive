...
#> • chicken-perm-article.txt <id: 1y4pnixJR6C0_JoTQ_yNvT0zZ_TOfUYp2>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1y4pnix… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1y4pnix… <named list>   <named list [2]>
```
