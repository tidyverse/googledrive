...
#> • chicken-perm-article.txt <id: 1ATGc1Q5r7K_K_CiocR6y5Io9BfT_1d37>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ATGc1Q… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ATGc1Q… <named list>   <named list [2]>
```
