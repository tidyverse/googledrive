...
#> • chicken-perm-article.txt <id: 1TZ0CoYuEsDWB4D38b0LGzfi1FUds54_g>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1TZ0CoY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1TZ0CoY… <named list>   <named list [2]>
```
