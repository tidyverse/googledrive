...
#> • chicken-perm-article.txt <id: 1jJKdhlbh-z21fXwF8-1TfVWhM8ksTWVZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1jJKdhl… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1jJKdhl… <named list>   <named list [2]>
```
