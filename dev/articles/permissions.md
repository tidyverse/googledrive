...
#> • chicken-perm-article.txt <id: 1Y3rpR6gG9VRYt1uxbh2MWTdoRxirW-0R>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Y3rpR6… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Y3rpR6… <named list>   <named list [2]>
```
