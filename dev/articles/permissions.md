...
#> • chicken-perm-article.txt <id: 1XhCUu72ESphUMZALgJE62foXX0Ixdc5l>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1XhCUu7… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1XhCUu7… <named list>   <named list [2]>
```
