...
#> • chicken-perm-article.txt <id: 1Plw27Yt4xFiFVgv3eDtuJ3i09vnp-sww>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Plw27Y… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Plw27Y… <named list>   <named list [2]>
```
