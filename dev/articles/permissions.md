...
#> • chicken-perm-article.txt <id: 1eK5ut6NI00Vs6YY5HdQEhBCQmK-EVLD1>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1eK5ut6… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1eK5ut6… <named list>   <named list [2]>
```
