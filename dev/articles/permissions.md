...
#> • chicken-perm-article.txt <id: 15Za0_I2EeBSiU6YZPoK0LfgjOxJdvQqr>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  15Za0_I… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   15Za0_I… <named list>   <named list [2]>
```
