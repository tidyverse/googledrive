...
#> • chicken-perm-article.txt <id: 1QFLvAsxtefD34pc-G5uvW7SECXHK8eBa>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1QFLvAs… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1QFLvAs… <named list>   <named list [2]>
```
