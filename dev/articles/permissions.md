...
#> • chicken-perm-article.txt <id: 13AJyLTaGrrOb1yKdIR2AIHQCGgl3rG-S>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  13AJyLT… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   13AJyLT… <named list>   <named list [2]>
```
