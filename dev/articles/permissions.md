...
#> • chicken-perm-article.txt <id: 1b9SWnatRyOw239mcq0ZJsnvD8JB4qpjC>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1b9SWna… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1b9SWna… <named list>   <named list [2]>
```
