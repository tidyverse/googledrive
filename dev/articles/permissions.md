...
#> • chicken-perm-article.txt <id: 1GQW6kD2kR7NX0fHuP6yYOEZOS9_lLle4>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1GQW6kD… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1GQW6kD… <named list>   <named list [2]>
```
