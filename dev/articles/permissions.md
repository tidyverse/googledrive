...
#> • chicken-perm-article.txt <id: 1jIy4d2C2rg6L3GfLWM0elzbEfN8kQsIP>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1jIy4d2… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1jIy4d2… <named list>   <named list [2]>
```
