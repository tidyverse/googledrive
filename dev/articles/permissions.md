...
#> • chicken-perm-article.txt <id: 1H0DJClxoSvIwy4ofA651wEa3HTbaZu5B>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1H0DJCl… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1H0DJCl… <named list>   <named list [2]>
```
