...
#> • chicken-perm-article.txt <id: 1hwr4BAAG2Nssd92b79PyuVwJrb939Fb2>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1hwr4BA… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1hwr4BA… <named list>   <named list [2]>
```
