...
#> • chicken-perm-article.txt <id: 1297yT5E9x6JMLb4xz3YqVIcWj68aWPSM>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1297yT5… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1297yT5… <named list>   <named list [2]>
```
