...
#> • chicken-perm-article.txt <id: 1Go2YejkSNAMGqrSXxASC8znJ6o8opYsy>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Go2Yej… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Go2Yej… <named list>   <named list [2]>
```
