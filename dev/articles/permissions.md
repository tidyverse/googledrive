...
#> • chicken-perm-article.txt <id: 15GMhNssEPIvkOQrKln_fPT_CB3h382Eb>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  15GMhNs… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   15GMhNs… <named list>   <named list [2]>
```
