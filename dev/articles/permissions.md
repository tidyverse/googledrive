...
#> • chicken-perm-article.txt <id: 13ns_U5ZCqX2IiYXIx3RdK6mVbAN1vD4R>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  13ns_U5… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   13ns_U5… <named list>   <named list [2]>
```
