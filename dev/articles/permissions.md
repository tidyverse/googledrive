...
#> • chicken-perm-article.txt <id: 1Gtqc_POHDm7PgCm_w8NI1AgCgljZMbHI>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Gtqc_P… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Gtqc_P… <named list>   <named list [2]>
```
