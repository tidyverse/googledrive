...
#> • chicken-perm-article.txt <id: 1-SF1mpy6bG_mvKz2m69gnD9lIq-F90qu>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1-SF1mp… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1-SF1mp… <named list>   <named list [2]>
```
