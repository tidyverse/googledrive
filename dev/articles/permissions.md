...
#> • chicken-perm-article.txt <id: 10P6bP2PTeRjoX5vz5Aeoo2xaPfvZmVfK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10P6bP2… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10P6bP2… <named list>   <named list [2]>
```
