...
#> • chicken-perm-article.txt <id: 1x5vd-RLFbHnw0DOKusk9vhMuXLkBMPfx>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1x5vd-R… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1x5vd-R… <named list>   <named list [2]>
```
