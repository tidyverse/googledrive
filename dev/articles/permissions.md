...
#> • chicken-perm-article.txt <id: 1878a9SmtFE_8GBXqYpV8-ZKps8zv4Tg2>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1878a9S… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1878a9S… <named list>   <named list [2]>
```
