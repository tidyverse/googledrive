...
#> • chicken-perm-article.txt <id: 1VOIHVy2sJHK_Z0NaLpKln3DEj5X8QN_M>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1VOIHVy… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1VOIHVy… <named list>   <named list [2]>
```
