...
#> • chicken-perm-article.txt <id: 11i2u4ukPYArlAfivEoYOgs_WUDyzxacq>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  11i2u4u… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   11i2u4u… <named list>   <named list [2]>
```
