...
#> • chicken-perm-article.txt <id: 1NHsTFzSR7w6u8D9gqM-Z1E0NUtRq8R6D>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1NHsTFz… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1NHsTFz… <named list>   <named list [2]>
```
