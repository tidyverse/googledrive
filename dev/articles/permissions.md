...
#> • chicken-perm-article.txt <id: 1LlnrbHXEHVWrZf-r8UT9Ca-r_zJM0NEz>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LlnrbH… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LlnrbH… <named list>   <named list [2]>
```
