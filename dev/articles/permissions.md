...
#> • chicken-perm-article.txt <id: 1Oe-AtND0PNkXUAfw_4NJ6WxrjU6AM9Wa>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Oe-AtN… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Oe-AtN… <named list>   <named list [2]>
```
