...
#> • chicken-perm-article.txt <id: 199lIvzuWbdY9Fn-x6K6K1LE9UZf_I8wK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  199lIvz… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   199lIvz… <named list>   <named list [2]>
```
