...
#> • chicken-perm-article.txt <id: 1i9rnP4UM9oKscBpv6d2n88RLsYBa_9FX>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1i9rnP4… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1i9rnP4… <named list>   <named list [2]>
```
