...
#> • chicken-perm-article.txt <id: 1FoM6eHCFF61ztHozFkvJcuZw4R_sPTgq>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1FoM6eH… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1FoM6eH… <named list>   <named list [2]>
```
