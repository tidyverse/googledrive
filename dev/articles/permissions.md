...
#> • chicken-perm-article.txt <id: 1z74X8k1OBZhXaPmDt4eXUt2mtDH1zTtZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1z74X8k… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1z74X8k… <named list>   <named list [2]>
```
