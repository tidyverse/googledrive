...
#> • chicken-perm-article.txt <id: 1w_ioxC2fl0vI4Ed6Ex7dsKeNSZFnqEYN>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1w_ioxC… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1w_ioxC… <named list>   <named list [2]>
```
