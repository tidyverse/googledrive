...
#> • chicken-perm-article.txt <id: 1Q_7aYu-4rO8FlDrAbhVjjH3M345igRF3>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Q_7aYu… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Q_7aYu… <named list>   <named list [2]>
```
