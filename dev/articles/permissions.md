...
#> • chicken-perm-article.txt <id: 1lhLX05BX4Q84hMDBHCJlqR7IRmWb1J8E>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1lhLX05… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1lhLX05… <named list>   <named list [2]>
```
