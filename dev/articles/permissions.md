...
#> • chicken-perm-article.txt <id: 10Jb6VQBYPeooFc7K8Ej3xHJKf9CydNeU>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10Jb6VQ… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10Jb6VQ… <named list>   <named list [2]>
```
