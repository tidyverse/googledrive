...
#> • chicken-perm-article.txt <id: 1PzXbu0_8L9fHorHC8zlnJ9GM466wbw2U>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1PzXbu0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1PzXbu0… <named list>   <named list [2]>
```
