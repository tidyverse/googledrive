...
#> • chicken-perm-article.txt <id: 1HRmWyD1nV_HKhSdKJzJBqSwB5hFWV3df>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1HRmWyD… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1HRmWyD… <named list>   <named list [2]>
```
