...
#> • chicken-perm-article.txt <id: 1ogC6eGMlM8Nju9bMXYPuSmFd4efEazNV>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ogC6eG… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ogC6eG… <named list>   <named list [2]>
```
