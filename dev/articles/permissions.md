...
#> • chicken-perm-article.txt <id: 132XdOjmzd_iQ6mbgPhAKxgm9TqBBQzby>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  132XdOj… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   132XdOj… <named list>   <named list [2]>
```
