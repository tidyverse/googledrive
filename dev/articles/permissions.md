...
#> • chicken-perm-article.txt <id: 1VH_O3mkehOWwq5B_hBdImXTDMiMa02RE>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1VH_O3m… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1VH_O3m… <named list>   <named list [2]>
```
