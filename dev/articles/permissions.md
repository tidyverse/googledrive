...
#> • chicken-perm-article.txt <id: 1D6pGggysMsmPive7RD-T7Si2gVgLzs8y>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1D6pGgg… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1D6pGgg… <named list>   <named list [2]>
```
