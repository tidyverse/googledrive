...
#> • chicken-perm-article.txt <id: 1vt4i1a3a_ryBdc2c5_peTAun80AVijLH>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1vt4i1a… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1vt4i1a… <named list>   <named list [2]>
```
