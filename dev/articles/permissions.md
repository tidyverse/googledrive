...
#> • chicken-perm-article.txt <id: 14x_KXv22Uzu4qktGXrO7qcluwmD_S6gc>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14x_KXv… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14x_KXv… <named list>   <named list [2]>
```
