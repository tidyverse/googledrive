...
#> • chicken-perm-article.txt <id: 1LqTK3tpfWl3inM6PqL6EHvpdCHe786mQ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LqTK3t… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LqTK3t… <named list>   <named list [2]>
```
