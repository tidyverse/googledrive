...
#> • chicken-perm-article.txt <id: 1Tsch3WaQdlPDkAedermGe4K4Wd2M_CR0>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Tsch3W… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Tsch3W… <named list>   <named list [2]>
```
