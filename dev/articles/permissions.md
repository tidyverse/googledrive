...
#> • chicken-perm-article.txt <id: 1CFEhuWzSL4B02kHSX6MPuIWgb-a76L__>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1CFEhuW… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1CFEhuW… <named list>   <named list [2]>
```
