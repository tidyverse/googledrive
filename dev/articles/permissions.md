...
#> • chicken-perm-article.txt <id: 13kK2wWh6mGXO87hcJqw21rgJS1PyLSyd>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  13kK2wW… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   13kK2wW… <named list>   <named list [2]>
```
