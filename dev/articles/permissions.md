...
#> • chicken-perm-article.txt <id: 1TXPPPOjVTNNQuY3SteQ7l7GKuXRQHXFF>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1TXPPPO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1TXPPPO… <named list>   <named list [2]>
```
