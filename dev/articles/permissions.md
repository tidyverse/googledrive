...
#> • chicken-perm-article.txt <id: 162uRVEeu7x3oFIuP0yQpZPAXorJAr92y>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  162uRVE… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   162uRVE… <named list>   <named list [2]>
```
