...
#> • chicken-perm-article.txt <id: 1K5oFH9HXVu6dUxaRVz2w3Zkb_NmBOtgx>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1K5oFH9… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1K5oFH9… <named list>   <named list [2]>
```
