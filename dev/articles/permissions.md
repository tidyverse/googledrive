...
#> • chicken-perm-article.txt <id: 1Lg5_3ulCfRpDBueUwRJUh1g47p6aWHme>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Lg5_3u… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Lg5_3u… <named list>   <named list [2]>
```
