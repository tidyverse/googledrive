...
#> • chicken-perm-article.txt <id: 1zRLo2J83ETYF_EE2W3iNQREeE9C5amWN>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1zRLo2J… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1zRLo2J… <named list>   <named list [2]>
```
