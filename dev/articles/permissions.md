...
#> • chicken-perm-article.txt <id: 1W3lnzaSyX6i3_6VtP6BUYW-M7vOkCtLd>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1W3lnza… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1W3lnza… <named list>   <named list [2]>
```
