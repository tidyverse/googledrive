...
#> • chicken-perm-article.txt <id: 11KdfVep65Xu5NUfekGmmLMgR3ouN2kBK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  11KdfVe… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   11KdfVe… <named list>   <named list [2]>
```
