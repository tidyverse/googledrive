...
#> • chicken-perm-article.txt <id: 1JDP59Iwsjz-GPN2F-5Z8h-lkYGid5XiV>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1JDP59I… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1JDP59I… <named list>   <named list [2]>
```
