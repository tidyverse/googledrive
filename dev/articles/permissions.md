...
#> • chicken-perm-article.txt <id: 178j8EjBpBLsRXnBc4DB6l08MhyEgYm-z>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  178j8Ej… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   178j8Ej… <named list>   <named list [2]>
```
