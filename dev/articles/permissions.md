...
#> • chicken-perm-article.txt <id: 1CmG2vo4pPc993zZOWBg5R16p1HfZ9Uel>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1CmG2vo… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1CmG2vo… <named list>   <named list [2]>
```
