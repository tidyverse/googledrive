...
#> • chicken-perm-article.txt <id: 1jhhrueWUSYeJDhxc4QYeEgNl9lJZ3Luf>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1jhhrue… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1jhhrue… <named list>   <named list [2]>
```
