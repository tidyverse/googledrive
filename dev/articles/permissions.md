...
#> • chicken-perm-article.txt <id: 1-wiOrYstxPn38sCkSpuMAr9mPL9pUbzx>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1-wiOrY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1-wiOrY… <named list>   <named list [2]>
```
