...
#> • chicken-perm-article.txt <id: 1LyxfRFvt5fMDLkOW69RKkPRKO_pSj9iW>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LyxfRF… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LyxfRF… <named list>   <named list [2]>
```
