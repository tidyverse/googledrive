...
#> • chicken-perm-article.txt <id: 1QULd6abIdUCkhauS66_GIPIfzkm0bgym>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1QULd6a… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1QULd6a… <named list>   <named list [2]>
```
