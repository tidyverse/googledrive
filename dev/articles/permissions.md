...
#> • chicken-perm-article.txt <id: 1mPGLfGEEd6FK72vBSbDOONeHHgEAc2Vj>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1mPGLfG… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1mPGLfG… <named list>   <named list [2]>
```
