...
#> • chicken-perm-article.txt <id: 1dpn9hxl5fvv-Ai9GXV7PN07px8wW7lzz>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1dpn9hx… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1dpn9hx… <named list>   <named list [2]>
```
