...
#> • chicken-perm-article.txt <id: 1j4GDu0jmrUm6ZW7ikTQQZKYIBthfxa5a>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1j4GDu0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1j4GDu0… <named list>   <named list [2]>
```
