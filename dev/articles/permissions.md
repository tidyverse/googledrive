...
#> • chicken-perm-article.txt <id: 17IhevWaxTS-WcIoHV-gc3zSdiFQdtPpK>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  17IhevW… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   17IhevW… <named list>   <named list [2]>
```
