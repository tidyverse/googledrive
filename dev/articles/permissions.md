...
#> • chicken-perm-article.txt <id: 1Zp9RLee46gk6_1-uwDnw3OJ8WhTfTJe4>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Zp9RLe… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Zp9RLe… <named list>   <named list [2]>
```
