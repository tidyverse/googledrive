...
#> • chicken-perm-article.txt <id: 1qRp3mZ_90KFTdyXmSr1KiWNr6-AwiUlZ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1qRp3mZ… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1qRp3mZ… <named list>   <named list [2]>
```
