...
#> • chicken-perm-article.txt <id: 1Cw_tk_wKw9oKSj9KjXNZ_4qx30SS6NJS>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Cw_tk_… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Cw_tk_… <named list>   <named list [2]>
```
