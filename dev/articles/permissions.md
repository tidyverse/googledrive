...
#> • chicken-perm-article.txt <id: 1V6bTtMl_DvA3uJ1woi_GDENt5L3K27Fp>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1V6bTtM… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1V6bTtM… <named list>   <named list [2]>
```
