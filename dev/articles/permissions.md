...
#> • chicken-perm-article.txt <id: 1Jg9YTgkolAz7kVka6wfOwrdeGmFBDicq>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Jg9YTg… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Jg9YTg… <named list>   <named list [2]>
```
