...
#> • chicken-perm-article.txt <id: 1va3yi0dgZ1rjwgsA5cmRrnL1Tc3_aGmM>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1va3yi0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1va3yi0… <named list>   <named list [2]>
```
