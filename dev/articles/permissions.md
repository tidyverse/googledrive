...
#> • chicken-perm-article.txt <id: 1NsESxxBz_alcNmiH2z7G2JtEbu-i6pnL>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1NsESxx… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1NsESxx… <named list>   <named list [2]>
```
