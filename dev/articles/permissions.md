...
#> • chicken-perm-article.txt <id: 16xLuqT9udKpFFYcnC1rwHHR78h4cEOwY>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  16xLuqT… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   16xLuqT… <named list>   <named list [2]>
```
