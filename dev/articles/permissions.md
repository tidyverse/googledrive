...
#> • chicken-perm-article.txt <id: 15zgbzpPEx8P8m2UoHcXEbnK_xI57N-AX>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  15zgbzp… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   15zgbzp… <named list>   <named list [2]>
```
