...
#> • chicken-perm-article.txt <id: 15N3CjLbrqlaQ3mImkgb7cSK4BOMV9gCr>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  15N3CjL… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   15N3CjL… <named list>   <named list [2]>
```
