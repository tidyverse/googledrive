...
#> • chicken-perm-article.txt <id: 1ohT5lbPG4HHV7llElNcxvPXPm6RnXz4g>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ohT5lb… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ohT5lb… <named list>   <named list [2]>
```
