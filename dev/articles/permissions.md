...
#> • chicken-perm-article.txt <id: 1MU5sp4HpvGkp5cLkcCkJO3OSGF4lKgnS>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1MU5sp4… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1MU5sp4… <named list>   <named list [2]>
```
