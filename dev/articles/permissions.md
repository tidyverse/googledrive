...
#> • chicken-perm-article.txt <id: 1yVtWdiwj_-Oc4ysTwqDw_TiZKcTtwsXB>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1yVtWdi… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1yVtWdi… <named list>   <named list [2]>
```
