...
#> • chicken-perm-article.txt <id: 1DrqEQzVI5RU_FdAvlevc6ttcHJ5-nHHe>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1DrqEQz… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1DrqEQz… <named list>   <named list [2]>
```
