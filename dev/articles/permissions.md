...
#> • chicken-perm-article.txt <id: 1I8BoZcUVpxuz-Y2IVOFKOw9TUsHuk64_>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1I8BoZc… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1I8BoZc… <named list>   <named list [2]>
```
