...
#> • chicken-perm-article.txt <id: 1p80_fOTpaL6QKbXwB_8tdmqjV8_tCZwp>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1p80_fO… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1p80_fO… <named list>   <named list [2]>
```
