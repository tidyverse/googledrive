...
#> • chicken-perm-article.txt <id: 14JOE5_KWgERS4gIZooVRHwDFfsjMpho8>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  14JOE5_… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   14JOE5_… <named list>   <named list [2]>
```
