...
#> • chicken-perm-article.txt <id: 17vegl0SbUl3Evg7wHKsFblFlQlJQB1Ye>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  17vegl0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   17vegl0… <named list>   <named list [2]>
```
