...
#> • chicken-perm-article.txt <id: 1V0G20d3GYr-atn5Kfle8_s6lES2LbETJ>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1V0G20d… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1V0G20d… <named list>   <named list [2]>
```
