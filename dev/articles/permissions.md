...
#> • chicken-perm-article.txt <id: 1C92vfYXE96clDNk98Dp0RmAZ2oeF1sUk>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1C92vfY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1C92vfY… <named list>   <named list [2]>
```
