...
#> • chicken-perm-article.txt <id: 10pa-WYMhe4FyaFRMub9gX91s9qY7b50Y>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  10pa-WY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   10pa-WY… <named list>   <named list [2]>
```
