...
#> • chicken-perm-article.txt <id: 1_vkc1aWnAJC2tTUwi4WWCqKRHropnaak>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1_vkc1a… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1_vkc1a… <named list>   <named list [2]>
```
