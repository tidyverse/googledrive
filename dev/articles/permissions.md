...
#> • chicken-perm-article.txt <id: 1GSPWQZFNjje97-ND1eue3AscrY4xVypN>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1GSPWQZ… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1GSPWQZ… <named list>   <named list [2]>
```
