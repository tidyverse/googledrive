...
#> • chicken-perm-article.txt <id: 1gJ1h8_KJBuoYcrZNAT5hXusGJP9YUPWH>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1gJ1h8_… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1gJ1h8_… <named list>   <named list [2]>
```
