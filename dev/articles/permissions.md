...
#> • chicken-perm-article.txt <id: 1Jgq65FRWok1wM5zRVP5chxDzC256njhE>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Jgq65F… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Jgq65F… <named list>   <named list [2]>
```
