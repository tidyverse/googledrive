...
#> • chicken-perm-article.txt <id: 1D84K8x8PaaJTfIeAvmxSO54aEqzmd3d->
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1D84K8x… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1D84K8x… <named list>   <named list [2]>
```
