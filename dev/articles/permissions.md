...
#> • chicken-perm-article.txt <id: 1UikRXAEaly7fMSil1hAM29VoZVXpfnti>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1UikRXA… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1UikRXA… <named list>   <named list [2]>
```
