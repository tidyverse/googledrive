...
#> • chicken-perm-article.txt <id: 1GLpz7Ly-H4KxoFlaK102efYYtPIKc8zI>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1GLpz7L… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1GLpz7L… <named list>   <named list [2]>
```
