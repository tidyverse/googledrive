...
#> • chicken-perm-article.txt <id: 1JOM0B7MJrngwwD5NMqMydVHXlDLVf3Xs>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1JOM0B7… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1JOM0B7… <named list>   <named list [2]>
```
