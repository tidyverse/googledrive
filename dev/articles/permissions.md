...
#> • chicken-perm-article.txt <id: 1xP0eHczvLlQL1olxYLTWsQ7Dua0PjE8j>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1xP0eHc… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1xP0eHc… <named list>   <named list [2]>
```
