...
#> • chicken-perm-article.txt <id: 1ztkc0hYo2rfDaRPwZpU6X1cYJ6wDkY-h>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ztkc0h… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ztkc0h… <named list>   <named list [2]>
```
