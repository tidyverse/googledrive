...
#> • chicken-perm-article.txt <id: 1nn7iKievQahu1JrBSrxs_n-Jrt8WZjuC>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1nn7iKi… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1nn7iKi… <named list>   <named list [2]>
```
