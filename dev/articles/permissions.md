...
#> • chicken-perm-article.txt <id: 1Em6XqXs8Go-5qAuFFCeN126F_WKp7iPX>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Em6XqX… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Em6XqX… <named list>   <named list [2]>
```
