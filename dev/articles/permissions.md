...
#> • chicken-perm-article.txt <id: 1jiHpKqxa9sQQBIj_LzzFiSulkiucS6i8>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1jiHpKq… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1jiHpKq… <named list>   <named list [2]>
```
