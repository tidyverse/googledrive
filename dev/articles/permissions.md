...
#> • chicken-perm-article.txt <id: 1bpo6udZQU0iEDDiQzoi5M56yTprFM-VW>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1bpo6ud… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1bpo6ud… <named list>   <named list [2]>
```
