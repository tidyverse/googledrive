...
#> • chicken-perm-article.txt <id: 13y88HY0LkSDBFuNY5PXShAfOIodIHZtd>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  13y88HY… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   13y88HY… <named list>   <named list [2]>
```
