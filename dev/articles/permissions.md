...
#> • chicken-perm-article.txt <id: 1NeOy_u2wRs_lZrwXBSK8bFIe1gplLzH8>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1NeOy_u… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1NeOy_u… <named list>   <named list [2]>
```
