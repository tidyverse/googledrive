...
#> • chicken-perm-article.txt <id: 1Ik4XG9SO33Uy-DFL81fnxO65PDjnDnwA>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Ik4XG9… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Ik4XG9… <named list>   <named list [2]>
```
