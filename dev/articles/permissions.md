...
#> • chicken-perm-article.txt <id: 1YgZjkQIzGG7520yvXp-xaavB9tcLs4F9>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1YgZjkQ… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1YgZjkQ… <named list>   <named list [2]>
```
