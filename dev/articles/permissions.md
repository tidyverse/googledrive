...
#> • chicken-perm-article.txt <id: 18hW78SWjy5kND3YP9A6EJHOwTWeZ5w-h>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  18hW78S… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   18hW78S… <named list>   <named list [2]>
```
