...
#> • chicken-perm-article.txt <id: 18oXrUg641Nb4-GZlg1Mh8G2EF3Qx0n8v>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  18oXrUg… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   18oXrUg… <named list>   <named list [2]>
```
