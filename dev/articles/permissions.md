...
#> • chicken-perm-article.txt <id: 1qr1M5c-jxgcn2s9h1_TLq_9s-nVDr21Q>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1qr1M5c… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1qr1M5c… <named list>   <named list [2]>
```
