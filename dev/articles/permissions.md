...
#> • chicken-perm-article.txt <id: 1hDfEcUjUdMnHJZc0qu5yOH96jHBnSF9A>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1hDfEcU… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1hDfEcU… <named list>   <named list [2]>
```
