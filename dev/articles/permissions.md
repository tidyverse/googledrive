...
#> • chicken-perm-article.txt <id: 1geZrM08yl20eHx2uStf5gZl1Aqzy7edk>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1geZrM0… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1geZrM0… <named list>   <named list [2]>
```
