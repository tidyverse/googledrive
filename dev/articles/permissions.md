...
#> • chicken-perm-article.txt <id: 1D_c7TRc3MZ39A8_YAehipLX6XS8VQpW_>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1D_c7TR… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1D_c7TR… <named list>   <named list [2]>
```
