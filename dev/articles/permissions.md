...
#> • chicken-perm-article.txt <id: 1LckdaHAnVkCUgA8hc71wowzZ9Rc2RR9F>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1LckdaH… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1LckdaH… <named list>   <named list [2]>
```
