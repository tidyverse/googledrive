...
#> • chicken-perm-article.txt <id: 1ArGWr9JgT7o7oa9scOR76Mgmm4imGAO_>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1ArGWr9… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1ArGWr9… <named list>   <named list [2]>
```
