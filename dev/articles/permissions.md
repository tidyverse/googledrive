...
#> • chicken-perm-article.txt <id: 18utdrb76OMQD_DOf44K7ONESM_QTsHmi>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  18utdrb… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   18utdrb… <named list>   <named list [2]>
```
