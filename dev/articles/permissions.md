...
#> • chicken-perm-article.txt <id: 1TG55o8rA0jE7-CbDFCeN-PYuEeQ7gigV>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1TG55o8… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1TG55o8… <named list>   <named list [2]>
```
