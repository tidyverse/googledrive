...
#> • chicken-perm-article.txt <id: 1GKYnNhroBQ-2r_U43nrLcTpKSpIdl45m>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1GKYnNh… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1GKYnNh… <named list>   <named list [2]>
```
