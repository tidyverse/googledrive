...
#> • chicken-perm-article.txt <id: 1Hd6O9p5DwMPJJ-Z-TwNUZ0Shz_KFyTMk>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Hd6O9p… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Hd6O9p… <named list>   <named list [2]>
```
