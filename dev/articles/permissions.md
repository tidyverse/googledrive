...
#> • chicken-perm-article.txt <id: 1GkalkviK7k7ZcUBinhUyrlJpfbRz52aC>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Gkalkv… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Gkalkv… <named list>   <named list [2]>
```
