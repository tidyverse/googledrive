...
#> • chicken-perm-article.txt <id: 1Hrf2Dsvtgw-qWMvRT0RbPfD1a_fK3Zzo>
#> With MIME type:
#> • text/plain
...
#> 1 chicken-perm-art… FALSE  1Hrf2Ds… <named list>   <named list [2]>
```
...
#>   name              shared id       drive_resource permissions_resource
#>   <chr>             <lgl>  <drv_id> <list>         <list>              
#> 1 chicken-perm-art… TRUE   1Hrf2Ds… <named list>   <named list [2]>
```
