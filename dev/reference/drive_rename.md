...
#> Created Drive file:
#> • file-to-rename <id: 1r6jImbWidUjQMPlPhfyCCPrDuTFvVY-U>
#> With MIME type:
...
#> • file-to-rename <id: 1r6jImbWidUjQMPlPhfyCCPrDuTFvVY-U>
#> Has been renamed:
#> • renamed-file <id: 1r6jImbWidUjQMPlPhfyCCPrDuTFvVY-U>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1m9S7jlghqK_u_QLY1VPJL533PVrmouvo>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1r6jImbWidUjQMPlPhfyCCPrDuTFvVY-U>
#> Has been renamed:
#> • name-squatter-rename <id: 1r6jImbWidUjQMPlPhfyCCPrDuTFvVY-U>
