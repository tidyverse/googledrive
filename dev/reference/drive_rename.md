...
#> Created Drive file:
#> • file-to-rename <id: 1rsAGIBNUslPrK9A7IwGZWwZFz63xHSmw>
#> With MIME type:
...
#> • file-to-rename <id: 1rsAGIBNUslPrK9A7IwGZWwZFz63xHSmw>
#> Has been renamed:
#> • renamed-file <id: 1rsAGIBNUslPrK9A7IwGZWwZFz63xHSmw>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1wOKpGPgi4dPRvnMaiHl0z2JAkzC-Yvhj>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1rsAGIBNUslPrK9A7IwGZWwZFz63xHSmw>
#> Has been renamed:
#> • name-squatter-rename <id: 1rsAGIBNUslPrK9A7IwGZWwZFz63xHSmw>
