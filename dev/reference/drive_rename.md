...
#> Created Drive file:
#> • file-to-rename <id: 1B38dg_-FlAxeuyUvUZdvPf8kWqfHDCuu>
#> With MIME type:
...
#> • file-to-rename <id: 1B38dg_-FlAxeuyUvUZdvPf8kWqfHDCuu>
#> Has been renamed:
#> • renamed-file <id: 1B38dg_-FlAxeuyUvUZdvPf8kWqfHDCuu>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1WLkRoqUyYALKYd8CD_DfqD5rMxaHsiBr>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1B38dg_-FlAxeuyUvUZdvPf8kWqfHDCuu>
#> Has been renamed:
#> • name-squatter-rename <id: 1B38dg_-FlAxeuyUvUZdvPf8kWqfHDCuu>
