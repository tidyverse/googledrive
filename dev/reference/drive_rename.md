...
#> Created Drive file:
#> • file-to-rename <id: 18JNkkIRLH5ueG_dC6fZbmoOcIswUjupp>
#> With MIME type:
...
#> • file-to-rename <id: 18JNkkIRLH5ueG_dC6fZbmoOcIswUjupp>
#> Has been renamed:
#> • renamed-file <id: 18JNkkIRLH5ueG_dC6fZbmoOcIswUjupp>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 171tpEjuMY2RfoyxynVhYkpzaQ2BNtd2w>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 18JNkkIRLH5ueG_dC6fZbmoOcIswUjupp>
#> Has been renamed:
#> • name-squatter-rename <id: 18JNkkIRLH5ueG_dC6fZbmoOcIswUjupp>
