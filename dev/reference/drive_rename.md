...
#> Created Drive file:
#> • file-to-rename <id: 1wyjatLrFOOEaSafPgrDyoA4v8cnnt2Pd>
#> With MIME type:
...
#> • file-to-rename <id: 1wyjatLrFOOEaSafPgrDyoA4v8cnnt2Pd>
#> Has been renamed:
#> • renamed-file <id: 1wyjatLrFOOEaSafPgrDyoA4v8cnnt2Pd>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 126AWe9e7_orlvAQ4d_Cw--8wGPvcSC1p>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1wyjatLrFOOEaSafPgrDyoA4v8cnnt2Pd>
#> Has been renamed:
#> • name-squatter-rename <id: 1wyjatLrFOOEaSafPgrDyoA4v8cnnt2Pd>
