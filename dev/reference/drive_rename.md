...
#> Created Drive file:
#> • file-to-rename <id: 1_MaqgtZ2jarXL1oMPV4IO4TGsZFUUPHW>
#> With MIME type:
...
#> • file-to-rename <id: 1_MaqgtZ2jarXL1oMPV4IO4TGsZFUUPHW>
#> Has been renamed:
#> • renamed-file <id: 1_MaqgtZ2jarXL1oMPV4IO4TGsZFUUPHW>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1sl-vZoAGuf_78xRwhAPnO8vKTThCFSEy>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1_MaqgtZ2jarXL1oMPV4IO4TGsZFUUPHW>
#> Has been renamed:
#> • name-squatter-rename <id: 1_MaqgtZ2jarXL1oMPV4IO4TGsZFUUPHW>
