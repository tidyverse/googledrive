...
#> Created Drive file:
#> • file-to-rename <id: 1dAujSYDMuNlvxpd5ouxqRkwyCxMTDLA9>
#> With MIME type:
...
#> • file-to-rename <id: 1dAujSYDMuNlvxpd5ouxqRkwyCxMTDLA9>
#> Has been renamed:
#> • renamed-file <id: 1dAujSYDMuNlvxpd5ouxqRkwyCxMTDLA9>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1JqBLtYvDNla0CWq-vOeODv1NlXoTS28s>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1dAujSYDMuNlvxpd5ouxqRkwyCxMTDLA9>
#> Has been renamed:
#> • name-squatter-rename <id: 1dAujSYDMuNlvxpd5ouxqRkwyCxMTDLA9>
