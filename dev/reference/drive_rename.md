...
#> Created Drive file:
#> • file-to-rename <id: 18DoD2-Pu1txLNRM7B8ggPCPO-yfqj0CO>
#> With MIME type:
...
#> • file-to-rename <id: 18DoD2-Pu1txLNRM7B8ggPCPO-yfqj0CO>
#> Has been renamed:
#> • renamed-file <id: 18DoD2-Pu1txLNRM7B8ggPCPO-yfqj0CO>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1IWGoTt3GPLrnKZrJNTg3JBnckK1wHSnu>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 18DoD2-Pu1txLNRM7B8ggPCPO-yfqj0CO>
#> Has been renamed:
#> • name-squatter-rename <id: 18DoD2-Pu1txLNRM7B8ggPCPO-yfqj0CO>
