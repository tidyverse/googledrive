...
#> Created Drive file:
#> • file-to-rename <id: 1dXmi-IekJ8mkca4ixf-id4yzPwI9dBZa>
#> With MIME type:
...
#> • file-to-rename <id: 1dXmi-IekJ8mkca4ixf-id4yzPwI9dBZa>
#> Has been renamed:
#> • renamed-file <id: 1dXmi-IekJ8mkca4ixf-id4yzPwI9dBZa>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1y_m_2X4bh0SrQCNtGGxAGY9ALqxDiLYN>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1dXmi-IekJ8mkca4ixf-id4yzPwI9dBZa>
#> Has been renamed:
#> • name-squatter-rename <id: 1dXmi-IekJ8mkca4ixf-id4yzPwI9dBZa>
