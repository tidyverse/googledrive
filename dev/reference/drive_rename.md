...
#> Created Drive file:
#> • file-to-rename <id: 1vqVHA1aOjZW08IFwGHDcsUIAHuyV63n->
#> With MIME type:
...
#> • file-to-rename <id: 1vqVHA1aOjZW08IFwGHDcsUIAHuyV63n->
#> Has been renamed:
#> • renamed-file <id: 1vqVHA1aOjZW08IFwGHDcsUIAHuyV63n->

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1lTX-RRb97w5X2mXXey-JCpqnJ5meYPLu>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1vqVHA1aOjZW08IFwGHDcsUIAHuyV63n->
#> Has been renamed:
#> • name-squatter-rename <id: 1vqVHA1aOjZW08IFwGHDcsUIAHuyV63n->
