...
#> Created Drive file:
#> • file-to-rename <id: 10ZgatiwpZJeL-MPzj-oYhLCJ3TwREXBl>
#> With MIME type:
...
#> • file-to-rename <id: 10ZgatiwpZJeL-MPzj-oYhLCJ3TwREXBl>
#> Has been renamed:
#> • renamed-file <id: 10ZgatiwpZJeL-MPzj-oYhLCJ3TwREXBl>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1UM3lBgqOfrYc1cRt_AMB1l82ztVQ1POn>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 10ZgatiwpZJeL-MPzj-oYhLCJ3TwREXBl>
#> Has been renamed:
#> • name-squatter-rename <id: 10ZgatiwpZJeL-MPzj-oYhLCJ3TwREXBl>
