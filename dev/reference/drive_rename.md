...
#> Created Drive file:
#> • file-to-rename <id: 12cRntVoNiPmJxbI1p1j99jOABRjPlDmu>
#> With MIME type:
...
#> • file-to-rename <id: 12cRntVoNiPmJxbI1p1j99jOABRjPlDmu>
#> Has been renamed:
#> • renamed-file <id: 12cRntVoNiPmJxbI1p1j99jOABRjPlDmu>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1iLDaxEBwsSx5c8cgh1oOIWpgGpHO6-97>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 12cRntVoNiPmJxbI1p1j99jOABRjPlDmu>
#> Has been renamed:
#> • name-squatter-rename <id: 12cRntVoNiPmJxbI1p1j99jOABRjPlDmu>
