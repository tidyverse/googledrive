...
#> Created Drive file:
#> • file-to-rename <id: 1sVUYLvjYvSkjSAykM8mZzHJjjHQ6Nre1>
#> With MIME type:
...
#> • file-to-rename <id: 1sVUYLvjYvSkjSAykM8mZzHJjjHQ6Nre1>
#> Has been renamed:
#> • renamed-file <id: 1sVUYLvjYvSkjSAykM8mZzHJjjHQ6Nre1>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1yhoCShKNtRGXsPT38XMVJnwVunhs5P_y>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1sVUYLvjYvSkjSAykM8mZzHJjjHQ6Nre1>
#> Has been renamed:
#> • name-squatter-rename <id: 1sVUYLvjYvSkjSAykM8mZzHJjjHQ6Nre1>
