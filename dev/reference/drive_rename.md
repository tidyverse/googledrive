...
#> Created Drive file:
#> • file-to-rename <id: 1s3TLdFQqZJKqp_MmP3BrLRAMoWkoH7-v>
#> With MIME type:
...
#> • file-to-rename <id: 1s3TLdFQqZJKqp_MmP3BrLRAMoWkoH7-v>
#> Has been renamed:
#> • renamed-file <id: 1s3TLdFQqZJKqp_MmP3BrLRAMoWkoH7-v>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1YABw6PoOjrhb4NJUX9XZmMHYZ-r1TViB>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1s3TLdFQqZJKqp_MmP3BrLRAMoWkoH7-v>
#> Has been renamed:
#> • name-squatter-rename <id: 1s3TLdFQqZJKqp_MmP3BrLRAMoWkoH7-v>
