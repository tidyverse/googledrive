...
#> Created Drive file:
#> • file-to-rename <id: 1gQ0CSZzHh456guZHJEkKywVsPi8WbSO1>
#> With MIME type:
...
#> • file-to-rename <id: 1gQ0CSZzHh456guZHJEkKywVsPi8WbSO1>
#> Has been renamed:
#> • renamed-file <id: 1gQ0CSZzHh456guZHJEkKywVsPi8WbSO1>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 17DccP6kP1EI39Z0OXcJl1ihmL0g52jCv>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1gQ0CSZzHh456guZHJEkKywVsPi8WbSO1>
#> Has been renamed:
#> • name-squatter-rename <id: 1gQ0CSZzHh456guZHJEkKywVsPi8WbSO1>
