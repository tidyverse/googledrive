...
#> Created Drive file:
#> • file-to-rename <id: 1ruHx3jmiGtuZfPPKZPmvjtdfuC-vbEtK>
#> With MIME type:
...
#> • file-to-rename <id: 1ruHx3jmiGtuZfPPKZPmvjtdfuC-vbEtK>
#> Has been renamed:
#> • renamed-file <id: 1ruHx3jmiGtuZfPPKZPmvjtdfuC-vbEtK>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1czyXCNADrXq8sGM_1C3hNpoH5dhPwDch>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1ruHx3jmiGtuZfPPKZPmvjtdfuC-vbEtK>
#> Has been renamed:
#> • name-squatter-rename <id: 1ruHx3jmiGtuZfPPKZPmvjtdfuC-vbEtK>
