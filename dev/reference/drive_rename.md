...
#> Created Drive file:
#> • file-to-rename <id: 1_scSTAkcJ8pOAUI5ylWIikNMoHmBz0FA>
#> With MIME type:
...
#> • file-to-rename <id: 1_scSTAkcJ8pOAUI5ylWIikNMoHmBz0FA>
#> Has been renamed:
#> • renamed-file <id: 1_scSTAkcJ8pOAUI5ylWIikNMoHmBz0FA>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 13Ua-7uDvhGl3D-1VC8KRd3HVMtIGjV3r>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1_scSTAkcJ8pOAUI5ylWIikNMoHmBz0FA>
#> Has been renamed:
#> • name-squatter-rename <id: 1_scSTAkcJ8pOAUI5ylWIikNMoHmBz0FA>
