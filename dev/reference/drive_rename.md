...
#> Created Drive file:
#> • file-to-rename <id: 1e8_oLR0SWdPmrc6B_WI_h7F3u8ZdztOC>
#> With MIME type:
...
#> • file-to-rename <id: 1e8_oLR0SWdPmrc6B_WI_h7F3u8ZdztOC>
#> Has been renamed:
#> • renamed-file <id: 1e8_oLR0SWdPmrc6B_WI_h7F3u8ZdztOC>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 11EKk38tPnMNCzvfVTrY3X4THqj1sTnkF>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1e8_oLR0SWdPmrc6B_WI_h7F3u8ZdztOC>
#> Has been renamed:
#> • name-squatter-rename <id: 1e8_oLR0SWdPmrc6B_WI_h7F3u8ZdztOC>
