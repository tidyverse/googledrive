...
#> Created Drive file:
#> • file-to-rename <id: 1UmvpcD_gcj-N9pHqwPj4CQBvd8H5BSsa>
#> With MIME type:
...
#> • file-to-rename <id: 1UmvpcD_gcj-N9pHqwPj4CQBvd8H5BSsa>
#> Has been renamed:
#> • renamed-file <id: 1UmvpcD_gcj-N9pHqwPj4CQBvd8H5BSsa>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1N_gzvalhkwywd0AabQwOClD5cTLZnUzh>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1UmvpcD_gcj-N9pHqwPj4CQBvd8H5BSsa>
#> Has been renamed:
#> • name-squatter-rename <id: 1UmvpcD_gcj-N9pHqwPj4CQBvd8H5BSsa>
