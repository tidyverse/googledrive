...
#> Created Drive file:
#> • file-to-rename <id: 1bxSoMBobwDgIfCwP8zrV-scRLbZbPWvj>
#> With MIME type:
...
#> • file-to-rename <id: 1bxSoMBobwDgIfCwP8zrV-scRLbZbPWvj>
#> Has been renamed:
#> • renamed-file <id: 1bxSoMBobwDgIfCwP8zrV-scRLbZbPWvj>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 10a5s46_jouvMCRO8m_A-i5Q8EzBu-XHs>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1bxSoMBobwDgIfCwP8zrV-scRLbZbPWvj>
#> Has been renamed:
#> • name-squatter-rename <id: 1bxSoMBobwDgIfCwP8zrV-scRLbZbPWvj>
