...
#> Created Drive file:
#> • file-to-rename <id: 14uInV2-zojg9BxU9khUmBRpUUsWjnKgv>
#> With MIME type:
...
#> • file-to-rename <id: 14uInV2-zojg9BxU9khUmBRpUUsWjnKgv>
#> Has been renamed:
#> • renamed-file <id: 14uInV2-zojg9BxU9khUmBRpUUsWjnKgv>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1sOaIhIG-HOcses37Sjm3WJmUZ0oqGn8Q>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 14uInV2-zojg9BxU9khUmBRpUUsWjnKgv>
#> Has been renamed:
#> • name-squatter-rename <id: 14uInV2-zojg9BxU9khUmBRpUUsWjnKgv>
