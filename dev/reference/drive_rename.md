...
#> Created Drive file:
#> • file-to-rename <id: 1hIlw--rLiMNobXYkfJoofAEi5qE5YSyt>
#> With MIME type:
...
#> • file-to-rename <id: 1hIlw--rLiMNobXYkfJoofAEi5qE5YSyt>
#> Has been renamed:
#> • renamed-file <id: 1hIlw--rLiMNobXYkfJoofAEi5qE5YSyt>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1e2DURKUNXXRIp0ZA1Ospke0fAbQZJ3bm>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1hIlw--rLiMNobXYkfJoofAEi5qE5YSyt>
#> Has been renamed:
#> • name-squatter-rename <id: 1hIlw--rLiMNobXYkfJoofAEi5qE5YSyt>
