...
#> Created Drive file:
#> • file-to-rename <id: 1ZkUHz_NWu2YQ_lydkgN9tAV34F4YOBAA>
#> With MIME type:
...
#> • file-to-rename <id: 1ZkUHz_NWu2YQ_lydkgN9tAV34F4YOBAA>
#> Has been renamed:
#> • renamed-file <id: 1ZkUHz_NWu2YQ_lydkgN9tAV34F4YOBAA>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1CIOP7M8G5np1lk4m-teoPSj2j5GlIojD>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1ZkUHz_NWu2YQ_lydkgN9tAV34F4YOBAA>
#> Has been renamed:
#> • name-squatter-rename <id: 1ZkUHz_NWu2YQ_lydkgN9tAV34F4YOBAA>
