...
#> Created Drive file:
#> • file-to-rename <id: 1-CtbAcLRnYwpWtjx8sVou-_hZ3UroPwr>
#> With MIME type:
...
#> • file-to-rename <id: 1-CtbAcLRnYwpWtjx8sVou-_hZ3UroPwr>
#> Has been renamed:
#> • renamed-file <id: 1-CtbAcLRnYwpWtjx8sVou-_hZ3UroPwr>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1GirmsC5AiBuUPUHHzUdGWgowDfgIELPQ>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1-CtbAcLRnYwpWtjx8sVou-_hZ3UroPwr>
#> Has been renamed:
#> • name-squatter-rename <id: 1-CtbAcLRnYwpWtjx8sVou-_hZ3UroPwr>
