...
#> Created Drive file:
#> • file-to-rename <id: 1KLn5VVDIpZ_FryjYVvxTClUkNqTZYlg9>
#> With MIME type:
...
#> • file-to-rename <id: 1KLn5VVDIpZ_FryjYVvxTClUkNqTZYlg9>
#> Has been renamed:
#> • renamed-file <id: 1KLn5VVDIpZ_FryjYVvxTClUkNqTZYlg9>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1nhIgdQMgB0SFatuRexe38iAfbkMhSgjC>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1KLn5VVDIpZ_FryjYVvxTClUkNqTZYlg9>
#> Has been renamed:
#> • name-squatter-rename <id: 1KLn5VVDIpZ_FryjYVvxTClUkNqTZYlg9>
