...
#> Created Drive file:
#> • file-to-rename <id: 1-p7xKLDj-NdC-pYB_KKlhY3VhAqHoEmS>
#> With MIME type:
...
#> • file-to-rename <id: 1-p7xKLDj-NdC-pYB_KKlhY3VhAqHoEmS>
#> Has been renamed:
#> • renamed-file <id: 1-p7xKLDj-NdC-pYB_KKlhY3VhAqHoEmS>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 16DHg0M_xtUreLf9Mk9M4UAgXjHUx-Zwo>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1-p7xKLDj-NdC-pYB_KKlhY3VhAqHoEmS>
#> Has been renamed:
#> • name-squatter-rename <id: 1-p7xKLDj-NdC-pYB_KKlhY3VhAqHoEmS>
