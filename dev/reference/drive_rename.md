...
#> Created Drive file:
#> • file-to-rename <id: 1TYOr-ihJYOv06xhgIiNWyPmpduLgtGcG>
#> With MIME type:
...
#> • file-to-rename <id: 1TYOr-ihJYOv06xhgIiNWyPmpduLgtGcG>
#> Has been renamed:
#> • renamed-file <id: 1TYOr-ihJYOv06xhgIiNWyPmpduLgtGcG>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 19SK-i645IrLo-jlYeAIk8-I-sB1e6bmB>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1TYOr-ihJYOv06xhgIiNWyPmpduLgtGcG>
#> Has been renamed:
#> • name-squatter-rename <id: 1TYOr-ihJYOv06xhgIiNWyPmpduLgtGcG>
