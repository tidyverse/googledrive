...
#> Created Drive file:
#> • file-to-rename <id: 1sRflIhx4tuGX4sbetHKMS0i5Qwn4-KQ1>
#> With MIME type:
...
#> • file-to-rename <id: 1sRflIhx4tuGX4sbetHKMS0i5Qwn4-KQ1>
#> Has been renamed:
#> • renamed-file <id: 1sRflIhx4tuGX4sbetHKMS0i5Qwn4-KQ1>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1zNp0zFc5L4alVwvgiJZBp6OX8S_dJZiG>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1sRflIhx4tuGX4sbetHKMS0i5Qwn4-KQ1>
#> Has been renamed:
#> • name-squatter-rename <id: 1sRflIhx4tuGX4sbetHKMS0i5Qwn4-KQ1>
