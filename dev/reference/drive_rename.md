...
#> Created Drive file:
#> • file-to-rename <id: 1nDvpofRzmEnt_JiHhZgyASBHYAUNHQax>
#> With MIME type:
...
#> • file-to-rename <id: 1nDvpofRzmEnt_JiHhZgyASBHYAUNHQax>
#> Has been renamed:
#> • renamed-file <id: 1nDvpofRzmEnt_JiHhZgyASBHYAUNHQax>

# `overwrite = FALSE` errors if something already exists at target filepath
# THIS WILL ERROR!
drive_create("name-squatter-rename")
#> Created Drive file:
#> • name-squatter-rename <id: 1cnNp4sjOPipgU0YaHfNEwhR-c8dj2PFq>
#> With MIME type:
#> • application/octet-stream
...
#> • renamed-file <id: 1nDvpofRzmEnt_JiHhZgyASBHYAUNHQax>
#> Has been renamed:
#> • name-squatter-rename <id: 1nDvpofRzmEnt_JiHhZgyASBHYAUNHQax>
