...
#> Local file:
#> • /tmp/RtmpLj5JUz/drive_put_1c9249a7a024.txt
#> Uploaded into Drive file:
#> • drive_put_1c9249a7a024.txt <id: 1-avaBl0wdmMO1DrrIeiCz2gXG6Bi79dk>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c9249a7a024.txt <id: 11aATu2Of0HIM3sHsTT7GVj2BPfgrw02M>
#> With MIME type:
#> • text/plain
