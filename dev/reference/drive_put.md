...
#> Local file:
#> • /tmp/RtmpxOkDst/drive_put_1a92db7c542.txt
#> Uploaded into Drive file:
#> • drive_put_1a92db7c542.txt <id: 1yO7NOUQTzAp_SpqrjdsoSG-ZuJlxev5C>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a92db7c542.txt <id: 1zKx1Qvr3tOqu2d3c7EKDElDqiV3f5Scw>
#> With MIME type:
#> • text/plain
