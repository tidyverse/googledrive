...
#> Local file:
#> • /tmp/RtmpWpFMTn/drive_put_1b043687600e.txt
#> Uploaded into Drive file:
#> • drive_put_1b043687600e.txt <id: 1ZVX-ciEwjP0Dzy9PxUXwdKLLHq9TK7jK>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b043687600e.txt <id: 15_HYVvUY0SXekGvYjKcEvK4XtspIcyBD>
#> With MIME type:
#> • text/plain
