...
#> Local file:
#> • /tmp/RtmpHrwJmH/drive_put_19c1398a5e7a.txt
#> Uploaded into Drive file:
#> • drive_put_19c1398a5e7a.txt <id: 11doGW0bek29VKkTtRFSefhsub-5H8hsl>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19c1398a5e7a.txt <id: 1Lc5hzKUUCJCrMK_9MQ2ImzOclWGxp5C7>
#> With MIME type:
#> • text/plain
