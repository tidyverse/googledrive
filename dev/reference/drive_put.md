...
#> Local file:
#> • /tmp/RtmpoVmF3V/drive_put_19ee103dbff2.txt
#> Uploaded into Drive file:
#> • drive_put_19ee103dbff2.txt <id: 13mzQunQv1u3IR_-wmlem9nXn6dW665Ej>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19ee103dbff2.txt <id: 16dtGbUZ8R9ZWtL_j4Lqc-3lyyp95s1s4>
#> With MIME type:
#> • text/plain
