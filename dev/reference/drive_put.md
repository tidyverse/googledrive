...
#> Local file:
#> • /tmp/RtmpoJTGlo/drive_put_1c022df6fc53.txt
#> Uploaded into Drive file:
#> • drive_put_1c022df6fc53.txt <id: 1eU0mDIHcBu6Atg_nLIrCGtvikGJsTD7O>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c022df6fc53.txt <id: 1uGMk3DqzNbOwvgTsbCEh9KpWv7mfn4cy>
#> With MIME type:
#> • text/plain
