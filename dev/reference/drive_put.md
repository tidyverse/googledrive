...
#> Local file:
#> • /tmp/RtmpP4chtz/drive_put_198e27b9f42c.txt
#> Uploaded into Drive file:
#> • drive_put_198e27b9f42c.txt <id: 1u2a9JpezL9T9GL1RkGIth8UQSXi8YZC8>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_198e27b9f42c.txt <id: 1HyouXjSyO8zvslZlhEDYb9Dpc7EkyV_W>
#> With MIME type:
#> • text/plain
