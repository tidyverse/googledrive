...
#> Local file:
#> • /tmp/RtmpEZDF76/drive_put_1a68394579fe.txt
#> Uploaded into Drive file:
#> • drive_put_1a68394579fe.txt <id: 1RqyZUzY0L7U80jeWRnwUcktv4fWWe1Mo>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a68394579fe.txt <id: 1NmepvnYfr-XPuTAJrQ26TbH3xJnRJBHq>
#> With MIME type:
#> • text/plain
