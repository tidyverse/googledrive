...
#> Local file:
#> • /tmp/RtmpG2yPoB/drive_put_1bfd351d1b61.txt
#> Uploaded into Drive file:
#> • drive_put_1bfd351d1b61.txt <id: 16mQ3OlRoPzrkBf9KzrY8kXEPYDUSu75Y>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bfd351d1b61.txt <id: 1aegWmR8S-n-GAqbYzL9br1ft29-GfMk->
#> With MIME type:
#> • text/plain
