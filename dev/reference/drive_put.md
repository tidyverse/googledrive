...
#> Local file:
#> • /tmp/Rtmp89sm8V/drive_put_19293d1f6acb.txt
#> Uploaded into Drive file:
#> • drive_put_19293d1f6acb.txt <id: 1aY4ikjNqrHPoBMvbJ-Fvl_yfPRCj0PqT>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19293d1f6acb.txt <id: 13wZPt4g5U87Ub-zBk9MVDQyIuY8ltDke>
#> With MIME type:
#> • text/plain
