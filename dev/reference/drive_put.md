...
#> Local file:
#> • /tmp/RtmpWOUwuZ/drive_put_19dd6b8c04ff.txt
#> Uploaded into Drive file:
#> • drive_put_19dd6b8c04ff.txt <id: 1UU0yYOCEnyvRe3pxSV_dE62zAGNJAFk_>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19dd6b8c04ff.txt <id: 1LfJh_Chkh5K6uD0pUStdYlV-K129x2TM>
#> With MIME type:
#> • text/plain
