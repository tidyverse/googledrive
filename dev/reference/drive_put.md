...
#> Local file:
#> • /tmp/Rtmp9c6PdM/drive_put_1a9f23bd3ff3.txt
#> Uploaded into Drive file:
#> • drive_put_1a9f23bd3ff3.txt <id: 1boCjQGhNvFtn03aPlIwrSP14L5kY-6bX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a9f23bd3ff3.txt <id: 1kQ0TVJ2TDBWxoF1_r3ZKBVbJpxeB7A2l>
#> With MIME type:
#> • text/plain
