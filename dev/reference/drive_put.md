...
#> Local file:
#> • /tmp/Rtmp1CR6qB/drive_put_1a4470584e8c.txt
#> Uploaded into Drive file:
#> • drive_put_1a4470584e8c.txt <id: 13fpKLi1ebjEpRByWFKTJfP-pZ_nY3WG2>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a4470584e8c.txt <id: 1g-Zy9v0xIUS8OwsY-wIEgzXlAek_J9oz>
#> With MIME type:
#> • text/plain
