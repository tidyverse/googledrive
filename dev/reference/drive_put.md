...
#> Local file:
#> • /tmp/Rtmp7ooq70/drive_put_19806d7a6fa6.txt
#> Uploaded into Drive file:
#> • drive_put_19806d7a6fa6.txt <id: 1ZYL_37YihHcSBzO6vlvj2SbgFcZd7Sz->
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19806d7a6fa6.txt <id: 1Vgy9cblRKbRtZ49ZQsVV4wTHq8EhLgPd>
#> With MIME type:
#> • text/plain
