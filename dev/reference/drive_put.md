...
#> Local file:
#> • /tmp/RtmpQddtcy/drive_put_1b81147dfcc2.txt
#> Uploaded into Drive file:
#> • drive_put_1b81147dfcc2.txt <id: 19j3D0qJtnxQA9j6kyZRyFD8ojrDSEBGW>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b81147dfcc2.txt <id: 1oBcm-CilIcTaOgR2xMiZksYk8Y4zRYE0>
#> With MIME type:
#> • text/plain
