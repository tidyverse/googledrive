...
#> Local file:
#> • /tmp/RtmpVxQAy0/drive_put_1a0e3d8dd746.txt
#> Uploaded into Drive file:
#> • drive_put_1a0e3d8dd746.txt <id: 1C0w5_woH6dFJuxmNYEj_zzThWSAEg5NO>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a0e3d8dd746.txt <id: 1K35fbXeSz28TCAxho_b6fsWl8CpXWGC8>
#> With MIME type:
#> • text/plain
