...
#> Local file:
#> • /tmp/RtmpIEnf56/drive_put_1be713fdeecd.txt
#> Uploaded into Drive file:
#> • drive_put_1be713fdeecd.txt <id: 15uxAZvImHepcd1Uomzur5wW2A481kMrX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1be713fdeecd.txt <id: 1mO7GrvjujwcGUR7Qn-dqjdY7Tsp0m0Dw>
#> With MIME type:
#> • text/plain
