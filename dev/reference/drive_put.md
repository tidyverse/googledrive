...
#> Local file:
#> • /tmp/RtmprgQm3p/drive_put_1c0054c29a01.txt
#> Uploaded into Drive file:
#> • drive_put_1c0054c29a01.txt <id: 1kEiZA0khEE6p9ppPO2HwIc2ZlYPHARVe>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c0054c29a01.txt <id: 1dOr-cmcWASLW7fS5g6mAEKngviwd2GzT>
#> With MIME type:
#> • text/plain
