...
#> Local file:
#> • /tmp/RtmppwDwJC/drive_put_1b552fd0a7e4.txt
#> Uploaded into Drive file:
#> • drive_put_1b552fd0a7e4.txt <id: 1okHkHCuBHMAq2cejMWU7ZtHNBzuMgCSX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b552fd0a7e4.txt <id: 1FLAUTgxHf-3m3rqaY5N3u3j1_TSV7WmD>
#> With MIME type:
#> • text/plain
