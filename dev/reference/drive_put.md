...
#> Local file:
#> • /tmp/RtmpvU9A9m/drive_put_19bc7b0636e8.txt
#> Uploaded into Drive file:
#> • drive_put_19bc7b0636e8.txt <id: 1vLE7tSo0GTFZQKxl0--GDuAep_D_vGJo>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19bc7b0636e8.txt <id: 1Fa2f26dYqHBDbZBI5zH2tVMtg32kWmfW>
#> With MIME type:
#> • text/plain
