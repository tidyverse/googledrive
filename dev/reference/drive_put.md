...
#> Local file:
#> • /tmp/RtmpDt5QEi/drive_put_1b7e5fd622a1.txt
#> Uploaded into Drive file:
#> • drive_put_1b7e5fd622a1.txt <id: 1kp_1D0t6JOvdl3zJ3dEnADQTmnZ1z_QQ>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b7e5fd622a1.txt <id: 1aJX4CykUa6JftipPbDVcarnv_FSAG7AR>
#> With MIME type:
#> • text/plain
