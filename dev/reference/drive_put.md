...
#> Local file:
#> • /tmp/RtmpflrbuB/drive_put_1bd0478e3bd6.txt
#> Uploaded into Drive file:
#> • drive_put_1bd0478e3bd6.txt <id: 1rZE7f1l2NlvR6Pua9tAVL2LjsMnQ3V8P>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bd0478e3bd6.txt <id: 1zlV8FTCzgzathyu_rTvBqSBKC_HqgIeR>
#> With MIME type:
#> • text/plain
