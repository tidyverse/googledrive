...
#> Local file:
#> • /tmp/RtmpjxPeyT/drive_put_1b8b6790f269.txt
#> Uploaded into Drive file:
#> • drive_put_1b8b6790f269.txt <id: 1bFpkJQcfH0kNT1yXoR12GmFgKemg-Js2>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b8b6790f269.txt <id: 1eEq3RLDGIUxcy3eZEnFR97VffmdCS7B4>
#> With MIME type:
#> • text/plain
