...
#> Local file:
#> • /tmp/RtmpOxaYow/drive_put_19f824c825c6.txt
#> Uploaded into Drive file:
#> • drive_put_19f824c825c6.txt <id: 18SdUtjDnrPAZPL8kB_1Bc_Fvocc2_DSE>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19f824c825c6.txt <id: 1JYGvGDOFKMjSTXyDwBX7tl8Xr0RU0zvk>
#> With MIME type:
#> • text/plain
