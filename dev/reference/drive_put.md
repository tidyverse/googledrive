...
#> Local file:
#> • /tmp/Rtmp2JKD8L/drive_put_1a3214add29e.txt
#> Uploaded into Drive file:
#> • drive_put_1a3214add29e.txt <id: 1u2C05B3PaLrmbC_Uj82uVOsm7OqZ3fFg>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a3214add29e.txt <id: 19mdc9qyFfcFPnkvziBNOa2VT8bKBnYmy>
#> With MIME type:
#> • text/plain
