...
#> Local file:
#> • /tmp/Rtmpbw32pM/drive_put_1acb64ffa4a9.txt
#> Uploaded into Drive file:
#> • drive_put_1acb64ffa4a9.txt <id: 1TqbP6OwMlSDp4VCCSok19hG0wp-YB_kr>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1acb64ffa4a9.txt <id: 1tEoefpwohDlSKDEQFjUCEo_u7jH9gXOl>
#> With MIME type:
#> • text/plain
