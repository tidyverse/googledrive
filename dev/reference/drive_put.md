...
#> Local file:
#> • /tmp/Rtmp2ghr1A/drive_put_19dc130234ce.txt
#> Uploaded into Drive file:
#> • drive_put_19dc130234ce.txt <id: 14MXQLiXJOWnv5OQ2_b3hpkVikY28yJDD>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19dc130234ce.txt <id: 1mhUxMvryeo7UC0Z20daajAqRAWtBFgH->
#> With MIME type:
#> • text/plain
