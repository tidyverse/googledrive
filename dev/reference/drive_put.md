...
#> Local file:
#> • /tmp/RtmpoqGxkj/drive_put_1a0e45a10f16.txt
#> Uploaded into Drive file:
#> • drive_put_1a0e45a10f16.txt <id: 1SBML6ZsD7y82znkeTbF9gc7bRjR-SJ8T>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a0e45a10f16.txt <id: 1LCeXPt1OvpkGbvTr_XHOoaEfo08m6wyx>
#> With MIME type:
#> • text/plain
