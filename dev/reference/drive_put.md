...
#> Local file:
#> • /tmp/Rtmpyl04wk/drive_put_1ce913dbb7ed.txt
#> Uploaded into Drive file:
#> • drive_put_1ce913dbb7ed.txt <id: 1hZ3_CV-XgEg3_sGVZKvzaKHsbk1R83EU>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ce913dbb7ed.txt <id: 1WAf3zF1djOm8eRJ0KlqTD7lBzo0QXIzj>
#> With MIME type:
#> • text/plain
