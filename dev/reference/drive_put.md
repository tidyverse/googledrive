...
#> Local file:
#> • /tmp/RtmpHK5OQR/drive_put_1bba7b7d621f.txt
#> Uploaded into Drive file:
#> • drive_put_1bba7b7d621f.txt <id: 1lelhNBsmMRq6-tLGstzWKsyHtW7O8BX->
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bba7b7d621f.txt <id: 1BZ5d1svo5zCBGfDn41RbQ3zh7P9CyWFK>
#> With MIME type:
#> • text/plain
