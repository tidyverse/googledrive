...
#> Local file:
#> • /tmp/RtmpcW7DXl/drive_put_19ef4685c497.txt
#> Uploaded into Drive file:
#> • drive_put_19ef4685c497.txt <id: 1YBKiaSD_rbWyziYWdbITlYRGdkaCZ-ML>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19ef4685c497.txt <id: 11jE-PrqiTCV6ci_oFbn9PVpQ3_0_uqfl>
#> With MIME type:
#> • text/plain
