...
#> Local file:
#> • /tmp/RtmpA1uqQ5/drive_put_1a565f3024eb.txt
#> Uploaded into Drive file:
#> • drive_put_1a565f3024eb.txt <id: 1iTuDN7CfNFi1ob1ol_jW21uFs-QhIAZU>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a565f3024eb.txt <id: 1mYk_QaPflpLnYz2BvkkvfSH548YoONb5>
#> With MIME type:
#> • text/plain
