...
#> Local file:
#> • /tmp/Rtmpo2p5PZ/drive_put_1ccc67172b4f.txt
#> Uploaded into Drive file:
#> • drive_put_1ccc67172b4f.txt <id: 1KCWZj7MT5yRZ5BLCOTnxTfSM316v-Ip2>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ccc67172b4f.txt <id: 1fPMNuwbNc-QwGRTejvb1M4KUrJyLi2NW>
#> With MIME type:
#> • text/plain
