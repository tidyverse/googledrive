...
#> Local file:
#> • /tmp/RtmpYRv1bP/drive_put_189e75ed57e.txt
#> Uploaded into Drive file:
#> • drive_put_189e75ed57e.txt <id: 1gQs-7dmvv_hNJWDqWOeniWaznwrrPLuX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_189e75ed57e.txt <id: 1hJrbZlYxZZmc2jGJKGktF32QA-K2yLoY>
#> With MIME type:
#> • text/plain
