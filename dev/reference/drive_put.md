...
#> Local file:
#> • /tmp/RtmpTWpC2p/drive_put_1b0e5c7d27d1.txt
#> Uploaded into Drive file:
#> • drive_put_1b0e5c7d27d1.txt <id: 19XgwFKvtm6zBWUWxRMXhDDJRJx_PR9ir>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b0e5c7d27d1.txt <id: 1IPN9k-6zGDuisl-6E9AXv16DeqnIWhUF>
#> With MIME type:
#> • text/plain
