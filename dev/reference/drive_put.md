...
#> Local file:
#> • /tmp/RtmpxVc7Ys/drive_put_1b2919a50367.txt
#> Uploaded into Drive file:
#> • drive_put_1b2919a50367.txt <id: 1pE0XWKCIY2etjwteu2ypgoNZb0kNFqr8>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b2919a50367.txt <id: 15AsmXCX--Y2ghEx8StB8LsbKpVJxfeiL>
#> With MIME type:
#> • text/plain
