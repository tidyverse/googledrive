...
#> Local file:
#> • /tmp/RtmpW7kcSO/drive_put_191d3c4212dd.txt
#> Uploaded into Drive file:
#> • drive_put_191d3c4212dd.txt <id: 1JY1cHnRvhmslY5jfo9mpZgvWR7MvBC2z>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_191d3c4212dd.txt <id: 1wLlPouWA_gtRkR4wJhTjrwlPm72uLiXW>
#> With MIME type:
#> • text/plain
