...
#> Local file:
#> • /tmp/RtmpMBWWjU/drive_put_1cca61072c0.txt
#> Uploaded into Drive file:
#> • drive_put_1cca61072c0.txt <id: 1RN7DLhEccRoyBorxYr5u2hgWj28bgHIc>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1cca61072c0.txt <id: 1az-Wb9CbrarqZ9HNFb-q7ZkBz5NYHZ-T>
#> With MIME type:
#> • text/plain
