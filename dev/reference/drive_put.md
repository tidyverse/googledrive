...
#> Local file:
#> • /tmp/RtmpahLTHy/drive_put_1bf9357cb9e6.txt
#> Uploaded into Drive file:
#> • drive_put_1bf9357cb9e6.txt <id: 100oZ7wkDUM3dy_kIUA1qXG1bXd9mbOSf>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bf9357cb9e6.txt <id: 1Y3FBWXY_N1NwRdfBEJPmf0n0ZL-vuv2J>
#> With MIME type:
#> • text/plain
