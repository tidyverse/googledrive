...
#> Local file:
#> • /tmp/RtmpfmCsLs/drive_put_1a431ceec0ac.txt
#> Uploaded into Drive file:
#> • drive_put_1a431ceec0ac.txt <id: 1TlT61hjZLzDBwlvxo7z2_AYMvNNWeVgH>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a431ceec0ac.txt <id: 16u94MxkcwI-Vl7a5n5CUIBJMsWtO-LjO>
#> With MIME type:
#> • text/plain
