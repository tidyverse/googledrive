...
#> Local file:
#> • /tmp/RtmprdqCMa/drive_put_198e4a5bc36d.txt
#> Uploaded into Drive file:
#> • drive_put_198e4a5bc36d.txt <id: 1tAhTVnPedgh1RK6_y5V9A7DT2R0FxWBR>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_198e4a5bc36d.txt <id: 18Z_nQkTZ71JQZzNMegs5H_S9TAuV3_oe>
#> With MIME type:
#> • text/plain
