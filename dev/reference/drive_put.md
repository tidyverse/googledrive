...
#> Local file:
#> • /tmp/Rtmp3Bcfi6/drive_put_18957fd96cd2.txt
#> Uploaded into Drive file:
#> • drive_put_18957fd96cd2.txt <id: 1nCApKlLBo9PzxO02r9ZT5F4rJ5I9E15C>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_18957fd96cd2.txt <id: 16D9bHzUaV_ERYITxBiuieGmNFJ_8eEmJ>
#> With MIME type:
#> • text/plain
