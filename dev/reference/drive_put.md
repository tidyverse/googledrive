...
#> Local file:
#> • /tmp/Rtmpu6j3GK/drive_put_19c73c22b09a.txt
#> Uploaded into Drive file:
#> • drive_put_19c73c22b09a.txt <id: 12sO0kNxsoXlzyMBw0vw2wnWbtu_5VvFG>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19c73c22b09a.txt <id: 1fdJdoM70xfhHVKEXNduDSQWvOzVcDwse>
#> With MIME type:
#> • text/plain
