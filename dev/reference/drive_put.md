...
#> Local file:
#> • /tmp/RtmpFDZ4Bg/drive_put_1b504c99a99.txt
#> Uploaded into Drive file:
#> • drive_put_1b504c99a99.txt <id: 1ZVNAZa5IT4llND-UopDRi9CnMe0U4bq5>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b504c99a99.txt <id: 1_dbkoXtC20u53NAV-IR4ysdov9vHHP2i>
#> With MIME type:
#> • text/plain
