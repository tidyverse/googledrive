...
#> Local file:
#> • /tmp/Rtmp3zKbpw/drive_put_1bbe3ab6c8bd.txt
#> Uploaded into Drive file:
#> • drive_put_1bbe3ab6c8bd.txt <id: 11j6nv9EFuj8SgDZWwQUGOMcx1SY9yel0>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bbe3ab6c8bd.txt <id: 1LRvE-bkrA6c-S_Gr2NwiQL-gijr2bYEU>
#> With MIME type:
#> • text/plain
