...
#> Local file:
#> • /tmp/RtmpCobbNb/drive_put_1968541ee4cf.txt
#> Uploaded into Drive file:
#> • drive_put_1968541ee4cf.txt <id: 1r101VjfLFV8wlgntVpdtOvXSgmZoc2-7>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1968541ee4cf.txt <id: 12LOSf2p25iggnd7Zl2awtohThqhwrFmJ>
#> With MIME type:
#> • text/plain
