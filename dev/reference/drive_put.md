...
#> Local file:
#> • /tmp/RtmpgaLL8l/drive_put_19933a934eb5.txt
#> Uploaded into Drive file:
#> • drive_put_19933a934eb5.txt <id: 1F4Lu77bZTm9b_evH90lSR_9OS1dO6Xvx>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19933a934eb5.txt <id: 11PTjXsEQ5acI1KC92KzDclfjr9tkqs-B>
#> With MIME type:
#> • text/plain
