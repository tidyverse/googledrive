...
#> Local file:
#> • /tmp/Rtmpvr2Zoz/drive_put_19f86f3b3cdf.txt
#> Uploaded into Drive file:
#> • drive_put_19f86f3b3cdf.txt <id: 1O2UVv3NYEyMUPvwDFVIkBBD5NYgeE9On>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19f86f3b3cdf.txt <id: 11Oy6PD_MPoACfU1bVgiUHo66_Lp2HkMw>
#> With MIME type:
#> • text/plain
