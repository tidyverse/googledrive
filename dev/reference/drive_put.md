...
#> Local file:
#> • /tmp/RtmpBIj7lR/drive_put_1be4640cce27.txt
#> Uploaded into Drive file:
#> • drive_put_1be4640cce27.txt <id: 1MmtvPuEDzo3hJw1NOyfP4BX8n01hXnOo>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1be4640cce27.txt <id: 1S5p-KHr7HTEJ7d0Zykp0BEclGiR_jxTr>
#> With MIME type:
#> • text/plain
