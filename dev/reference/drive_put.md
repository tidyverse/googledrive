...
#> Local file:
#> • /tmp/RtmpQt2ra2/drive_put_19b3a1675c6.txt
#> Uploaded into Drive file:
#> • drive_put_19b3a1675c6.txt <id: 1XWQz72FO9zPpEbDDVfqaNpGlmvBAmeqc>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19b3a1675c6.txt <id: 1Nh_j4JUXURdEvwZLvsj-MTzoZHifNFA->
#> With MIME type:
#> • text/plain
