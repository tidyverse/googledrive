...
#> Local file:
#> • /tmp/RtmpirmmX4/drive_put_1bde4925774c.txt
#> Uploaded into Drive file:
#> • drive_put_1bde4925774c.txt <id: 1H5-1OGyQOPPzh3uUu7PBmmI9h3H5f-rF>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bde4925774c.txt <id: 1LLUUj5mYTgjntfFndFBgDRdMf-Zx5Xoe>
#> With MIME type:
#> • text/plain
