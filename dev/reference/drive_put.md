...
#> Local file:
#> • /tmp/Rtmp6hjyOJ/drive_put_19143a9b5d7d.txt
#> Uploaded into Drive file:
#> • drive_put_19143a9b5d7d.txt <id: 1mycZbl5SujcbjRTkud52OaPlDesKmrlM>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19143a9b5d7d.txt <id: 1xIH_m4M_rPT7zXGSrhYP97lOtO3crzhW>
#> With MIME type:
#> • text/plain
