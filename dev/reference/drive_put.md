...
#> Local file:
#> • /tmp/RtmpC6z1Ky/drive_put_1c9b2ec9cbf6.txt
#> Uploaded into Drive file:
#> • drive_put_1c9b2ec9cbf6.txt <id: 1JKQqrWpYtzVUuwrJqIbwNUYeRXeXyxnp>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c9b2ec9cbf6.txt <id: 1V9_W7_qq_XPFd6fcqKrpaRZ8XWxllTpJ>
#> With MIME type:
#> • text/plain
