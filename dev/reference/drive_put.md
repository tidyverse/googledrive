...
#> Local file:
#> • /tmp/RtmpyD7LYZ/drive_put_195e3de9040f.txt
#> Uploaded into Drive file:
#> • drive_put_195e3de9040f.txt <id: 1s7vF9d4xUtOeJLdJOusedIVnqj1Yvj6J>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_195e3de9040f.txt <id: 1wt65LyikzeWdSQUBaAacXHz86w9J4eyk>
#> With MIME type:
#> • text/plain
