...
#> Local file:
#> • /tmp/RtmpVwIZQb/drive_put_1ccb21b32205.txt
#> Uploaded into Drive file:
#> • drive_put_1ccb21b32205.txt <id: 1ScA6lSRk0ZVPn2zLAWYXPdxgIJOyeG2->
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ccb21b32205.txt <id: 1uLXAqynn7wLKXZZEPVPEN0YHJ2ClrMiJ>
#> With MIME type:
#> • text/plain
