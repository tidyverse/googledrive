...
#> Local file:
#> • /tmp/Rtmprh7z1Y/drive_put_1bad4d1f42c2.txt
#> Uploaded into Drive file:
#> • drive_put_1bad4d1f42c2.txt <id: 1QIgVVxYMGaEcuG2PeyAvV4ulFaAI75fH>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bad4d1f42c2.txt <id: 1aUO0N_D62gzavSLih9yeakYLNzkx81-T>
#> With MIME type:
#> • text/plain
