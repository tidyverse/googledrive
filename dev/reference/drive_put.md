...
#> Local file:
#> • /tmp/RtmpudYTYp/drive_put_1c1350bd352e.txt
#> Uploaded into Drive file:
#> • drive_put_1c1350bd352e.txt <id: 1T2Sd1iSoK0H4-Ptgh-n_XaXmrhCjHHGT>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c1350bd352e.txt <id: 1-I34NNvuLX02BsK-3PSh8lAwMaZRfk96>
#> With MIME type:
#> • text/plain
