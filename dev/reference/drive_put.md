...
#> Local file:
#> • /tmp/RtmpxAFlxb/drive_put_1b531c6a999a.txt
#> Uploaded into Drive file:
#> • drive_put_1b531c6a999a.txt <id: 1n1bUIeokTxoeOG79ZgacEG2KAU1EG4fN>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b531c6a999a.txt <id: 1e8LjyGdHAbyIaklWGGJVyKuVpirI_QwK>
#> With MIME type:
#> • text/plain
