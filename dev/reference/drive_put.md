...
#> Local file:
#> • /tmp/RtmpCtRrTH/drive_put_19986afb85bb.txt
#> Uploaded into Drive file:
#> • drive_put_19986afb85bb.txt <id: 1ZRK7TFaXNRxgNMSaDqL42tyMlVEVwmkp>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19986afb85bb.txt <id: 1LlQlSqwDKVBCGZ5hCmzhQh8TS4eRaLw6>
#> With MIME type:
#> • text/plain
