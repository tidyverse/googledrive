...
#> Local file:
#> • /tmp/Rtmp4IvF13/drive_put_1bb83acc8e0.txt
#> Uploaded into Drive file:
#> • drive_put_1bb83acc8e0.txt <id: 1vI2SMkCh11f2gIZbLWq7iPoljqlDts7u>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bb83acc8e0.txt <id: 1Jd72PF6AlNNpv9cTVdH8YTaYNx4SW-gt>
#> With MIME type:
#> • text/plain
