...
#> Local file:
#> • /tmp/RtmpzCjozi/drive_put_1e0e3668da50.txt
#> Uploaded into Drive file:
#> • drive_put_1e0e3668da50.txt <id: 1BuoFq5cPt1zDXsRhIVEygb8yJIoN4KXL>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1e0e3668da50.txt <id: 106zr8yLfnwlRKUIFF-iRbkwYtvC_XdEr>
#> With MIME type:
#> • text/plain
