...
#> Local file:
#> • /tmp/RtmpPIvzwU/drive_put_1b9a4abeb6ed.txt
#> Uploaded into Drive file:
#> • drive_put_1b9a4abeb6ed.txt <id: 1x4MB-YZJ8UxY6KtJxc8AFfOXCpnuGycM>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b9a4abeb6ed.txt <id: 1I1vHBn7iNTQRvfBG1nlwVwHcNi2aTFwS>
#> With MIME type:
#> • text/plain
