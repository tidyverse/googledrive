...
#> Local file:
#> • /tmp/Rtmpu3v2Wn/drive_put_1beb7438a417.txt
#> Uploaded into Drive file:
#> • drive_put_1beb7438a417.txt <id: 1JzxbP1ZDQ_gL58ZYs_WfPL-0ICINnnqq>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1beb7438a417.txt <id: 1r09rZk4VHfQ4vMyIkKNIuHgsjORZllPI>
#> With MIME type:
#> • text/plain
