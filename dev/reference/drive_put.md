...
#> Local file:
#> • /tmp/RtmpCUAeN5/drive_put_1a0a49c617f7.txt
#> Uploaded into Drive file:
#> • drive_put_1a0a49c617f7.txt <id: 1-EhiPLp89kHiF6ONCD6xkC48dmDxV-_g>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a0a49c617f7.txt <id: 1rAiXnk5j2OB3vw_0BXetFv_7cISxMPnl>
#> With MIME type:
#> • text/plain
