...
#> Local file:
#> • /tmp/RtmpJZLOjh/drive_put_1bd83d98c8b9.txt
#> Uploaded into Drive file:
#> • drive_put_1bd83d98c8b9.txt <id: 139kqSshdBnLg-p5t4sl4fFTKteWL-y_C>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bd83d98c8b9.txt <id: 1IkT6SAxjLaJV8j3H2SY4JMDPOBbdXGMb>
#> With MIME type:
#> • text/plain
