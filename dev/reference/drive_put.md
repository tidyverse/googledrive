...
#> Local file:
#> • /tmp/RtmpQL3RA7/drive_put_18646540b0d3.txt
#> Uploaded into Drive file:
#> • drive_put_18646540b0d3.txt <id: 1yiGT7kDkneeSMNqEmkdt1sdMrwCs7ctT>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_18646540b0d3.txt <id: 12uTBXRaMZjCx05bv6wWlpGnCTMPjzFyj>
#> With MIME type:
#> • text/plain
