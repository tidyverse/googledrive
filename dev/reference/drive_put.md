...
#> Local file:
#> • /tmp/RtmpVoOuZ2/drive_put_1ba51e2e5b8a.txt
#> Uploaded into Drive file:
#> • drive_put_1ba51e2e5b8a.txt <id: 1V4gx_NbIDNxvjUUKDbbCt4vCtawTU_ar>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ba51e2e5b8a.txt <id: 128blzE0U5QmdfSolMa5TDQZl1qK8P0A4>
#> With MIME type:
#> • text/plain
