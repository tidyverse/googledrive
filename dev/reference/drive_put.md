...
#> Local file:
#> • /tmp/RtmpQGoZ5z/drive_put_1a3f6e4a2f68.txt
#> Uploaded into Drive file:
#> • drive_put_1a3f6e4a2f68.txt <id: 1rpsuQQ2EluPbh8u2O_Vkh7ZH8UErBVNX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a3f6e4a2f68.txt <id: 1YeFw0mTyfW9eIWsDgYFHFGVYuJ0vqp7U>
#> With MIME type:
#> • text/plain
