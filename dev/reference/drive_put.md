...
#> Local file:
#> • /tmp/Rtmpagw5pB/drive_put_1a1d54a6b229.txt
#> Uploaded into Drive file:
#> • drive_put_1a1d54a6b229.txt <id: 1y_IPtlcvPVPfKQCGJkYd5O4ICpUvulQH>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a1d54a6b229.txt <id: 1dVWs3cBAcIek8tNO3DoYmJUFwyAegbtN>
#> With MIME type:
#> • text/plain
