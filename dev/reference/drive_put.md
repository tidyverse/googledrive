...
#> Local file:
#> • /tmp/RtmpmrO7ps/drive_put_1d6e308a00a5.txt
#> Uploaded into Drive file:
#> • drive_put_1d6e308a00a5.txt <id: 1RiPEAMYKlu_-GwBFJhcSmLh4I0jkCCuG>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1d6e308a00a5.txt <id: 1ZVG3QzhAE4WfDNJ4-OAv9Sw2tgaT_F5T>
#> With MIME type:
#> • text/plain
