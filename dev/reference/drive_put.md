...
#> Local file:
#> • /tmp/RtmpmvO7IF/drive_put_1b4d6e7bdb69.txt
#> Uploaded into Drive file:
#> • drive_put_1b4d6e7bdb69.txt <id: 1bNKxeO70_4CKoBureLdidIbcb7nQQeJ5>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b4d6e7bdb69.txt <id: 1cT9IRN_yzG15I5_vrUejo7qNL0ObjATF>
#> With MIME type:
#> • text/plain
