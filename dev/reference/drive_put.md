...
#> Local file:
#> • /tmp/RtmpAnXcp6/drive_put_1a533d2644e1.txt
#> Uploaded into Drive file:
#> • drive_put_1a533d2644e1.txt <id: 17Vf-sQn8qmSDD4TJsrWJTFoCQUUXPHvF>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a533d2644e1.txt <id: 1ThMVOMQhicChSj4rxE3pyAMQT-lMZdCR>
#> With MIME type:
#> • text/plain
