...
#> Local file:
#> • /tmp/RtmpdhXVaH/drive_put_1a8b7633c0ae.txt
#> Uploaded into Drive file:
#> • drive_put_1a8b7633c0ae.txt <id: 1GXSCSro3B3XkzS_6Y-QREzdkOV_PLL0a>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a8b7633c0ae.txt <id: 1VA6IYrZ7mH9Gf0vJOiH1LTdBZdgnSEvb>
#> With MIME type:
#> • text/plain
