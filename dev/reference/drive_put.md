...
#> Local file:
#> • /tmp/RtmpCKV0gY/drive_put_1bbd577b5bed.txt
#> Uploaded into Drive file:
#> • drive_put_1bbd577b5bed.txt <id: 1UmxiIr9JILSWkPveXC_hRRi3ZJYN1P2->
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bbd577b5bed.txt <id: 1QprLm2RQWfhU41sSB_Nxu54kDIdd-q55>
#> With MIME type:
#> • text/plain
