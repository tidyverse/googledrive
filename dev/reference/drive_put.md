...
#> Local file:
#> • /tmp/RtmpljPdPg/drive_put_1ce35d989586.txt
#> Uploaded into Drive file:
#> • drive_put_1ce35d989586.txt <id: 1JjFxu7eXEsAEE73IXuCsXXS3CaMdH-iC>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ce35d989586.txt <id: 18V3FMvELeaQMlTc-TfGBrQyAhoefV-pc>
#> With MIME type:
#> • text/plain
