...
#> Local file:
#> • /tmp/RtmpLoeoks/drive_put_1900634a97c8.txt
#> Uploaded into Drive file:
#> • drive_put_1900634a97c8.txt <id: 1nMwHButGYdlNmFG2JQhtC5BVEqPyG-pD>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1900634a97c8.txt <id: 18SoLPuChK0N4bFFplZ2sp-9hmETQCiHl>
#> With MIME type:
#> • text/plain
