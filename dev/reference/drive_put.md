...
#> Local file:
#> • /tmp/Rtmp26Ebtj/drive_put_19487b80fabe.txt
#> Uploaded into Drive file:
#> • drive_put_19487b80fabe.txt <id: 1QWTrIBTp5NUb2uTtZOGC3nXmVTtJ-bD_>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19487b80fabe.txt <id: 1Iw9Wm6esNanqlVg8ZQMk1ytdDW5kGLQJ>
#> With MIME type:
#> • text/plain
