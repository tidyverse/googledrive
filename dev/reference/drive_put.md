...
#> Local file:
#> • /tmp/RtmpOZS1iL/drive_put_19d0cc6b7bd.txt
#> Uploaded into Drive file:
#> • drive_put_19d0cc6b7bd.txt <id: 1Cir4Bv94qOT6RbRSYV93HG6kaFH5Q6Gy>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19d0cc6b7bd.txt <id: 1PH0Xt0ZGMlhoW9I3Ks_HtaaqulKnD_Xk>
#> With MIME type:
#> • text/plain
