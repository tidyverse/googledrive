...
#> Local file:
#> • /tmp/RtmpbSvgyR/drive_put_19b562782016.txt
#> Uploaded into Drive file:
#> • drive_put_19b562782016.txt <id: 10svxLOpVGeI8-2HXellMx9lQtvB7vUEg>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19b562782016.txt <id: 1ss18c3jDNyoYocrQoFbEPJSymKRxcxkC>
#> With MIME type:
#> • text/plain
