...
#> Local file:
#> • /tmp/RtmphXI8l2/drive_put_1b1c5ffa6b3.txt
#> Uploaded into Drive file:
#> • drive_put_1b1c5ffa6b3.txt <id: 13o8oqrHBY1ZPWeBafvOXmZwZCLfkaN8k>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b1c5ffa6b3.txt <id: 1kR6CpqsWWSIGl6HiBz4JqVWjWf3ILf_E>
#> With MIME type:
#> • text/plain
