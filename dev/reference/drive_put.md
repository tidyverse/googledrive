...
#> Local file:
#> • /tmp/RtmpECwlaY/drive_put_19ae6903fff4.txt
#> Uploaded into Drive file:
#> • drive_put_19ae6903fff4.txt <id: 1DxuUwt0KyQC9H3dr5kSvaaYEfslKFIR7>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19ae6903fff4.txt <id: 1XCzVlmz1sMvmNDZc-3Ug6SPClsdxbx2n>
#> With MIME type:
#> • text/plain
