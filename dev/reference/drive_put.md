...
#> Local file:
#> • /tmp/Rtmp8ILGvB/drive_put_19c817caa963.txt
#> Uploaded into Drive file:
#> • drive_put_19c817caa963.txt <id: 1iRv4gfWyKzOaW_XR-MUXoGEmTWtEhWdq>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19c817caa963.txt <id: 1FtmwQPYIWW48UF4C74e0l-CNhBlzU37P>
#> With MIME type:
#> • text/plain
