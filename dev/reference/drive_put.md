...
#> Local file:
#> • /tmp/Rtmp6QlwOL/drive_put_19b21b221865.txt
#> Uploaded into Drive file:
#> • drive_put_19b21b221865.txt <id: 1tjBOemZ1MI24Kzqh4h9FHY6Te_1W1rD5>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19b21b221865.txt <id: 10Ao6m_Z_MgEqsZNsyJ1iaCVCU1FrKMPo>
#> With MIME type:
#> • text/plain
