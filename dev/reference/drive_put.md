...
#> Local file:
#> • /tmp/Rtmpu2o4XU/drive_put_19cd3eb951c8.txt
#> Uploaded into Drive file:
#> • drive_put_19cd3eb951c8.txt <id: 1O6N3fKSw7ZTz9COi8z9Wu-0tnLGGR8xY>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19cd3eb951c8.txt <id: 1mTf07QYEmGNpe2TrpszLw8I7xtJV4FeM>
#> With MIME type:
#> • text/plain
