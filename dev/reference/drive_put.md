...
#> Local file:
#> • /tmp/Rtmp9eA9MT/drive_put_1dbc4745ace1.txt
#> Uploaded into Drive file:
#> • drive_put_1dbc4745ace1.txt <id: 1z6T4H3OTHU4__RyMnVVxmCOTCl4hSZlE>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1dbc4745ace1.txt <id: 1ZSZ1F7ZZj0XGVPXgo9WVjze7QIZgG1Eb>
#> With MIME type:
#> • text/plain
