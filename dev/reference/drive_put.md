...
#> Local file:
#> • /tmp/Rtmpw2fYAK/drive_put_1b5077963a2b.txt
#> Uploaded into Drive file:
#> • drive_put_1b5077963a2b.txt <id: 1y3eFAJTuiun7YnhDGZW60HdYywMfWTQp>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b5077963a2b.txt <id: 1Vub0CMtwWX4Yp331NoI3WjJEveELP1s7>
#> With MIME type:
#> • text/plain
