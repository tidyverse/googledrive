...
#> Local file:
#> • /tmp/RtmpnpjMPa/drive_put_1c9227c2557c.txt
#> Uploaded into Drive file:
#> • drive_put_1c9227c2557c.txt <id: 1_v0KHyFDFiN56sy7qPkLLaaASTATZB7->
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c9227c2557c.txt <id: 12bNJiQz7z4L0cToGhmQLVi0W1riyaNaR>
#> With MIME type:
#> • text/plain
