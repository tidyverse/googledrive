...
#> Local file:
#> • /tmp/RtmpZr0GXh/drive_put_1bac5027a6dc.txt
#> Uploaded into Drive file:
#> • drive_put_1bac5027a6dc.txt <id: 16HXgzKAfzW4865tAoOk1IrrZd2jbYAhL>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bac5027a6dc.txt <id: 1tZQK_igIVZq7xnmeSuPq2uJkra5n092T>
#> With MIME type:
#> • text/plain
