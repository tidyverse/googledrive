...
#> Local file:
#> • /tmp/RtmphTOeLV/drive_put_1a1d5df95245.txt
#> Uploaded into Drive file:
#> • drive_put_1a1d5df95245.txt <id: 1J4BKS6RG21VMN87GpMcg8sAzen-30ZOh>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a1d5df95245.txt <id: 1CUmocLY2Wrm0DFhPKFM8udoF_zCXUt_->
#> With MIME type:
#> • text/plain
