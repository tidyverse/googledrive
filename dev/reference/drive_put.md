...
#> Local file:
#> • /tmp/RtmpDVACkG/drive_put_1bb15f45ff0f.txt
#> Uploaded into Drive file:
#> • drive_put_1bb15f45ff0f.txt <id: 1ooC5HHt7mnBddGsWKOyAlohbjETIPDuf>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bb15f45ff0f.txt <id: 1aBk0mSvewhpPEbxk0cVYrw6DA1mEIGYH>
#> With MIME type:
#> • text/plain
