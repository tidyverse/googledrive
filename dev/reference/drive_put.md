...
#> Local file:
#> • /tmp/RtmpnuPw1A/drive_put_1c5d4aa081d.txt
#> Uploaded into Drive file:
#> • drive_put_1c5d4aa081d.txt <id: 1bwtIx6DOPAgM4G5qwHvogNDWU6NWNg_j>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1c5d4aa081d.txt <id: 18Zbl3pLnU44Ave90bGyTlF4Khtyr4m-m>
#> With MIME type:
#> • text/plain
