...
#> Local file:
#> • /tmp/RtmpLhwifn/drive_put_1a7f5d1ba174.txt
#> Uploaded into Drive file:
#> • drive_put_1a7f5d1ba174.txt <id: 1fweGzTNuDxHcrbZVvDbq8_3XpUX-TMzU>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a7f5d1ba174.txt <id: 1wetzIJmGGfyVFg2w7n8n_VoIJgkj-Pop>
#> With MIME type:
#> • text/plain
