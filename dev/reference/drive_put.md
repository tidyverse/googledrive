...
#> Local file:
#> • /tmp/Rtmp3IumQY/drive_put_1cb57178d006.txt
#> Uploaded into Drive file:
#> • drive_put_1cb57178d006.txt <id: 14mTAdIKsmzFdjwlaMaSyFOvKTWXwE6Br>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1cb57178d006.txt <id: 1cL8AImks5FBqgNgsaYHlkEM-tVSTXaDC>
#> With MIME type:
#> • text/plain
