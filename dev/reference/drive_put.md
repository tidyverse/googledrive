...
#> Local file:
#> • /tmp/RtmpQOCLky/drive_put_19f96bac0cc1.txt
#> Uploaded into Drive file:
#> • drive_put_19f96bac0cc1.txt <id: 17wsZQrZmtILs1MaWcy088XX5IoywQGll>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19f96bac0cc1.txt <id: 1_Co0namNFr9JZ-YG5qThs5dkPQcs-SXF>
#> With MIME type:
#> • text/plain
