...
#> Local file:
#> • /tmp/Rtmpg0jpRM/drive_put_1ca4704d39bd.txt
#> Uploaded into Drive file:
#> • drive_put_1ca4704d39bd.txt <id: 1-AG7haggXpYSIrjyJw6SWeEjdgKbT8uM>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1ca4704d39bd.txt <id: 1jIvIu7v-JtKduoYWRpce94Tp9RREFkl3>
#> With MIME type:
#> • text/plain
