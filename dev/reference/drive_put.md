...
#> Local file:
#> • /tmp/RtmpGVQrwi/drive_put_1bab6511aa5.txt
#> Uploaded into Drive file:
#> • drive_put_1bab6511aa5.txt <id: 1h8A5j7lcD94aYq1oZHJFAlZl-rVvpFUI>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bab6511aa5.txt <id: 18lSvozNzmztVGsFCyqgAVbYcVL_5vzQG>
#> With MIME type:
#> • text/plain
