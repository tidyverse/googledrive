...
#> Local file:
#> • /tmp/Rtmpa1W9VF/drive_put_19dd155ff3bf.txt
#> Uploaded into Drive file:
#> • drive_put_19dd155ff3bf.txt <id: 1M9DZ6sMc-AoVy7gJDpn9USLgGCRcP225>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19dd155ff3bf.txt <id: 1DR8ULJgcfpLwAXqC43eDBdl_aHfwYRAm>
#> With MIME type:
#> • text/plain
