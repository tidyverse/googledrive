...
#> Local file:
#> • /tmp/RtmpNXkWtE/drive_put_1986779236ef.txt
#> Uploaded into Drive file:
#> • drive_put_1986779236ef.txt <id: 1IQY1OEQgIFojq4UIw5wGIiYG4x2UcCfz>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1986779236ef.txt <id: 1MKpSfnVcwM8TRVN5hF56D2S3gp1TPPWs>
#> With MIME type:
#> • text/plain
