...
#> Local file:
#> • /tmp/Rtmp4BsmJk/drive_put_1883280644b8.txt
#> Uploaded into Drive file:
#> • drive_put_1883280644b8.txt <id: 1c5zz--SHEwBTGLgOCxuOblorD-dolA43>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1883280644b8.txt <id: 13-cVABzTxhAYhQoFPq0kOSvExVzJoP4y>
#> With MIME type:
#> • text/plain
