...
#> Local file:
#> • /tmp/RtmpowQNBR/drive_put_199b7b8765a9.txt
#> Uploaded into Drive file:
#> • drive_put_199b7b8765a9.txt <id: 18xYYmgQzQfSqqNknQI_5YHRgdGURaOlo>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_199b7b8765a9.txt <id: 1PppIqUIYXcwrOyLbZx6UOcXI3fAIkE7R>
#> With MIME type:
#> • text/plain
