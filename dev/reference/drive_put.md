...
#> Local file:
#> • /tmp/Rtmpmw5uBD/drive_put_1a4b18108578.txt
#> Uploaded into Drive file:
#> • drive_put_1a4b18108578.txt <id: 1Xp6-deMxrIcYurXKQbLXXFwqfHWu2Mld>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a4b18108578.txt <id: 1IKMq9Bvy0VXI55EFje_0_nMOcqp0OkiF>
#> With MIME type:
#> • text/plain
