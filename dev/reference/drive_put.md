...
#> Local file:
#> • /tmp/Rtmp9Qs504/drive_put_1a29b5cceb8.txt
#> Uploaded into Drive file:
#> • drive_put_1a29b5cceb8.txt <id: 1R47jbE0LjZDtPjPF9HbcqWFpqFXznXqA>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a29b5cceb8.txt <id: 1-rQ-D5Ofx-w7ZnJnVBD-wYOs1xLRr_3j>
#> With MIME type:
#> • text/plain
