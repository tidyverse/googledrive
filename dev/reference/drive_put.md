...
#> Local file:
#> • /tmp/RtmpHnAxKH/drive_put_1f0419a33fc2.txt
#> Uploaded into Drive file:
#> • drive_put_1f0419a33fc2.txt <id: 1fMFus-SHFP-mtd0X_MlfW2LEu1YT0mge>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1f0419a33fc2.txt <id: 1_z6Rq1sChLZ6f6p7bZ8VyuBIHmaJG4aw>
#> With MIME type:
#> • text/plain
