...
#> Local file:
#> • /tmp/Rtmp9GWAWY/drive_put_1bd4dace84.txt
#> Uploaded into Drive file:
#> • drive_put_1bd4dace84.txt <id: 1aAL2j3JDXhFrTlvh-bxoD96BvYn3BlqK>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bd4dace84.txt <id: 1Blhqgl6OFnR1q1VnJwBRHhuIC3H4EBEU>
#> With MIME type:
#> • text/plain
