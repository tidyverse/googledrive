...
#> Local file:
#> • /tmp/RtmpyMGD4w/drive_put_1bd538d004e9.txt
#> Uploaded into Drive file:
#> • drive_put_1bd538d004e9.txt <id: 1cTvt_x7ixVwf7X29ON-bI1KnBcSmvrlX>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bd538d004e9.txt <id: 13p8vyzm_a1BY5LbIl-M-JujTlaE7NTjr>
#> With MIME type:
#> • text/plain
