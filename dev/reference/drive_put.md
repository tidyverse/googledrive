...
#> Local file:
#> • /tmp/Rtmpn1ooEL/drive_put_1bd957cbc6ac.txt
#> Uploaded into Drive file:
#> • drive_put_1bd957cbc6ac.txt <id: 10TkImYMpUlcd6qUWTI_IuCgOeKfdO8NH>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bd957cbc6ac.txt <id: 1MP1BEWhzD71zyegnr-yeGAkshBIIkEiY>
#> With MIME type:
#> • text/plain
