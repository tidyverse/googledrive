...
#> Local file:
#> • /tmp/RtmprQunru/drive_put_1a032c0e983b.txt
#> Uploaded into Drive file:
#> • drive_put_1a032c0e983b.txt <id: 1tGhlqxGW0EpGtJ5_2jUhmwsUfVsgkCRo>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a032c0e983b.txt <id: 1RKalQ7lZhzBJWILB0Jc9oCtiKLhaHIh3>
#> With MIME type:
#> • text/plain
