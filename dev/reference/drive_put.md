...
#> Local file:
#> • /tmp/Rtmp6HizWm/drive_put_1a3c9cefef8.txt
#> Uploaded into Drive file:
#> • drive_put_1a3c9cefef8.txt <id: 1gmy7gSv-Ny78ie-uxyAebhhY8xw33wEO>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a3c9cefef8.txt <id: 1N_kja4QGKWwBt1lvULY8OSFRMJu0bYFq>
#> With MIME type:
#> • text/plain
