...
#> Local file:
#> • /tmp/RtmpH0ZQTZ/drive_put_1b4b22d4f6c1.txt
#> Uploaded into Drive file:
#> • drive_put_1b4b22d4f6c1.txt <id: 1OZ7MeyWY3PeGs2AC4hH5C2shxULPopP2>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b4b22d4f6c1.txt <id: 1aq6LTNe-HcG-AWuoxjWtu6UeS1cMd5jo>
#> With MIME type:
#> • text/plain
