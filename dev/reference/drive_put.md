...
#> Local file:
#> • /tmp/RtmpJ5gRCN/drive_put_187219a8a4b4.txt
#> Uploaded into Drive file:
#> • drive_put_187219a8a4b4.txt <id: 1TulffjeEa4K637h5KT5TmHM3PKUjxNCO>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_187219a8a4b4.txt <id: 1E-oq4b7ja7bU9PEGsoutg1gqI9sdNPLv>
#> With MIME type:
#> • text/plain
