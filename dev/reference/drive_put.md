...
#> Local file:
#> • /tmp/RtmpgaKMku/drive_put_19106d7a5e75.txt
#> Uploaded into Drive file:
#> • drive_put_19106d7a5e75.txt <id: 10qX3HU-Ww9ryLFnuKA9ZEVCVJA4ZsJFj>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19106d7a5e75.txt <id: 1Gqh0GzTHAsvws9MhSwUccZkGJ7SPLCn3>
#> With MIME type:
#> • text/plain
