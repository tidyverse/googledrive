...
#> Local file:
#> • /tmp/RtmpNna0CO/drive_put_1a8741cfcf0e.txt
#> Uploaded into Drive file:
#> • drive_put_1a8741cfcf0e.txt <id: 1CZrrkxHUYrTKxjRHlXZ8OMQjyEyx4awg>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a8741cfcf0e.txt <id: 1-mmrK6xq9E366E5mFJ-iASKIjQND3MkY>
#> With MIME type:
#> • text/plain
