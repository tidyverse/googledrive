...
#> Local file:
#> • /tmp/Rtmp5galI2/drive_put_1b7e4eeccd62.txt
#> Uploaded into Drive file:
#> • drive_put_1b7e4eeccd62.txt <id: 1ZcMr2__NzpvRlOK4_5n_CFUW7mOwcDGC>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b7e4eeccd62.txt <id: 1JH0ijcGQp2HE0avhrlOmfZVobV5-a1hX>
#> With MIME type:
#> • text/plain
