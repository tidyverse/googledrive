...
#> Local file:
#> • /tmp/Rtmpz3B5pb/drive_put_198d4dbd7b35.txt
#> Uploaded into Drive file:
#> • drive_put_198d4dbd7b35.txt <id: 1WZvDaeKF8EyCIhxtZSZQTqJ_OE8_80Dg>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_198d4dbd7b35.txt <id: 1Qsuz5_Xovku9hj23XtcHy3gbLIrKgFLW>
#> With MIME type:
#> • text/plain
