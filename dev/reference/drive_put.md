...
#> Local file:
#> • /tmp/RtmpWrpKMe/drive_put_1b1f44cb2e9e.txt
#> Uploaded into Drive file:
#> • drive_put_1b1f44cb2e9e.txt <id: 180WRQDF7995R9bvUa1iqAJjvz8trfV4j>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b1f44cb2e9e.txt <id: 1v4-Ef4CvNk53oTxmDfBvpCOtjq3utQrF>
#> With MIME type:
#> • text/plain
