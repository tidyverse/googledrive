...
#> Local file:
#> • /tmp/RtmpJbtZC2/drive_put_19062f27a03f.txt
#> Uploaded into Drive file:
#> • drive_put_19062f27a03f.txt <id: 1Aj_cDfnfYS7niYaB1VPfOSQfUCTqK9Fx>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19062f27a03f.txt <id: 1y5gfIQtyQOwz7iYfUWta016t_7GEsVmI>
#> With MIME type:
#> • text/plain
