...
#> Local file:
#> • /tmp/RtmpO1N6yB/drive_put_1cbd5800e9a6.txt
#> Uploaded into Drive file:
#> • drive_put_1cbd5800e9a6.txt <id: 19fPLRGfuBy0Eus2nljHRI-m_KyU76En7>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1cbd5800e9a6.txt <id: 1Rio8SIAtqeSN5PDrLIDvIDts6rDX6CAm>
#> With MIME type:
#> • text/plain
