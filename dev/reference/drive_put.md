...
#> Local file:
#> • /tmp/RtmprktHm1/drive_put_1a062f4f7d4f.txt
#> Uploaded into Drive file:
#> • drive_put_1a062f4f7d4f.txt <id: 1U4_I5DZvyvbeoqOnFVZLgUisSHvlzoyU>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a062f4f7d4f.txt <id: 1lu_LOv_1QIjYwt91eoQCJT_YnKOBAXJG>
#> With MIME type:
#> • text/plain
