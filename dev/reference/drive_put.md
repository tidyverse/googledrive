...
#> Local file:
#> • /tmp/RtmpB8wQKd/drive_put_191661c5f8b6.txt
#> Uploaded into Drive file:
#> • drive_put_191661c5f8b6.txt <id: 1sI2RvjlVUq8JBBUrtwy-IxumShLztUKP>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_191661c5f8b6.txt <id: 1wmJCoRldm_jamKkbYAg1VGMTUqBU6nmK>
#> With MIME type:
#> • text/plain
