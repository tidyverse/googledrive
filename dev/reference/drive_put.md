...
#> Local file:
#> • /tmp/RtmpzEk5A0/drive_put_1bae4afcedce.txt
#> Uploaded into Drive file:
#> • drive_put_1bae4afcedce.txt <id: 1zi0td8jaLdUJcZX8ojWyKKXLbc8JHm1i>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1bae4afcedce.txt <id: 1X-fvC9nRMzuJZX1XqbQaBBy0DChoLG3Q>
#> With MIME type:
#> • text/plain
