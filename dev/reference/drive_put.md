...
#> Local file:
#> • /tmp/Rtmpys7mTl/drive_put_1b424d4d84ed.txt
#> Uploaded into Drive file:
#> • drive_put_1b424d4d84ed.txt <id: 1BHjLDN6U77e-9QtZbrc-C1xiJius-3b0>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b424d4d84ed.txt <id: 1JHpohMWEnM1Xm1ZqHuWgexy4-H8kc4HO>
#> With MIME type:
#> • text/plain
