...
#> Local file:
#> • /tmp/Rtmp3WTRAJ/drive_put_1a8deb26092.txt
#> Uploaded into Drive file:
#> • drive_put_1a8deb26092.txt <id: 1on1gYnJV1oF65Lvz4jF6-Jr2pdPhOUaN>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1a8deb26092.txt <id: 1KOP9ZVBMdXyeqdto7lwVMopthVR1ODSt>
#> With MIME type:
#> • text/plain
