...
#> Local file:
#> • /tmp/RtmpMdIKis/drive_put_1b572b33103e.txt
#> Uploaded into Drive file:
#> • drive_put_1b572b33103e.txt <id: 1t9_9fYnj8SvUzOTPmY0ZEkLtGBD5lzS3>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_1b572b33103e.txt <id: 1HFfhIcLVwFCzWOYacR5oHYyDPXqN88pe>
#> With MIME type:
#> • text/plain
