...
#> Local file:
#> • /tmp/Rtmp4L2boF/drive_put_19587fb43a3f.txt
#> Uploaded into Drive file:
#> • drive_put_19587fb43a3f.txt <id: 1iBbKfp_PrdlB0K7lrZwcXa-jNpL5HMLb>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_19587fb43a3f.txt <id: 1-Wsp_jfeGVXGY30r0cEuiV0IUlNG7jjp>
#> With MIME type:
#> • text/plain
