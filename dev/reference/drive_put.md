...
#> Local file:
#> • /tmp/RtmpRJpd78/drive_put_18fe21cff188.txt
#> Uploaded into Drive file:
#> • drive_put_18fe21cff188.txt <id: 1y_BsGyEjd7pkVlWQc0KaIGxaHhhECWGm>
#> With MIME type:
#> • text/plain
...
#> Created Drive file:
#> • drive_put_18fe21cff188.txt <id: 1J6hdilDO-CWSSqsilNFH4lCQRWBTFGHi>
#> With MIME type:
#> • text/plain
