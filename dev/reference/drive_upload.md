...
#> • chicken-upload.csv <id: 1dpuxmnLAgeRR8RVTvItEPyzPzFgsghoC>
#> With MIME type:
#> • text/csv
...
#>   <id: 19R9wueOnkYbMSvuApoPc6A9TGZnFBko4arAJrqEnsW4>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1QDn97RX3JaNDiaY4UXkBDLhuKZ66mVKl>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1DhYOThoiezmdbssmNzT7LSlNLBr_izzR>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1Cw2D0rmWfFrGKk-9Z1csRNaIYxG5HuBW>
#> With MIME type:
#> • image/jpeg
