...
#> • chicken-upload.csv <id: 1vBINt3qSflL7iwCGcWxkRuD9lrU7aYo7>
#> With MIME type:
#> • text/csv
...
#>   <id: 1vrxJ3APs8uXLpzznZOK_y-CtmElsRed9aOFlD8ROGdc>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1cj00jQ0RyDNmHqOjrXklaRIPxPlsvoru>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1US7kBcv94WYxhI1pV4DWV_O_OyKhChpW>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1I_LzCcYCvPEbdfloB7IKLUZ1MlQ3CmFU>
#> With MIME type:
#> • image/jpeg
