...
#> • chicken-upload.csv <id: 103HOQ88EuwR0YVAJK6kU_otXFRpEW9O9>
#> With MIME type:
#> • text/csv
...
#>   <id: 1MOQF_nfCRL8lHfT8_svDmQcexcY0SBaXl8USs6p43N0>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1aIVgkcqExY7r9xUsQJeNeXapaaUDAvbB>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 19_1xmO8ko4BDwt7YaK0sR2zKpJKYnkkz>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1lcF99TLwI3QnODQHmVF2HHN71WDy5GR->
#> With MIME type:
#> • image/jpeg
