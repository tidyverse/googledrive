...
#> • chicken-upload.csv <id: 11DAD5lHH3AsH1dQGwKixKHaiko2_Nlhq>
#> With MIME type:
#> • text/csv
...
#>   <id: 1ip35UENIwrUdzHT4XvVMJLU8CzXeBrx_mKIHmHIhydU>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1HxJdrp_IQWcrzKgboznN9_qK6F_rMTVj>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1OQw4xNRmNFvXYU0fkdbCqI3roMrb2DRh>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1kiWSW6itQl2HzeXX04ok3Qd8A1soyI_p>
#> With MIME type:
#> • image/jpeg
