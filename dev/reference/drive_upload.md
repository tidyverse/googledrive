...
#> • chicken-upload.csv <id: 1kW3EzOx5cfBAHQY1RdxkB1OchkWauS5T>
#> With MIME type:
#> • text/csv
...
#>   <id: 1fzwbMW3woKd5pJPiyIq_dYfIl84g1FOVFsckYLNLuSw>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1zd8B2DeRFOvjEepX4OzYrK_bU_VvZnb->
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1DhK-Xnzz5pI5B856X1IoL6K6KVLDjRJm>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 11YkdFyhhiA8U7HZks8s70oKPnRk9nUp2>
#> With MIME type:
#> • image/jpeg
