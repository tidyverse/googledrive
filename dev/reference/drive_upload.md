...
#> • chicken-upload.csv <id: 1zQdI888vmEZ1lj7TruBiR8_sZMrKvdnj>
#> With MIME type:
#> • text/csv
...
#>   <id: 1KAEs37G8OeiDKjyIzCuKI-WslMXc1eakah3VpE5uw34>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1BW8rdrWunCGLrCWetI0vuh4_5q5FLjn8>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1fkRcxVIC07nLQeBbi8CSkpNDP0iF5A4M>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1e-mGYoJlyYHNUqijUZ_kL3kYxfoNO9m4>
#> With MIME type:
#> • image/jpeg
