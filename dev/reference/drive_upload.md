...
#> • chicken-upload.csv <id: 1YmH-HbE0I88MyuIPbYOg0UKhD-u9M0yH>
#> With MIME type:
#> • text/csv
...
#>   <id: 19oaE4b7_eLIglQxuIyPzMMsl_EuUcU1qBkk5oEa_y_M>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 14BPAGIJRPR1P_lwBlZ3__xjQ77jrcT6a>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1lbDW_AAuevurp126Knk8EckGqghOggmU>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1nPCkVL-FzPQ55oIZD4bH78i2GeZAZegC>
#> With MIME type:
#> • image/jpeg
