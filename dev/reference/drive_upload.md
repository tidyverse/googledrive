...
#> • chicken-upload.csv <id: 1-w1ninxDV8fpbkwCgMCB0K1TqZ1Ro1q9>
#> With MIME type:
#> • text/csv
...
#>   <id: 1syVfgbK4dAsM5SMgaz_2jAzJn5BTQQLXAzOcdNojHcI>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1NQn8C9N89R-Tn5R1ruKNgikwGIRJUyHN>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1m5GRsDQmltWenI6aAXteiXEcz37r4i-r>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 15zPMo38yzWUY3on8bDXabGxoMAxkoRHw>
#> With MIME type:
#> • image/jpeg
