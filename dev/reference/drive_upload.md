...
#> • chicken-upload.csv <id: 1SiRbeVttP5i6t32jC7A6QDzPCDPi0OyP>
#> With MIME type:
#> • text/csv
...
#>   <id: 1hv05tumX31nEDrTVlbry8TiKEYHWxSBwU17bRCtWjbE>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1G7fxiJyaGUFMMq2UBfrXuD_aRKS1-nez>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1u1zV36PNRJ_Zd2JclEbAw11LA8k7JWa9>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1Pqo8Uep8DlyMFIAZPbisEXO124lIYtUP>
#> With MIME type:
#> • image/jpeg
