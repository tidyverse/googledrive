...
#> • chicken-upload.csv <id: 17yB-qjPmrI3-BmXAB8RSk0hiYMwTVzPY>
#> With MIME type:
#> • text/csv
...
#>   <id: 1fdY_jIKKlEuLld7JMdBEGkZ5Q_U5OPtidw2aMUvh60U>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1-j8KLexs7CUM2vZFIyYvNvlxPHglOk0s>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1VsNYfw7S9S5OidnqVym_Mxl6bHdEVqT1>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1XgVb3o_xPqGADGDcNGfz2iwc92rJtuL4>
#> With MIME type:
#> • image/jpeg
