...
#> • chicken-upload.csv <id: 1ERMGeGS65COSg2SL5R8TdmNbp6Lzk-k7>
#> With MIME type:
#> • text/csv
...
#>   <id: 1FaLiBybpOprakTeuliBJSGfr59UI6DN6A8yHeNCqAyo>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 15csVYbHeixajRrli5CphDfQfWrwhrVqi>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1mEFEBiOZOo9CvVJivpX_VaTL7y9lRDJQ>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1WpjcokSi902_w45aik4GWpZLz4NCSjwu>
#> With MIME type:
#> • image/jpeg
