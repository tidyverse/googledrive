...
#> • chicken-upload.csv <id: 1s36RkC3fxVrwV_Slnf_qQ48gVJI3IAGB>
#> With MIME type:
#> • text/csv
...
#>   <id: 1UQ8KmPLD19Tpu8ApwLCHK1htCThIRan1WRsTxspUb9s>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1uymooY_r1CzFqJDeeWV9esHuvgvutXV9>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1fSMxIBWM4aQuKVySZ3PM_sPtTQCEn5Z->
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 1BHe4tLM1vv7a0bPoX65pSoaEn2ZuraWS>
#> With MIME type:
#> • image/jpeg
