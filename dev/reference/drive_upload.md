...
#> • chicken-upload.csv <id: 1G46XbHwdI7sGejKhU9bk04GAdICCfGyz>
#> With MIME type:
#> • text/csv
...
#>   <id: 1Zjl5KPp6TM335HQtLsmIAQ3VHT2c1IHaFPECOBk5VSQ>
#> With MIME type:
...
#> Uploaded into Drive file:
#> • chicken.jpg <id: 1ICIpajBS7T1RI32R2cOEq_DyscoIllLl>
#> With MIME type:
#> • image/jpeg
...
#> Created Drive file:
#> • name-squatter-upload <id: 1GzzluI9-I5HiyOMSiYYXJNUNlCLCG0Fn>
#> With MIME type:
...
#> • /home/runner/work/_temp/Library/googledrive/extdata/example_files/chicken.jpg
#> Uploaded into Drive file:
#> • name-squatter-upload <id: 16xI0B60CY38T2k0nM6Mg9X7NTzqwYtcy>
#> With MIME type:
#> • image/jpeg
