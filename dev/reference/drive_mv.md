...
#> Copied to file:
#> • chicken-mv.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
...
#> • chicken-mv.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1WSufa7JKMcH31e6i82p0E9W-s0xut5hv>
#> With MIME type:
...
#>   <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 14SApsi… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
...
#> Created Drive file:
#> • name-squatter-mv <id: 11-RbVVQP7BB9Fdmh2WGgD-V5uDmnCqFq>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 14SApsiqrhwxC6XqOzxAiVyXZbouwFLV->
