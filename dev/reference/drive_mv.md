...
#> Copied to file:
#> • chicken-mv.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
...
#> • chicken-mv.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1wITq6wAtaymGwRKN22oDZQL_EsTcpZ6V>
#> With MIME type:
...
#>   <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1HGzk2I… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1QH44nObZFJ6fAGds_8m0KXd6wImGRmwk>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1HGzk2IRV936NTJAb_CSIirmCZhJHBJOh>
