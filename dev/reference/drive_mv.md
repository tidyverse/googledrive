...
#> Copied to file:
#> • chicken-mv.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
...
#> • chicken-mv.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 13QL-UgQaPkirogrcd0P4EcfllBA0kWp_>
#> With MIME type:
...
#>   <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1XtVuKh… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
...
#> Created Drive file:
#> • name-squatter-mv <id: 1wiioIcR1MVaGTLX_dQKmxBumzVZK2zgf>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1XtVuKhEOZnLpXQCFPLf-20voBqHYjDO->
