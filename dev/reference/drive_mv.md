...
#> Copied to file:
#> • chicken-mv.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
...
#> • chicken-mv.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1RwS7r5EctYE799pF2QPBdOow5fIFpZCG>
#> With MIME type:
...
#>   <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1fH4JNZ… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1ipiW9h6l3lAtDXjwW0XH5F6Ow1k7r4a9>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1fH4JNZ7sLBmpW8Ylvo0vJxFvO0XYSsLk>
