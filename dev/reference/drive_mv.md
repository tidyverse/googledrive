...
#> Copied to file:
#> • chicken-mv.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
...
#> • chicken-mv.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1AwDpDyxJuEyKfw_N6-D9KzbNjYCKXPQK>
#> With MIME type:
...
#>   <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 12LRCDu… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1hp1L0bHjiLIsSyDOuBIcDvzE0b87KHCL>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 12LRCDuWGygkMFTICKKa9o7bhOSyI7d5c>
