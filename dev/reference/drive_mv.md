...
#> Copied to file:
#> • chicken-mv.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
...
#> • chicken-mv.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 19eNE1XPWmubyqUhKzYWoNvJssOA2cLTf>
#> With MIME type:
...
#>   <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1kgpoeM… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
...
#> Created Drive file:
#> • name-squatter-mv <id: 17wvFIP73JdSw_r7THZvD6XF8twfuUJ60>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1kgpoeMTyXREWvX6JXyTge2dHyU1Ba9HH>
