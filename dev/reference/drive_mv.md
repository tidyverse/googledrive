...
#> Copied to file:
#> • chicken-mv.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
...
#> • chicken-mv.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1o-oJz1BZrnDVdHsTduI8eIwepNb7Prhk>
#> With MIME type:
...
#>   <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1os7na_… <named list [43]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1n6ZGYguq9zLydJcIDiEYEdtAaCwEznMC>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1os7na_mdm_tI2oenHKP3PeEyqiPxGQDx>
