...
#> Copied to file:
#> • chicken-mv.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
...
#> • chicken-mv.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1rMTnGewfIwnXmu60KhbKf1xX1Egrs_6V>
#> With MIME type:
...
#>   <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1ZZVqcE… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
...
#> Created Drive file:
#> • name-squatter-mv <id: 11BAgC-xkb6sQT93AEQJBgAokbCXu5LDh>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1ZZVqcERuYDW2p61UvR_nGwu6FpuAgme8>
