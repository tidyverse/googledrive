...
#> Copied to file:
#> • chicken-mv.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
...
#> • chicken-mv.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1gA0rN7_blIRa6xT7GLaHEMCW-tDHQuZV>
#> With MIME type:
...
#>   <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 18r1H8u… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1mDtepRvs9tc5DTYhKcDgoTNEnjK225Hv>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 18r1H8uEffXdjpT0xJsxRmnf_XHJPnTwP>
