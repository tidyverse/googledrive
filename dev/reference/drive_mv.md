...
#> Copied to file:
#> • chicken-mv.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
...
#> • chicken-mv.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1hxpkOi2t4ae5ihJ6RrP-gX7qIuFBhgLE>
#> With MIME type:
...
#>   <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1QMjNOf… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
...
#> Created Drive file:
#> • name-squatter-mv <id: 12dP6V9WrRrVUI404IqRcY7hc8NcBNM-y>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1QMjNOfs98vYs3vR16LPIUF8veQIXHxVl>
