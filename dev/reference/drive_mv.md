...
#> Copied to file:
#> • chicken-mv.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
...
#> • chicken-mv.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1BfiFVf76VGaigS6mgzfFwPFj-CErVZ0l>
#> With MIME type:
...
#>   <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1H9edKy… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1ME6eCyvFLTttvf6qczXrFXp18IfDVtT2>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1H9edKybGaKKBAfictD7LOptxftI0B50p>
