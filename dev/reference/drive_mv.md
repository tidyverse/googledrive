...
#> Copied to file:
#> • chicken-mv.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
...
#> • chicken-mv.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1ESZFiQi9LwnkYDaHf7p6SCkaArg6B3nI>
#> With MIME type:
...
#>   <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1TtgfgM… <named list [43]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
...
#> Created Drive file:
#> • name-squatter-mv <id: 18U0NsyDVeLC40YNeD0uJq9vR7Nw1gpzj>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1TtgfgM2sM3LLGKoJUq3fEiZaIY8ghLKg>
