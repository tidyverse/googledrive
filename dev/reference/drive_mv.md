...
#> Copied to file:
#> • chicken-mv.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
...
#> • chicken-mv.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1KMiRBkg2MB7pT8xsYFikm8zcMLRwLm1y>
#> With MIME type:
...
#>   <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 19FXD2N… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1r1Y0LRj3Hdg6fyM3opoay6rIaDwCrkhB>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 19FXD2NgNcifu3RfWnqZHnbU-e_RWxFhR>
