...
#> Copied to file:
#> • chicken-mv.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
...
#> • chicken-mv.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1c3gMj9JsYsUcvVH4uHr4Wl-k_bfw68ro>
#> With MIME type:
...
#>   <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1hyPl20… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
...
#> Created Drive file:
#> • name-squatter-mv <id: 1NWFC2r7JnArewxRwI_AEa_YpQBMLtOEH>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1hyPl20ZAdszqwPPxo-dvV-P4gjmco6V->
