...
#> Copied to file:
#> • chicken-mv.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
...
#> • chicken-mv.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1Dkq4WISYmAsUpviQ7-LAxDX5hCMLcjz4>
#> With MIME type:
...
#>   <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 157G27_… <named list [43]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
...
#> Created Drive file:
#> • name-squatter-mv <id: 10AY2eX3P17a2Owi5I-oY47rUuMVXr9hC>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 157G27_H4e6ZTszXL6YpVgProqz3DVQoy>
