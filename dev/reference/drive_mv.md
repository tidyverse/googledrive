...
#> Copied to file:
#> • chicken-mv.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
...
#> • chicken-mv.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1Ga_RDvnWg3ulazXU02N-sw1IH5T71owO>
#> With MIME type:
...
#>   <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1oO0MVs… <named list [45]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
...
#> Created Drive file:
#> • name-squatter-mv <id: 13gbA2zNghcY2lBEpkxi3DAjuaUbBz3YQ>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1oO0MVswkotsMOqPOnSy3BkvyWWxuDhlc>
