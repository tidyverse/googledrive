...
#> Copied to file:
#> • chicken-mv.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
...
#> • chicken-mv.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1n4PklkeTUcdUHRbR_6Vuzze27uxFDlRP>
#> With MIME type:
...
#>   <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 14dndxE… <named list [43]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
...
#> Created Drive file:
#> • name-squatter-mv <id: 17ChsskM70fZvjvrLEhXnHxZMWOSaqze4>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 14dndxE0BNQZiMt1_P7KifDzDBjRe8NGH>
