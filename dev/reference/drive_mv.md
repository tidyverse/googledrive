...
#> Copied to file:
#> • chicken-mv.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
...
#> • chicken-mv.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1XT_9CaQRwix2FXUAaACb659o5qfX3eSG>
#> With MIME type:
...
#>   <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 15zJouM… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
...
#> Created Drive file:
#> • name-squatter-mv <id: 1ZoQfvt0spPgE82bdeDZxFjN43JOOrmx3>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 15zJouMEYAtI7_RPzqUnPaoOIQgUHOSf->
