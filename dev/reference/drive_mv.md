...
#> Copied to file:
#> • chicken-mv.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
...
#> • chicken-mv.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1NCmFrrf-7d5GKZF_x05j3I2BPM4u6n_X>
#> With MIME type:
...
#>   <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1CMGbKf… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1HUQDgHN5j4e0wDLlfaws8uXiw2T4yj2W>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1CMGbKfmSq5fbR_1CmQqWAqLGUomCXn51>
