...
#> Copied to file:
#> • chicken-mv.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
...
#> • chicken-mv.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1aEAl98aj6C1-s9qpyMimOaCXqXrdtsf->
#> With MIME type:
...
#>   <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 19Rd5Wc… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
...
#> Created Drive file:
#> • name-squatter-mv <id: 13gT_4-N828OOh3EeRSRwcPTKDn9sbN7Y>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 19Rd5WcYRRx29Nyr-ArctnsrZWYOjP91J>
