...
#> Copied to file:
#> • chicken-mv.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
...
#> • chicken-mv.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
#> Has been renamed:
#> • chicken-mv-renamed.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>

# create a folder to move the file into
folder <- drive_mkdir("mv-folder")
#> Created Drive file:
#> • mv-folder <id: 1J6lcXFEyTwxWvq2UEQBs-fQnrtqrV_Sp>
#> With MIME type:
...
#>   <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
...
#>   <chr>                     <drv_id> <list>           
#> 1 chicken-mv-re-renamed.txt 1K-xcNf… <named list [44]>

# move the file back to root folder
file <- drive_mv(file, "~/")
#> Original file:
#> • chicken-mv-re-renamed.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
#> Has been moved:
#> • ~/chicken-mv-re-renamed.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
...
#> Created Drive file:
#> • name-squatter-mv <id: 1ii0YjmcIoQZwJYhB8Aj1AhDssgVZHANI>
#> With MIME type:
...
#> • chicken-mv-re-renamed.txt <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
#> Has been renamed and moved:
#> • ~/name-squatter-mv <id: 1K-xcNfvPBzzzzX5LwtPdiR0dVoQ3sHek>
