...
#>   <id: 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1l9QdjHOi7RFnO3crGdASCYhyvaAzBCdN>
#> With MIME type:
...
#> • shortcut-1 <id: 1l9QdjHOi7RFnO3crGdASCYhyvaAzBCdN>
#> Copied to file:
#> • shortcut-2 <id: 1WA961XzxNPvO7Ordt4IWvKge1j1mGJpc>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1WA961XzxNPvO7Ordt4IWvKge1j1mGJpc <named list [34]>
#> 2 shortcut-1 1l9QdjHOi7RFnO3crGdASCYhyvaAzBCdN <named list [34]>
...
#> 1 chicken-sheet-for-… 1NC74ml… shortcut-2    1WA961X…    <named list>  
#> 2 chicken-sheet-for-… 1NC74ml… shortcut-1    1l9QdjH…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M
#> [2] 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M
file$id
#> <drive_id[1]>
#> [1] 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M
...
#> • shortcut-2 <id: 1WA961XzxNPvO7Ordt4IWvKge1j1mGJpc> -> NA
#>   <id: 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M>
#> • shortcut-1 <id: 1l9QdjHOi7RFnO3crGdASCYhyvaAzBCdN> -> NA
#>   <id: 1NC74mljWpyEN4GOItzwjVAryW-HO3BVR_ZSO0ZOw30M>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1NC74ml… shortcut-2    1WA961X…    <named list [3]>
#> 2 NA    1NC74ml… shortcut-1    1l9QdjH…    <named list [3]>
