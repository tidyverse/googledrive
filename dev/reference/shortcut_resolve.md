...
#>   <id: 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1-CKyJxhn5RJGke1rKJ43XqrAz6AVQZzT>
#> With MIME type:
...
#> • shortcut-1 <id: 1-CKyJxhn5RJGke1rKJ43XqrAz6AVQZzT>
#> Copied to file:
#> • shortcut-2 <id: 1eKFEAnqv_A-2rBLhM-IYrkhIViY-qWJl>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1eKFEAnqv_A-2rBLhM-IYrkhIViY-qWJl <named list [35]>
#> 2 shortcut-1 1-CKyJxhn5RJGke1rKJ43XqrAz6AVQZzT <named list [35]>
...
#> 1 chicken-sheet-for-… 1_Yt4or… shortcut-2    1eKFEAn…    <named list>  
#> 2 chicken-sheet-for-… 1_Yt4or… shortcut-1    1-CKyJx…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM
#> [2] 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM
file$id
#> <drive_id[1]>
#> [1] 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM
...
#> • shortcut-2 <id: 1eKFEAnqv_A-2rBLhM-IYrkhIViY-qWJl> -> NA
#>   <id: 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM>
#> • shortcut-1 <id: 1-CKyJxhn5RJGke1rKJ43XqrAz6AVQZzT> -> NA
#>   <id: 1_Yt4oriAPZ1VBTC6MOj_RUJQs8BVbaUAXuUcz-CIBbM>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1_Yt4or… shortcut-2    1eKFEAn…    <named list [3]>
#> 2 NA    1_Yt4or… shortcut-1    1-CKyJx…    <named list [3]>
