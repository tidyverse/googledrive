...
#>   <id: 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1JLf21C7LiSUoAvYW31eWKO8hxT0_NXZj>
#> With MIME type:
...
#> • shortcut-1 <id: 1JLf21C7LiSUoAvYW31eWKO8hxT0_NXZj>
#> Copied to file:
#> • shortcut-2 <id: 1L2CJUDoT8haUgrhRLYAWb5oui5gSVQao>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1L2CJUDoT8haUgrhRLYAWb5oui5gSVQao <named list [35]>
#> 2 shortcut-1 1JLf21C7LiSUoAvYW31eWKO8hxT0_NXZj <named list [35]>
...
#> 1 chicken-sheet-for-… 1dM3UL3… shortcut-2    1L2CJUD…    <named list>  
#> 2 chicken-sheet-for-… 1dM3UL3… shortcut-1    1JLf21C…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU
#> [2] 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU
file$id
#> <drive_id[1]>
#> [1] 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU
...
#> • shortcut-2 <id: 1L2CJUDoT8haUgrhRLYAWb5oui5gSVQao> -> NA
#>   <id: 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU>
#> • shortcut-1 <id: 1JLf21C7LiSUoAvYW31eWKO8hxT0_NXZj> -> NA
#>   <id: 1dM3UL37LGNtlBbpqta_4WZxLue2mi9FNK75At8kWiBU>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1dM3UL3… shortcut-2    1L2CJUD…    <named list [3]>
#> 2 NA    1dM3UL3… shortcut-1    1JLf21C…    <named list [3]>
