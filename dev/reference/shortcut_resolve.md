...
#>   <id: 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 15JBvTYs3PIYK3oq49EOOMrdA-TqLxQdy>
#> With MIME type:
...
#> • shortcut-1 <id: 15JBvTYs3PIYK3oq49EOOMrdA-TqLxQdy>
#> Copied to file:
#> • shortcut-2 <id: 1B6uOlQnLlFDzRRZxU8Ii5XLmWw-C15bq>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1B6uOlQnLlFDzRRZxU8Ii5XLmWw-C15bq <named list [34]>
#> 2 shortcut-1 15JBvTYs3PIYK3oq49EOOMrdA-TqLxQdy <named list [34]>
...
#> 1 chicken-sheet-for-… 15TuLLq… shortcut-2    1B6uOlQ…    <named list>  
#> 2 chicken-sheet-for-… 15TuLLq… shortcut-1    15JBvTY…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI
#> [2] 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI
file$id
#> <drive_id[1]>
#> [1] 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI
...
#> • shortcut-2 <id: 1B6uOlQnLlFDzRRZxU8Ii5XLmWw-C15bq> -> NA
#>   <id: 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI>
#> • shortcut-1 <id: 15JBvTYs3PIYK3oq49EOOMrdA-TqLxQdy> -> NA
#>   <id: 15TuLLqfs_Fm9WU-cqN67e2CxMEU2xj21UwoDs-Y1DxI>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    15TuLLq… shortcut-2    1B6uOlQ…    <named list [3]>
#> 2 NA    15TuLLq… shortcut-1    15JBvTY…    <named list [3]>
