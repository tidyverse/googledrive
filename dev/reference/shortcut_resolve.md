...
#>   <id: 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1ViTOpy8HMUTT72OcrFF-7DdvelpLwFty>
#> With MIME type:
...
#> • shortcut-1 <id: 1ViTOpy8HMUTT72OcrFF-7DdvelpLwFty>
#> Copied to file:
#> • shortcut-2 <id: 1Urpqvkknr3kbGy8MFgzYHSd9DMGXbnny>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1Urpqvkknr3kbGy8MFgzYHSd9DMGXbnny <named list [34]>
#> 2 shortcut-1 1ViTOpy8HMUTT72OcrFF-7DdvelpLwFty <named list [34]>
...
#> 1 chicken-sheet-for-… 1bxD5VM… shortcut-2    1Urpqvk…    <named list>  
#> 2 chicken-sheet-for-… 1bxD5VM… shortcut-1    1ViTOpy…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA
#> [2] 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA
file$id
#> <drive_id[1]>
#> [1] 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA
...
#> • shortcut-2 <id: 1Urpqvkknr3kbGy8MFgzYHSd9DMGXbnny> -> NA
#>   <id: 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA>
#> • shortcut-1 <id: 1ViTOpy8HMUTT72OcrFF-7DdvelpLwFty> -> NA
#>   <id: 1bxD5VM-SLuFAN2rPLSvccKOqPGEWlp_mSCaUXDEiDUA>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1bxD5VM… shortcut-2    1Urpqvk…    <named list [3]>
#> 2 NA    1bxD5VM… shortcut-1    1ViTOpy…    <named list [3]>
