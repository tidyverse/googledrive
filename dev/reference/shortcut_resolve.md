...
#>   <id: 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1LnUJBMINBdjbqdSYkULoRny-GBrs655V>
#> With MIME type:
...
#> • shortcut-1 <id: 1LnUJBMINBdjbqdSYkULoRny-GBrs655V>
#> Copied to file:
#> • shortcut-2 <id: 10f3qjr1xOs5OpRXRR9LD-1aaTN5NR_aU>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 10f3qjr1xOs5OpRXRR9LD-1aaTN5NR_aU <named list [35]>
#> 2 shortcut-1 1LnUJBMINBdjbqdSYkULoRny-GBrs655V <named list [35]>
...
#> 1 chicken-sheet-for-… 1oITLcB… shortcut-2    10f3qjr…    <named list>  
#> 2 chicken-sheet-for-… 1oITLcB… shortcut-1    1LnUJBM…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE
#> [2] 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE
file$id
#> <drive_id[1]>
#> [1] 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE
...
#> • shortcut-2 <id: 10f3qjr1xOs5OpRXRR9LD-1aaTN5NR_aU> -> NA
#>   <id: 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE>
#> • shortcut-1 <id: 1LnUJBMINBdjbqdSYkULoRny-GBrs655V> -> NA
#>   <id: 1oITLcBInLWmmuG_OQN42jItfdFANWiojEE9tznKHJvE>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1oITLcB… shortcut-2    10f3qjr…    <named list [3]>
#> 2 NA    1oITLcB… shortcut-1    1LnUJBM…    <named list [3]>
