...
#>   <id: 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1HWt7jQVI3uzbvOYytlbez0Qrfvsdr8pf>
#> With MIME type:
...
#> • shortcut-1 <id: 1HWt7jQVI3uzbvOYytlbez0Qrfvsdr8pf>
#> Copied to file:
#> • shortcut-2 <id: 1iB8IipU_zuhJGB63mxXWy8Z3zb1ylQTI>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1iB8IipU_zuhJGB63mxXWy8Z3zb1ylQTI <named list [35]>
#> 2 shortcut-1 1HWt7jQVI3uzbvOYytlbez0Qrfvsdr8pf <named list [35]>
...
#> 1 chicken-sheet-for-… 1VqmoRj… shortcut-2    1iB8Iip…    <named list>  
#> 2 chicken-sheet-for-… 1VqmoRj… shortcut-1    1HWt7jQ…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY
#> [2] 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY
file$id
#> <drive_id[1]>
#> [1] 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY
...
#> • shortcut-2 <id: 1iB8IipU_zuhJGB63mxXWy8Z3zb1ylQTI> -> NA
#>   <id: 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY>
#> • shortcut-1 <id: 1HWt7jQVI3uzbvOYytlbez0Qrfvsdr8pf> -> NA
#>   <id: 1VqmoRjz5NbUgTpKCtyJRxvvotbw0TL9EOR2-VqAJGVY>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1VqmoRj… shortcut-2    1iB8Iip…    <named list [3]>
#> 2 NA    1VqmoRj… shortcut-1    1HWt7jQ…    <named list [3]>
