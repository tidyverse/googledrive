...
#>   <id: 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 119nMEmtFchWLv_ks77hP-cgVQhLapLWj>
#> With MIME type:
...
#> • shortcut-1 <id: 119nMEmtFchWLv_ks77hP-cgVQhLapLWj>
#> Copied to file:
#> • shortcut-2 <id: 1nQo_8sLb4GX6QKVw-V5Wesn0QjKL92NG>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1nQo_8sLb4GX6QKVw-V5Wesn0QjKL92NG <named list [35]>
#> 2 shortcut-1 119nMEmtFchWLv_ks77hP-cgVQhLapLWj <named list [35]>
...
#> 1 chicken-sheet-for-… 1wEYkJW… shortcut-2    1nQo_8s…    <named list>  
#> 2 chicken-sheet-for-… 1wEYkJW… shortcut-1    119nMEm…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0
#> [2] 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0
file$id
#> <drive_id[1]>
#> [1] 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0
...
#> • shortcut-2 <id: 1nQo_8sLb4GX6QKVw-V5Wesn0QjKL92NG> -> NA
#>   <id: 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0>
#> • shortcut-1 <id: 119nMEmtFchWLv_ks77hP-cgVQhLapLWj> -> NA
#>   <id: 1wEYkJWjcy9xazfoQHEUVVxTAOaDl8sUfmIN1xYVF1o0>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1wEYkJW… shortcut-2    1nQo_8s…    <named list [3]>
#> 2 NA    1wEYkJW… shortcut-1    119nMEm…    <named list [3]>
