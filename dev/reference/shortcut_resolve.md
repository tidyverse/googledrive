...
#>   <id: 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1tfJ368RX5mxdEYFfjfs5PKf75qVcIRC5>
#> With MIME type:
...
#> • shortcut-1 <id: 1tfJ368RX5mxdEYFfjfs5PKf75qVcIRC5>
#> Copied to file:
#> • shortcut-2 <id: 1v5IzXNYToVaeAveJ0sjmSD_LhdZ7Ncit>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1v5IzXNYToVaeAveJ0sjmSD_LhdZ7Ncit <named list [35]>
#> 2 shortcut-1 1tfJ368RX5mxdEYFfjfs5PKf75qVcIRC5 <named list [35]>
...
#> 1 chicken-sheet-for-… 1Zl2Fsg… shortcut-2    1v5IzXN…    <named list>  
#> 2 chicken-sheet-for-… 1Zl2Fsg… shortcut-1    1tfJ368…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158
#> [2] 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158
file$id
#> <drive_id[1]>
#> [1] 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158
...
#> • shortcut-2 <id: 1v5IzXNYToVaeAveJ0sjmSD_LhdZ7Ncit> -> NA
#>   <id: 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158>
#> • shortcut-1 <id: 1tfJ368RX5mxdEYFfjfs5PKf75qVcIRC5> -> NA
#>   <id: 1Zl2FsgmfctkxvnrlxA9np37eN0Nud7lPWAFpDB0-158>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1Zl2Fsg… shortcut-2    1v5IzXN…    <named list [3]>
#> 2 NA    1Zl2Fsg… shortcut-1    1tfJ368…    <named list [3]>
