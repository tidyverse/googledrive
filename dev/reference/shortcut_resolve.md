...
#>   <id: 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1Y151th1y50oWdNTZ4ixOpMhTccknIwrK>
#> With MIME type:
...
#> • shortcut-1 <id: 1Y151th1y50oWdNTZ4ixOpMhTccknIwrK>
#> Copied to file:
#> • shortcut-2 <id: 1iWv039jWL1mzXEGUmM4k1VlBE_XXsH-8>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1iWv039jWL1mzXEGUmM4k1VlBE_XXsH-8 <named list [35]>
#> 2 shortcut-1 1Y151th1y50oWdNTZ4ixOpMhTccknIwrK <named list [35]>
...
#> 1 chicken-sheet-for-… 1o1AbdO… shortcut-2    1iWv039…    <named list>  
#> 2 chicken-sheet-for-… 1o1AbdO… shortcut-1    1Y151th…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo
#> [2] 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo
file$id
#> <drive_id[1]>
#> [1] 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo
...
#> • shortcut-2 <id: 1iWv039jWL1mzXEGUmM4k1VlBE_XXsH-8> -> NA
#>   <id: 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo>
#> • shortcut-1 <id: 1Y151th1y50oWdNTZ4ixOpMhTccknIwrK> -> NA
#>   <id: 1o1AbdOETSS2balxiba76jdPw7mLBUgZzCyXWsiPgkRo>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1o1AbdO… shortcut-2    1iWv039…    <named list [3]>
#> 2 NA    1o1AbdO… shortcut-1    1Y151th…    <named list [3]>
