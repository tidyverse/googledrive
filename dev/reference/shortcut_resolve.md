...
#>   <id: 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1RQIyQ-FmGBI_LdAJEqhnrRqIoiHRR0gd>
#> With MIME type:
...
#> • shortcut-1 <id: 1RQIyQ-FmGBI_LdAJEqhnrRqIoiHRR0gd>
#> Copied to file:
#> • shortcut-2 <id: 1K6lR3UGUSfJ9BIXa-jmGmKh7iuJjRCYq>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1K6lR3UGUSfJ9BIXa-jmGmKh7iuJjRCYq <named list [34]>
#> 2 shortcut-1 1RQIyQ-FmGBI_LdAJEqhnrRqIoiHRR0gd <named list [34]>
...
#> 1 chicken-sheet-for-… 1DrfnU4… shortcut-2    1K6lR3U…    <named list>  
#> 2 chicken-sheet-for-… 1DrfnU4… shortcut-1    1RQIyQ-…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro
#> [2] 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro
file$id
#> <drive_id[1]>
#> [1] 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro
...
#> • shortcut-2 <id: 1K6lR3UGUSfJ9BIXa-jmGmKh7iuJjRCYq> -> NA
#>   <id: 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro>
#> • shortcut-1 <id: 1RQIyQ-FmGBI_LdAJEqhnrRqIoiHRR0gd> -> NA
#>   <id: 1DrfnU4jyo40MTmBriB1Ib8O-cJQ07_P07k8EOGZ-0Ro>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    1DrfnU4… shortcut-2    1K6lR3U…    <named list [3]>
#> 2 NA    1DrfnU4… shortcut-1    1RQIyQ-…    <named list [3]>
