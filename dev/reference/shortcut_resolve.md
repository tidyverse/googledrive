...
#>   <id: 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0>

# Create a shortcut
sc1 <- file |>
  shortcut_create(name = "shortcut-1")
#> Created Drive file:
#> • shortcut-1 <id: 1b1FrEp4zzH6Pm_xXartW6R01nZa0CR8c>
#> With MIME type:
...
#> • shortcut-1 <id: 1b1FrEp4zzH6Pm_xXartW6R01nZa0CR8c>
#> Copied to file:
#> • shortcut-2 <id: 1mr1e74aXZDNBrgnjkPYPc5TiGJPBQTvB>
...
#>   <chr>      <drv_id>                          <list>           
#> 1 shortcut-2 1mr1e74aXZDNBrgnjkPYPc5TiGJPBQTvB <named list [35]>
#> 2 shortcut-1 1b1FrEp4zzH6Pm_xXartW6R01nZa0CR8c <named list [35]>
...
#> 1 chicken-sheet-for-… 12IfXRX… shortcut-2    1mr1e74…    <named list>  
#> 2 chicken-sheet-for-… 12IfXRX… shortcut-1    1b1FrEp…    <named list>  

resolved$id
#> <drive_id[2]>
#> [1] 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0
#> [2] 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0
file$id
#> <drive_id[1]>
#> [1] 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0
...
#> • shortcut-2 <id: 1mr1e74aXZDNBrgnjkPYPc5TiGJPBQTvB> -> NA
#>   <id: 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0>
#> • shortcut-1 <id: 1b1FrEp4zzH6Pm_xXartW6R01nZa0CR8c> -> NA
#>   <id: 12IfXRXRSgOQxaxl_3zmiOFxt1VNCjY_45DyJIHaOCp0>
#> # A dribble: 2 × 5
#>   name  id       name_shortcut id_shortcut drive_resource  
#>   <chr> <drv_id> <chr>         <drv_id>    <list>          
#> 1 NA    12IfXRX… shortcut-2    1mr1e74…    <named list [3]>
#> 2 NA    12IfXRX… shortcut-1    1b1FrEp…    <named list [3]>
