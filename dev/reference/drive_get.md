...
#> Created Drive file:
#> • alfalfa <id: 16rUYQRrA20E3W7AaP7DlUf1f7EVc4kq5>
#> With MIME type:
...
#> • broccoli <id: 1H0RNNCF-ahol5eVP2xxHTOR__wtOL4SR>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1H0RNNCF-ahol5eVP2xxHTOR__wtOL4SR <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1H0RNNC… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1H0RNNC… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         16rUYQR… <named list [35]>
