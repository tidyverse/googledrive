...
#> Created Drive file:
#> • alfalfa <id: 1VoqPPIVzmArokD-N2jijMgavAicNnWLf>
#> With MIME type:
...
#> • broccoli <id: 1F0Dl6ArDcNFerNpfM85tc2cV8W5GRRJ2>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1F0Dl6ArDcNFerNpfM85tc2cV8W5GRRJ2 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1F0Dl6A… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1F0Dl6A… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1VoqPPI… <named list [36]>
