...
#> Created Drive file:
#> • alfalfa <id: 1YrZK46dhLK2JXPF-vDPenB5UJbt3HiCq>
#> With MIME type:
...
#> • broccoli <id: 1DcESvd1yvoXP7uth6OfjhRDsa-cwB2ZM>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1DcESvd1yvoXP7uth6OfjhRDsa-cwB2ZM <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1DcESvd… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1DcESvd… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1YrZK46… <named list [35]>
