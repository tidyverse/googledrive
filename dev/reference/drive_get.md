...
#> Created Drive file:
#> • alfalfa <id: 1SMw7NmZZo3taIz_0awABeUTYlQOiSwr4>
#> With MIME type:
...
#> • broccoli <id: 1y0XTP67s6f6DFetWkLDYvFrfmKXSPmaP>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1y0XTP67s6f6DFetWkLDYvFrfmKXSPmaP <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1y0XTP6… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1y0XTP6… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1SMw7Nm… <named list [35]>
