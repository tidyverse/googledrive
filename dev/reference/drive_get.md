...
#> Created Drive file:
#> • alfalfa <id: 1MwjN7AIo-HRZQa-olYMuF27pzx0-ZKrY>
#> With MIME type:
...
#> • broccoli <id: 1_TyCOfgpBMBHHSUSCwlezyLv-cObY0xX>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1_TyCOfgpBMBHHSUSCwlezyLv-cObY0xX <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_TyCOf… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_TyCOf… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1MwjN7A… <named list [35]>
