...
#> Created Drive file:
#> • alfalfa <id: 1QfGHRN9CXgF5J5uWrByw8EzZHAweinAI>
#> With MIME type:
...
#> • broccoli <id: 10drIAF98J2ZcggjYWInxWMQDT1R3B3NI>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 10drIAF98J2ZcggjYWInxWMQDT1R3B3NI <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 10drIAF… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 10drIAF… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1QfGHRN… <named list [35]>
