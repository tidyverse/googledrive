...
#> Created Drive file:
#> • alfalfa <id: 1Lz02tEUD6XURlMihvf0bUAm1Tmsssl4h>
#> With MIME type:
...
#> • broccoli <id: 1Qc6RbYABc9hn4vqFAOIAqYPxEasdlOqg>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Qc6RbYABc9hn4vqFAOIAqYPxEasdlOqg <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Qc6RbY… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1Lz02tE… <named list [36]>
