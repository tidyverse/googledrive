...
#> Created Drive file:
#> • alfalfa <id: 14vOznggs9lTU6xOJ4P-0s8teOTB2U7JL>
#> With MIME type:
...
#> • broccoli <id: 1_XppXDoF6tE_DRtnXKL83SoLl08roOw4>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1_XppXDoF6tE_DRtnXKL83SoLl08roOw4 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_XppXD… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_XppXD… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         14vOzng… <named list [36]>
