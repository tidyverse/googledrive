...
#> Created Drive file:
#> • alfalfa <id: 1kW3EYixASAuju09qrucBJWjb6QMa7KnF>
#> With MIME type:
...
#> • broccoli <id: 1aZayUZ1jSNR6A4jrOKsomBrsDHujvSSi>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1aZayUZ1jSNR6A4jrOKsomBrsDHujvSSi <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1aZayUZ… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1aZayUZ… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1kW3EYi… <named list [35]>
