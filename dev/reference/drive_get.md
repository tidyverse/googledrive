...
#> Created Drive file:
#> • alfalfa <id: 1BTjjkMgEWpWI1UtXaokTrniObiDSAO5Y>
#> With MIME type:
...
#> • broccoli <id: 1tSXJ4yk1cWK-C_m-VC-QiypXlkT4ERRW>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1tSXJ4yk1cWK-C_m-VC-QiypXlkT4ERRW <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tSXJ4y… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1BTjjkM… <named list [35]>
