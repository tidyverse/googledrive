...
#> Created Drive file:
#> • alfalfa <id: 1JoHjqOTlaKVOiztxGqysmRnSKD8VmZLf>
#> With MIME type:
...
#> • broccoli <id: 11NaSTBSJDZOl0OsGpWEuF0R8yvX_IgCD>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 11NaSTBSJDZOl0OsGpWEuF0R8yvX_IgCD <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 11NaSTB… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 11NaSTB… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1JoHjqO… <named list [35]>
