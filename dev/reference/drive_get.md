...
#> Created Drive file:
#> • alfalfa <id: 199wcQo8q8_FmNmt59LmK437B3ZneZi1I>
#> With MIME type:
...
#> • broccoli <id: 1BgTox2hCx7A-HItwb9MtWsCCnSoToSW8>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1BgTox2hCx7A-HItwb9MtWsCCnSoToSW8 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1BgTox2… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1BgTox2… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         199wcQo… <named list [36]>
