...
#> Created Drive file:
#> • alfalfa <id: 1kCebKsaBA5wP4jz8utyX5oHh592tO4y5>
#> With MIME type:
...
#> • broccoli <id: 18TTBXSJPcg46w0xc5HdtBeHyz6mt_u84>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 18TTBXSJPcg46w0xc5HdtBeHyz6mt_u84 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 18TTBXS… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 18TTBXS… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1kCebKs… <named list [35]>
