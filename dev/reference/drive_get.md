...
#> Created Drive file:
#> • alfalfa <id: 1tiOqJJvy1U8prxr3GNRQneGlnSINKwR1>
#> With MIME type:
...
#> • broccoli <id: 1a2M-Ht6SPZNwxZyInnuFR1D-JCNMnPEj>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1a2M-Ht6SPZNwxZyInnuFR1D-JCNMnPEj <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1a2M-Ht… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1tiOqJJ… <named list [35]>
