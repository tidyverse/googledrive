...
#> Created Drive file:
#> • alfalfa <id: 1dccRdesXmNz22kYAG9UKSusBR2T1J0ET>
#> With MIME type:
...
#> • broccoli <id: 1s3_kwH62SX8F0tg93ZxeaYwI125IwoSU>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1s3_kwH62SX8F0tg93ZxeaYwI125IwoSU <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1s3_kwH… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1s3_kwH… <named list [45]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [45]>
#> 3 alfalfa  ~/alfalfa/         1dccRde… <named list [36]>
