...
#> Created Drive file:
#> • alfalfa <id: 1NcEOPDAGCPjz_LAclMG02DVCTKTkBNjj>
#> With MIME type:
...
#> • broccoli <id: 13hJE1zOMiSXNR9u2dqtdJS1cQYzSBVLv>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 13hJE1zOMiSXNR9u2dqtdJS1cQYzSBVLv <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 13hJE1z… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1NcEOPD… <named list [36]>
