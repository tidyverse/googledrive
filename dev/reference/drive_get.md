...
#> Created Drive file:
#> • alfalfa <id: 1dCemlsiT03BRt-D-ZuNxzzK17vOSwM0X>
#> With MIME type:
...
#> • broccoli <id: 14hlg5IzYtMj2S_4Idakq1jVtVAMS8ioR>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14hlg5IzYtMj2S_4Idakq1jVtVAMS8ioR <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14hlg5I… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14hlg5I… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1dCemls… <named list [35]>
