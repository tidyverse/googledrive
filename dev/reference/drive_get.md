...
#> Created Drive file:
#> • alfalfa <id: 1LESwtVWXD5Gdv4huqNsE8Sepep_OoN-Z>
#> With MIME type:
...
#> • broccoli <id: 1jeEeA7gxpy27vpDuy_FxkPSLMu1aGTx7>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1jeEeA7gxpy27vpDuy_FxkPSLMu1aGTx7 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1jeEeA7… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1jeEeA7… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1LESwtV… <named list [35]>
