...
#> Created Drive file:
#> • alfalfa <id: 1PeGLLgafx5clPDgV3rkH_-CXAxa6M-O2>
#> With MIME type:
...
#> • broccoli <id: 1Q00WwFishfw8VRabMwhfQwx425hL-z4a>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Q00WwFishfw8VRabMwhfQwx425hL-z4a <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Q00WwF… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1PeGLLg… <named list [36]>
