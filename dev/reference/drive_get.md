...
#> Created Drive file:
#> • alfalfa <id: 1rQbhYA1O9PX1JeM9kCPFMJnyOZckGhGL>
#> With MIME type:
...
#> • broccoli <id: 1hBImZ4svyFU3Zqh1jxvrs_80nnbUsrVQ>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1hBImZ4svyFU3Zqh1jxvrs_80nnbUsrVQ <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1hBImZ4… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1hBImZ4… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1rQbhYA… <named list [35]>
