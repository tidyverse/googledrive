...
#> Created Drive file:
#> • alfalfa <id: 1vBtyq0j_sBudpbYfJe3CI2F3JEiz-uLm>
#> With MIME type:
...
#> • broccoli <id: 1dzLAWLxJs6bZTj-Mixudx5nNhmeNF7RY>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1dzLAWLxJs6bZTj-Mixudx5nNhmeNF7RY <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1dzLAWL… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1dzLAWL… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1vBtyq0… <named list [36]>
