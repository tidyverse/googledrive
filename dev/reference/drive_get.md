...
#> Created Drive file:
#> • alfalfa <id: 11JK4V-j0lt1N9BVjr4A9-zGDFiy1l_eh>
#> With MIME type:
...
#> • broccoli <id: 1MvZAAZixlgtyNO_HdYafAuy6U4HxnQSu>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1MvZAAZixlgtyNO_HdYafAuy6U4HxnQSu <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1MvZAAZ… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         11JK4V-… <named list [36]>
