...
#> Created Drive file:
#> • alfalfa <id: 1oaLrGE_YjrtJla_5MItIeXAkxQ_nEQVv>
#> With MIME type:
...
#> • broccoli <id: 1w2uPzP9kD0NggJhMsRhBEx5D_9PRn-hW>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1w2uPzP9kD0NggJhMsRhBEx5D_9PRn-hW <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1w2uPzP… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1w2uPzP… <named list [45]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [45]>
#> 3 alfalfa  ~/alfalfa/         1oaLrGE… <named list [36]>
