...
#> Created Drive file:
#> • alfalfa <id: 1OiKFNshgHgHr8b1-evV7U7IP59kgtgnh>
#> With MIME type:
...
#> • broccoli <id: 1Cl_NzuNorRD0scwPKvBcgAO5qnYHBfv8>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Cl_NzuNorRD0scwPKvBcgAO5qnYHBfv8 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Cl_Nzu… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Cl_Nzu… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1OiKFNs… <named list [35]>
