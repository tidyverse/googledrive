...
#> Created Drive file:
#> • alfalfa <id: 1quIcxHJbJIANB7x-TuOSHEi8ptsbT_FR>
#> With MIME type:
...
#> • broccoli <id: 1mPjLXADCHXyz2qpzMrrmA4qLRTM_wPHX>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1mPjLXADCHXyz2qpzMrrmA4qLRTM_wPHX <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1mPjLXA… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1mPjLXA… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1quIcxH… <named list [35]>
