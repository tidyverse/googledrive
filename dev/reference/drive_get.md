...
#> Created Drive file:
#> • alfalfa <id: 1EWs6qn5VDYuGISCvLs8-Fn75Gf8TLCE9>
#> With MIME type:
...
#> • broccoli <id: 1gsszL5BKGDKNiObMqYqZ4jEoG-SLn821>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1gsszL5BKGDKNiObMqYqZ4jEoG-SLn821 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1gsszL5… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1gsszL5… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1EWs6qn… <named list [36]>
