...
#> Created Drive file:
#> • alfalfa <id: 1Pm5YRL3DpspQZuB6bp9GosEKpIL5syiG>
#> With MIME type:
...
#> • broccoli <id: 1_ANnzrWUpocMPRiO00KbISdXybI3eydV>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1_ANnzrWUpocMPRiO00KbISdXybI3eydV <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_ANnzr… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1_ANnzr… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1Pm5YRL… <named list [35]>
