...
#> Created Drive file:
#> • alfalfa <id: 1qqomqN_ohFiBpA6s6QJ9TCfsCeTMjKgh>
#> With MIME type:
...
#> • broccoli <id: 1JcVdWeiLhOeGmsrVUkaWfbm75O_ZG5_R>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1JcVdWeiLhOeGmsrVUkaWfbm75O_ZG5_R <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1JcVdWe… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1JcVdWe… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1qqomqN… <named list [36]>
