...
#> Created Drive file:
#> • alfalfa <id: 18yS7Vhfxv-fpnbFTYgs38G7KRehRGaJw>
#> With MIME type:
...
#> • broccoli <id: 1nPW5tgGer2Ifk3wRLQnwRpPOdxIImtH0>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1nPW5tgGer2Ifk3wRLQnwRpPOdxIImtH0 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1nPW5tg… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1nPW5tg… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         18yS7Vh… <named list [36]>
