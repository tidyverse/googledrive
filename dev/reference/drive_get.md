...
#> Created Drive file:
#> • alfalfa <id: 13jQY8UV_g2OM69NVwQ5BNKwt30wHp3xr>
#> With MIME type:
...
#> • broccoli <id: 1NaTs4LQBfQgXdGMibZeFASFWUhTLiLfX>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1NaTs4LQBfQgXdGMibZeFASFWUhTLiLfX <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1NaTs4L… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1NaTs4L… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         13jQY8U… <named list [36]>
