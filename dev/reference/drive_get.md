...
#> Created Drive file:
#> • alfalfa <id: 1ipJRYOzOp8dMNwojYWoto5lEWf_r16BT>
#> With MIME type:
...
#> • broccoli <id: 1Q5Q-iiknM12f_PmmxSZdTn0_8QJXJ6xD>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Q5Q-iiknM12f_PmmxSZdTn0_8QJXJ6xD <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Q5Q-ii… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1ipJRYO… <named list [36]>
