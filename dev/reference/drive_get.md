...
#> Created Drive file:
#> • alfalfa <id: 1tjvO2N4ICw1hf8DmyrXLt-unFhK8Wadw>
#> With MIME type:
...
#> • broccoli <id: 10BPvL9R0v3PjjRLphSa_w6kcxu8GevZt>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 10BPvL9R0v3PjjRLphSa_w6kcxu8GevZt <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 10BPvL9… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 10BPvL9… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1tjvO2N… <named list [36]>
