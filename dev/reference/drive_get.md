...
#> Created Drive file:
#> • alfalfa <id: 193OKePGogvky_kIO5RoeQy4LSxGHTcT1>
#> With MIME type:
...
#> • broccoli <id: 1gGAOsVG82I1tgStANsgUXg_PJ9HpW9TF>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1gGAOsVG82I1tgStANsgUXg_PJ9HpW9TF <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1gGAOsV… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1gGAOsV… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         193OKeP… <named list [35]>
