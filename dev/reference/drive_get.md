...
#> Created Drive file:
#> • alfalfa <id: 1o2C1mvKxi0bzj9jw7v4OrS68IPjBrPZU>
#> With MIME type:
...
#> • broccoli <id: 1jKT4r9m2HOfmOKjLW4VINdffdNxa5nGA>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1jKT4r9m2HOfmOKjLW4VINdffdNxa5nGA <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1jKT4r9… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1jKT4r9… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1o2C1mv… <named list [36]>
