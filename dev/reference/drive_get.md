...
#> Created Drive file:
#> • alfalfa <id: 12XDS05O25mN5PuxMsb-ocPaD0yll6aVU>
#> With MIME type:
...
#> • broccoli <id: 1LH_2IOEObWuCJHPv6EsWDAVwcr3tmSaY>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1LH_2IOEObWuCJHPv6EsWDAVwcr3tmSaY <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1LH_2IO… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1LH_2IO… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         12XDS05… <named list [36]>
