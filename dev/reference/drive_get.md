...
#> Created Drive file:
#> • alfalfa <id: 1HN-lEmi1xmjSbCrWKC5VUgZWpZNifcqs>
#> With MIME type:
...
#> • broccoli <id: 1W-KHnrgEQvVP8IIM9At41fO_ZyEC-pcE>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1W-KHnrgEQvVP8IIM9At41fO_ZyEC-pcE <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1W-KHnr… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1W-KHnr… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1HN-lEm… <named list [36]>
