...
#> Created Drive file:
#> • alfalfa <id: 1tLJ2tTjjlB5JtFKPx5n6FYN2xuUiDry4>
#> With MIME type:
...
#> • broccoli <id: 14ylvwr4rLQv5JKabq4_JZWxUk55vILGE>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14ylvwr4rLQv5JKabq4_JZWxUk55vILGE <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14ylvwr… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14ylvwr… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1tLJ2tT… <named list [36]>
