...
#> Created Drive file:
#> • alfalfa <id: 1uggVJnQ149Gup1orKRfgr7zNnWDYsdQG>
#> With MIME type:
...
#> • broccoli <id: 1QqKNpUP4Cvhhsbt6-9pjJbuyCsNnq-xv>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1QqKNpUP4Cvhhsbt6-9pjJbuyCsNnq-xv <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1QqKNpU… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1QqKNpU… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1uggVJn… <named list [35]>
