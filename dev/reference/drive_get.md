...
#> Created Drive file:
#> • alfalfa <id: 1tsWRxb2fHM2Ic1_dxJwK_FghHuMS2QL->
#> With MIME type:
...
#> • broccoli <id: 1FLwDqReQpUl96Rwk3oBKK35HPcCliM_8>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1FLwDqReQpUl96Rwk3oBKK35HPcCliM_8 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1FLwDqR… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1FLwDqR… <named list [45]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [45]>
#> 3 alfalfa  ~/alfalfa/         1tsWRxb… <named list [36]>
