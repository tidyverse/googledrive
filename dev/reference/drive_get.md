...
#> Created Drive file:
#> • alfalfa <id: 1_y7vUoPB1qVj6DQ5y-_THZgEHwr0HlFs>
#> With MIME type:
...
#> • broccoli <id: 1WBpKBSEdNNhYTel4GzapnYNkLE7Ghuh9>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1WBpKBSEdNNhYTel4GzapnYNkLE7Ghuh9 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1WBpKBS… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1_y7vUo… <named list [35]>
