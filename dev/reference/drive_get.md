...
#> Created Drive file:
#> • alfalfa <id: 1LYgolMqvin8OVSvD6o2BO-NglZeka2f_>
#> With MIME type:
...
#> • broccoli <id: 1CRDpdVtq0XXb2L-T-F4zos-Anrs8_4Nr>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1CRDpdVtq0XXb2L-T-F4zos-Anrs8_4Nr <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1CRDpdV… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1CRDpdV… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1LYgolM… <named list [35]>
