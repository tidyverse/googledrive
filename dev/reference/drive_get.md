...
#> Created Drive file:
#> • alfalfa <id: 1kdvHY1MMU9W6b6onTMFTR929_OZU3Lt8>
#> With MIME type:
...
#> • broccoli <id: 1XlWq8KlWxxHS3n1ZTaes5gKL7eIbrx_C>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1XlWq8KlWxxHS3n1ZTaes5gKL7eIbrx_C <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1XlWq8K… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1XlWq8K… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1kdvHY1… <named list [35]>
