...
#> Created Drive file:
#> • alfalfa <id: 1lQD7URjIJWdMtXPBDrbLQUSfjlXxQxSA>
#> With MIME type:
...
#> • broccoli <id: 1703q8M6zxenjHRqVBw2_RVVxS3va6WlT>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1703q8M6zxenjHRqVBw2_RVVxS3va6WlT <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1703q8M… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1703q8M… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1lQD7UR… <named list [35]>
