...
#> Created Drive file:
#> • alfalfa <id: 1nSPh_nPg2i8oExVGqdyLyHciq7fpTcvW>
#> With MIME type:
...
#> • broccoli <id: 12QliFlJiqrx4JIp3xrxtwaCnY08IKfE2>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 12QliFlJiqrx4JIp3xrxtwaCnY08IKfE2 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 12QliFl… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1nSPh_n… <named list [36]>
