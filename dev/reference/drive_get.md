...
#> Created Drive file:
#> • alfalfa <id: 1Y2WlLfH2lWqWPu3Yzv3oelbDSwCYkkGT>
#> With MIME type:
...
#> • broccoli <id: 1ScglXSvkx62zmWxpePU-QONC4Ss2rzC8>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1ScglXSvkx62zmWxpePU-QONC4Ss2rzC8 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ScglXS… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ScglXS… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1Y2WlLf… <named list [35]>
