...
#> Created Drive file:
#> • alfalfa <id: 17kFacLrbsFezKO143aclmyXuG1ffH-Wq>
#> With MIME type:
...
#> • broccoli <id: 17kPaCm54MSyyeaD1eqzP_ue3NL0S8ew4>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 17kPaCm54MSyyeaD1eqzP_ue3NL0S8ew4 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 17kPaCm… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 17kPaCm… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         17kFacL… <named list [35]>
