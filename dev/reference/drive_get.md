...
#> Created Drive file:
#> • alfalfa <id: 1LZhitnSthZe7Jy0SY-ucKFfiyJUEqyyC>
#> With MIME type:
...
#> • broccoli <id: 1PIDs5spIEbwmcbVV5zVds3Po1hEZNGWt>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1PIDs5spIEbwmcbVV5zVds3Po1hEZNGWt <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1PIDs5s… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1PIDs5s… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1LZhitn… <named list [35]>
