...
#> Created Drive file:
#> • alfalfa <id: 11clxo5Y66Om9yrjyKtb3pZCDayz5iaf2>
#> With MIME type:
...
#> • broccoli <id: 1E5xN7s2uM8iTu1NaGoylW_kX856c_dlM>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1E5xN7s2uM8iTu1NaGoylW_kX856c_dlM <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1E5xN7s… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1E5xN7s… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         11clxo5… <named list [35]>
