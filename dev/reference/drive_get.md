...
#> Created Drive file:
#> • alfalfa <id: 1zXbqJSHEp9Rs-7IuBKKXia3yrpviLfw7>
#> With MIME type:
...
#> • broccoli <id: 1EnsodTGkVydq3s4uz46DmP_0_gKHDw-->
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1EnsodTGkVydq3s4uz46DmP_0_gKHDw-- <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1EnsodT… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1EnsodT… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1zXbqJS… <named list [35]>
