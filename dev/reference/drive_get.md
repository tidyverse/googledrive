...
#> Created Drive file:
#> • alfalfa <id: 1ygB5Jiyrx20zLEAm1RPXzdgGSzlmnlfM>
#> With MIME type:
...
#> • broccoli <id: 1tz_Ej0sHTzWY0X8BQnrNPE6CGfTkHZX8>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1tz_Ej0sHTzWY0X8BQnrNPE6CGfTkHZX8 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tz_Ej0… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tz_Ej0… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1ygB5Ji… <named list [35]>
