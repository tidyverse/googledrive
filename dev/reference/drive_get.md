...
#> Created Drive file:
#> • alfalfa <id: 1AAXC5tNsRU71alqCn3R41DXSd2bWj4NL>
#> With MIME type:
...
#> • broccoli <id: 1chkMqiKLqdkZlWQWIblS-Xyw_yqwlQmX>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1chkMqiKLqdkZlWQWIblS-Xyw_yqwlQmX <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1chkMqi… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1chkMqi… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1AAXC5t… <named list [35]>
