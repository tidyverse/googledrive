...
#> Created Drive file:
#> • alfalfa <id: 1LJ9qy1zCpe6Bwp1xrlyZHBOBI61TyOh1>
#> With MIME type:
...
#> • broccoli <id: 1eowvjVMTp5JyWdROiSf4YQsLHaqIGnnw>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1eowvjVMTp5JyWdROiSf4YQsLHaqIGnnw <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1eowvjV… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1eowvjV… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1LJ9qy1… <named list [36]>
