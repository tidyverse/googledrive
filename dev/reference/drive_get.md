...
#> Created Drive file:
#> • alfalfa <id: 1MjRiBst8_zEMT8mzA98JyPXjByrPgjx5>
#> With MIME type:
...
#> • broccoli <id: 16AXUv6TESridaYEPFHIz4zRYxehLuIEE>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 16AXUv6TESridaYEPFHIz4zRYxehLuIEE <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 16AXUv6… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1MjRiBs… <named list [36]>
