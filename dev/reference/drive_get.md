...
#> Created Drive file:
#> • alfalfa <id: 1RN1AZvmmzNOvIol6B8AngqhB_owammAt>
#> With MIME type:
...
#> • broccoli <id: 1v8T1Ba0xC7zq74-ZYkCSRsRQOOBlIpJD>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1v8T1Ba0xC7zq74-ZYkCSRsRQOOBlIpJD <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1v8T1Ba… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1v8T1Ba… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1RN1AZv… <named list [36]>
