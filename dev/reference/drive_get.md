...
#> Created Drive file:
#> • alfalfa <id: 1UxTza2tQUVK6uSIrCB33Vxc99OmyEfiN>
#> With MIME type:
...
#> • broccoli <id: 14rtBVd_RQjNUhEPwMZ5le4ndaSGvjBrt>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14rtBVd_RQjNUhEPwMZ5le4ndaSGvjBrt <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14rtBVd… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14rtBVd… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1UxTza2… <named list [35]>
