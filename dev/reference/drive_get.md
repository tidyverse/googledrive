...
#> Created Drive file:
#> • alfalfa <id: 1R9sjneoH4QcTtZNc0nVyXYKl0O0pFGuW>
#> With MIME type:
...
#> • broccoli <id: 1rZc3NR-RPUHtWZsdXqVWfZAZuD2V_c16>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1rZc3NR-RPUHtWZsdXqVWfZAZuD2V_c16 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rZc3NR… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rZc3NR… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1R9sjne… <named list [36]>
