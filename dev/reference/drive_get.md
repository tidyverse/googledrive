...
#> Created Drive file:
#> • alfalfa <id: 1zwe9x7kA4Q8XsomxujmrfQvulLVUxgpf>
#> With MIME type:
...
#> • broccoli <id: 1T_DS03XnbslhTrYdxj2fC7fTckMrx7WR>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1T_DS03XnbslhTrYdxj2fC7fTckMrx7WR <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1T_DS03… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1T_DS03… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1zwe9x7… <named list [35]>
