...
#> Created Drive file:
#> • alfalfa <id: 10WnCyropWHJ5wf8bo5-BV0zI9DlVkLR_>
#> With MIME type:
...
#> • broccoli <id: 1RfZs1OiQdySyx0zraqLsMzEtdx8gIJlr>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1RfZs1OiQdySyx0zraqLsMzEtdx8gIJlr <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1RfZs1O… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1RfZs1O… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         10WnCyr… <named list [36]>
