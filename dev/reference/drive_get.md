...
#> Created Drive file:
#> • alfalfa <id: 1gGhr8PSoYCGJJ8Tsob4iDM4vLKL6ZWH9>
#> With MIME type:
...
#> • broccoli <id: 1L2-EfDrA71x5YFcfvFiq-lnihWfKqH3s>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1L2-EfDrA71x5YFcfvFiq-lnihWfKqH3s <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1L2-EfD… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1L2-EfD… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1gGhr8P… <named list [36]>
