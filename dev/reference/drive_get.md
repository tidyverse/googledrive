...
#> Created Drive file:
#> • alfalfa <id: 1v4FxlrrLLkrTQs0V6UPywnk98SVKRtnN>
#> With MIME type:
...
#> • broccoli <id: 1WMoR_khZHLTmcGRIdKhlk10zhtUAQ5qU>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1WMoR_khZHLTmcGRIdKhlk10zhtUAQ5qU <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1WMoR_k… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1WMoR_k… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1v4Fxlr… <named list [36]>
