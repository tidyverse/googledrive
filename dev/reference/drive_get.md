...
#> Created Drive file:
#> • alfalfa <id: 1wKw1tdgR2_4wVMy6QT1QApQXo2kBeJye>
#> With MIME type:
...
#> • broccoli <id: 1Vw0yDdsOGR7km1_-SBZvWmhlymtVjCpl>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Vw0yDdsOGR7km1_-SBZvWmhlymtVjCpl <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Vw0yDd… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Vw0yDd… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1wKw1td… <named list [35]>
