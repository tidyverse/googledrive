...
#> Created Drive file:
#> • alfalfa <id: 1d_qtP4XvOFwi_72yC8bCw0DrXsMlX3Eo>
#> With MIME type:
...
#> • broccoli <id: 1aG7NWm677YyP03R77ufrvx6le7CTUi79>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1aG7NWm677YyP03R77ufrvx6le7CTUi79 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1aG7NWm… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1d_qtP4… <named list [36]>
