...
#> Created Drive file:
#> • alfalfa <id: 1C6PP4bl4qJF0RLrvu1pTqwAYlxbypZ9z>
#> With MIME type:
...
#> • broccoli <id: 1RgSFm1TwYBZWI9CccuRAEKyY7nXnykTW>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1RgSFm1TwYBZWI9CccuRAEKyY7nXnykTW <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1RgSFm1… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1C6PP4b… <named list [35]>
