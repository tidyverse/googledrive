...
#> Created Drive file:
#> • alfalfa <id: 1pNC2SOeT3-Ms1RmvNCPA7AJDeM73oCvc>
#> With MIME type:
...
#> • broccoli <id: 1fg0gI4ukwPJpMy6InpoTDxFJlmqShR52>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1fg0gI4ukwPJpMy6InpoTDxFJlmqShR52 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1fg0gI4… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1fg0gI4… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1pNC2SO… <named list [36]>
