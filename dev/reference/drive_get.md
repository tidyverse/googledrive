...
#> Created Drive file:
#> • alfalfa <id: 10H6HWYtWcH7GOYQyu4H_PItz0x96lPQP>
#> With MIME type:
...
#> • broccoli <id: 1Bja-pma5ZHoiCQZJiXE8xEbtl1sjFdNN>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Bja-pma5ZHoiCQZJiXE8xEbtl1sjFdNN <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Bja-pm… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Bja-pm… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         10H6HWY… <named list [35]>
