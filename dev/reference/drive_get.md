...
#> Created Drive file:
#> • alfalfa <id: 15306DZrdaKuwnJhSzoVLNqS73SjW7na6>
#> With MIME type:
...
#> • broccoli <id: 140sFzlqZOT8GStvD2k7eR27tDxt7Cb1j>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 140sFzlqZOT8GStvD2k7eR27tDxt7Cb1j <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 140sFzl… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 140sFzl… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         15306DZ… <named list [36]>
