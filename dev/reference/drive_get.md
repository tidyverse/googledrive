...
#> Created Drive file:
#> • alfalfa <id: 1yLapyzf9YCS0odTg82-IvVIzQb4zcCdC>
#> With MIME type:
...
#> • broccoli <id: 1tBWXcc88bUvqFnb5Q1tT3EVxkDmtTRzU>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1tBWXcc88bUvqFnb5Q1tT3EVxkDmtTRzU <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tBWXcc… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tBWXcc… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1yLapyz… <named list [35]>
