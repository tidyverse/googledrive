...
#> Created Drive file:
#> • alfalfa <id: 1gWhEZzCbsMHGyeRel79PX626MK7gW6kN>
#> With MIME type:
...
#> • broccoli <id: 1uUkmvKIK1CFAPignszS4KVhehkdE9oOw>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1uUkmvKIK1CFAPignszS4KVhehkdE9oOw <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1uUkmvK… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1uUkmvK… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1gWhEZz… <named list [35]>
