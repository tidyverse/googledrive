...
#> Created Drive file:
#> • alfalfa <id: 13VIgEkPNBs4m9Wz20ZxpQXkYb_gYlbJa>
#> With MIME type:
...
#> • broccoli <id: 112g4BCzZeI1uvzR3kJ4ddpdE5SNbb9fM>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 112g4BCzZeI1uvzR3kJ4ddpdE5SNbb9fM <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 112g4BC… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         13VIgEk… <named list [35]>
