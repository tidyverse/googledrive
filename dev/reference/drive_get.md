...
#> Created Drive file:
#> • alfalfa <id: 1zSWMGwOqin4QsncH55FDikPSxsyBIBV4>
#> With MIME type:
...
#> • broccoli <id: 1LNBPRfZa9rfOLQMgEd57gWvkFULl-vJ3>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1LNBPRfZa9rfOLQMgEd57gWvkFULl-vJ3 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1LNBPRf… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1zSWMGw… <named list [35]>
