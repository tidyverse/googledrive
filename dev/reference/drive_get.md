...
#> Created Drive file:
#> • alfalfa <id: 1QDSyDdM0clkugemDJVt6IcGW-CdTTnY_>
#> With MIME type:
...
#> • broccoli <id: 1Wq8k-h73LxWl5AGXCOF__klNxchhJ2ZZ>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Wq8k-h73LxWl5AGXCOF__klNxchhJ2ZZ <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Wq8k-h… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1QDSyDd… <named list [35]>
