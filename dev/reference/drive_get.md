...
#> Created Drive file:
#> • alfalfa <id: 1d1Gt2DiJ1JQB-Wy-QF3Mls9gCeLaTdWn>
#> With MIME type:
...
#> • broccoli <id: 1JFBgOMcDemhmO0aMXldO4XPCALM8WCf7>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1JFBgOMcDemhmO0aMXldO4XPCALM8WCf7 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1JFBgOM… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1JFBgOM… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1d1Gt2D… <named list [36]>
