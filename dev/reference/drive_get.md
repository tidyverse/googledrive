...
#> Created Drive file:
#> • alfalfa <id: 1Eb-Aw-TthnqpCuNffZ7Rsw5qiiKPylXK>
#> With MIME type:
...
#> • broccoli <id: 1DHVnKs_Lx1WcfXMGf7gW7lSG8d_suUPf>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1DHVnKs_Lx1WcfXMGf7gW7lSG8d_suUPf <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1DHVnKs… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1Eb-Aw-… <named list [35]>
