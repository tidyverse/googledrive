...
#> Created Drive file:
#> • alfalfa <id: 1xvuK4s69r11iJUB7KOD1yVJYo8TDms3f>
#> With MIME type:
...
#> • broccoli <id: 1Ts7E8XE4SjtZckhW3GPUZYBYv-orW1yE>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Ts7E8XE4SjtZckhW3GPUZYBYv-orW1yE <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Ts7E8X… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Ts7E8X… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1xvuK4s… <named list [36]>
