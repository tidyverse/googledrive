...
#> Created Drive file:
#> • alfalfa <id: 1NGji-xcfbb6U7NbocWbPcasVlj6Gw1e4>
#> With MIME type:
...
#> • broccoli <id: 1tfPawz8OLMsFPk_jM6lH-yars_B2ZfTp>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1tfPawz8OLMsFPk_jM6lH-yars_B2ZfTp <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tfPawz… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1tfPawz… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1NGji-x… <named list [35]>
