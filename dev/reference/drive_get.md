...
#> Created Drive file:
#> • alfalfa <id: 1haHITny0iSgOr6McHHS_w3vfTd9SSd7p>
#> With MIME type:
...
#> • broccoli <id: 1Y81AtLUtrIvf2EUKGMYe2bXPlkKh2w5->
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Y81AtLUtrIvf2EUKGMYe2bXPlkKh2w5- <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Y81AtL… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Y81AtL… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1haHITn… <named list [35]>
