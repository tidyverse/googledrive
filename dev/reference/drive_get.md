...
#> Created Drive file:
#> • alfalfa <id: 1HUByH6qTdg0vj_AbrdE6nfFl6eWCReXn>
#> With MIME type:
...
#> • broccoli <id: 1Mmht3txbPGg03TCvRjWSCYajHPrL6M9j>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1Mmht3txbPGg03TCvRjWSCYajHPrL6M9j <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Mmht3t… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1Mmht3t… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1HUByH6… <named list [35]>
