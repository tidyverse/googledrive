...
#> Created Drive file:
#> • alfalfa <id: 167kn2xA09lapuApOjUKYJYVuToO0X5GX>
#> With MIME type:
...
#> • broccoli <id: 14kIDlrG7CWSLKBDNvavlGcvmkm6QKhNf>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14kIDlrG7CWSLKBDNvavlGcvmkm6QKhNf <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14kIDlr… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14kIDlr… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         167kn2x… <named list [36]>
