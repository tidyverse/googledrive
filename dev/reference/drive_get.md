...
#> Created Drive file:
#> • alfalfa <id: 1qhVBOwDqo0fvPv0ek_L_hmq2A9Zvkfgo>
#> With MIME type:
...
#> • broccoli <id: 1OcOZaohVXuSZk2VPVv_v7S_hidM9SOmu>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1OcOZaohVXuSZk2VPVv_v7S_hidM9SOmu <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1OcOZao… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1OcOZao… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1qhVBOw… <named list [35]>
