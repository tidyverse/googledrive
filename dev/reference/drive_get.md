...
#> Created Drive file:
#> • alfalfa <id: 17Srtbw8RI_zY0LrcncUpXDFOJlswTWGZ>
#> With MIME type:
...
#> • broccoli <id: 1ZZ_AqxS7bbHQns9MaBi4fxqjvXJ8Z_uw>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1ZZ_AqxS7bbHQns9MaBi4fxqjvXJ8Z_uw <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ZZ_Aqx… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         17Srtbw… <named list [35]>
