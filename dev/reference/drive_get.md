...
#> Created Drive file:
#> • alfalfa <id: 1wXrlMUq-qYfb_gZmKEGwEOpLKw0GkCRg>
#> With MIME type:
...
#> • broccoli <id: 1qLg3vdd5Gnq7TuxsPcZvuHbD2ZnQvd_I>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1qLg3vdd5Gnq7TuxsPcZvuHbD2ZnQvd_I <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1qLg3vd… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1qLg3vd… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1wXrlMU… <named list [35]>
