...
#> Created Drive file:
#> • alfalfa <id: 1MDouNPcNlXS5n-S79mRTVxs90Ql6UOLq>
#> With MIME type:
...
#> • broccoli <id: 15nYvJviVkAQgzNLhQmLhTeWoHPIcT1ba>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 15nYvJviVkAQgzNLhQmLhTeWoHPIcT1ba <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 15nYvJv… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 15nYvJv… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1MDouNP… <named list [35]>
