...
#> Created Drive file:
#> • alfalfa <id: 1wnFXfwUjTsMHZump9c97vaVj_Ni55eBY>
#> With MIME type:
...
#> • broccoli <id: 1p1TXK_LmJacBX8-DFAL3tmEsw0LdDWQc>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1p1TXK_LmJacBX8-DFAL3tmEsw0LdDWQc <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1p1TXK_… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1p1TXK_… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1wnFXfw… <named list [35]>
