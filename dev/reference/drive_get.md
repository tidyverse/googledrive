...
#> Created Drive file:
#> • alfalfa <id: 1n6qcAC0OfMfTcq5GV6E4CCL9Q2V_RDNr>
#> With MIME type:
...
#> • broccoli <id: 1MbyP9nmr8X00L-EEVHz-y0QkiLbz0Pkn>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1MbyP9nmr8X00L-EEVHz-y0QkiLbz0Pkn <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1MbyP9n… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1n6qcAC… <named list [35]>
