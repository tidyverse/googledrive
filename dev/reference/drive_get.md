...
#> Created Drive file:
#> • alfalfa <id: 1qTrIRcG6XVZigXWPfwUAPHS2SPxNx3w->
#> With MIME type:
...
#> • broccoli <id: 1rV4_nQhWuOJC0oDyj03RPw55fixRF0Bw>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1rV4_nQhWuOJC0oDyj03RPw55fixRF0Bw <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rV4_nQ… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rV4_nQ… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1qTrIRc… <named list [36]>
