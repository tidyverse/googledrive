...
#> Created Drive file:
#> • alfalfa <id: 1PvHwTVEw3XowG1MBh27o3yHhjnQb7QAZ>
#> With MIME type:
...
#> • broccoli <id: 1ZL_YbugL6ZXb9841xMWdBdPa-mxLPMqU>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1ZL_YbugL6ZXb9841xMWdBdPa-mxLPMqU <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ZL_Ybu… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ZL_Ybu… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1PvHwTV… <named list [36]>
