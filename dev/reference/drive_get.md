...
#> Created Drive file:
#> • alfalfa <id: 1lhNjn57TdjoJRcuABJnT06PV6_2d6vqV>
#> With MIME type:
...
#> • broccoli <id: 1GzPHll_5p_3xi4TlCC9EF14USrRPXbh0>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1GzPHll_5p_3xi4TlCC9EF14USrRPXbh0 <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1GzPHll… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1GzPHll… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1lhNjn5… <named list [36]>
