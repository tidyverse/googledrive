...
#> Created Drive file:
#> • alfalfa <id: 1fAZUvgdEIh8NL_k8CgIXXAUyCUeoO4XR>
#> With MIME type:
...
#> • broccoli <id: 1PVIiD0z7asnunsePL5YT_HywMNN1CMnb>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1PVIiD0z7asnunsePL5YT_HywMNN1CMnb <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1PVIiD0… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1PVIiD0… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1fAZUvg… <named list [35]>
