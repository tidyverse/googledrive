...
#> Created Drive file:
#> • alfalfa <id: 1XbuwAJDy0Ke2PUZolvsI-4TJNiBB4YUi>
#> With MIME type:
...
#> • broccoli <id: 1QYfK_bej0N3JLVDbO0rtAyX_zESMCTeL>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1QYfK_bej0N3JLVDbO0rtAyX_zESMCTeL <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1QYfK_b… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1QYfK_b… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1XbuwAJ… <named list [35]>
