...
#> Created Drive file:
#> • alfalfa <id: 1h2NUJyCbouyh56JJJqqO92cDqzFKyJtl>
#> With MIME type:
...
#> • broccoli <id: 1v6O_IsyusVAez3r4cdmi8w_2dpRGVY-f>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1v6O_IsyusVAez3r4cdmi8w_2dpRGVY-f <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1v6O_Is… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1v6O_Is… <named list [44]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [44]>
#> 3 alfalfa  ~/alfalfa/         1h2NUJy… <named list [35]>
