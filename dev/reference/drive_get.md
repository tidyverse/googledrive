...
#> Created Drive file:
#> • alfalfa <id: 1xPYrLrx8JwJ7CPOhtNBzbWBoTB_Rrk10>
#> With MIME type:
...
#> • broccoli <id: 1SxMCS1UVLbUIVW_KbgSswPFvEEx_34iy>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1SxMCS1UVLbUIVW_KbgSswPFvEEx_34iy <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1SxMCS1… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1xPYrLr… <named list [35]>
