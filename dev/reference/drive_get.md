...
#> Created Drive file:
#> • alfalfa <id: 1MajFNFzusjfQ4xzYqZUmjMUIAgiUO3gx>
#> With MIME type:
...
#> • broccoli <id: 14Nm4SSmTovZXM_y-n_laQzx6Y0HriWqj>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14Nm4SSmTovZXM_y-n_laQzx6Y0HriWqj <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14Nm4SS… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14Nm4SS… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1MajFNF… <named list [36]>
