...
#> Created Drive file:
#> • alfalfa <id: 1ZJ-DG9_xS9QTJocaTjbuaWlJb_84YUY->
#> With MIME type:
...
#> • broccoli <id: 1rKjxeHsU159R90KVQb_NpEKK2R6_F_RF>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1rKjxeHsU159R90KVQb_NpEKK2R6_F_RF <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rKjxeH… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1rKjxeH… <named list [45]>
#> 2 broccoli ~/broccoli         1aNh9_Y… <named list [45]>
#> 3 alfalfa  ~/alfalfa/         1ZJ-DG9… <named list [36]>
