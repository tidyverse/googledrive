...
#> Created Drive file:
#> • alfalfa <id: 1JZz6hdzA8hp6eUkoif5gl2qAK7YNQrei>
#> With MIME type:
...
#> • broccoli <id: 14cMyE7R2Pki1aeis5-xASYaZPwpdqNfO>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 14cMyE7R2Pki1aeis5-xASYaZPwpdqNfO <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 14cMyE7… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
...
#> 3 alfalfa  ~/alfalfa/         1JZz6hd… <named list [35]>
