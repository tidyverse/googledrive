...
#> Created Drive file:
#> • alfalfa <id: 1aDjm844laaEEbBFT6hBNc1To-PSQ3vDg>
#> With MIME type:
...
#> • broccoli <id: 1q3zAdfFfKRK36K8IKxJ_qIFnRCaAlxpW>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1q3zAdfFfKRK36K8IKxJ_qIFnRCaAlxpW <named list [44]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1q3zAdf… <named list [44]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1q3zAdf… <named list [45]>
...
#> 3 alfalfa  ~/alfalfa/         1aDjm84… <named list [36]>
