...
#> Created Drive file:
#> • alfalfa <id: 1W55XglgSr3F8fPsOIKW8fu1vcJoPVkeb>
#> With MIME type:
...
#> • broccoli <id: 114mdtQYKQyVwZtBT3Xi619gMOajDicij>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 114mdtQYKQyVwZtBT3Xi619gMOajDicij <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 114mdtQ… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 114mdtQ… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1W55Xgl… <named list [35]>
