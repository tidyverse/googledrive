...
#> Created Drive file:
#> • alfalfa <id: 1y5cZ75juJaajKDxq9-6fxYfsR8wywwda>
#> With MIME type:
...
#> • broccoli <id: 1ApQm5SCID26G5U4FyH5fZ5JJo2tB5wx3>
#> With MIME type:
#> • text/plain
drive_get("broccoli")
...
#>   name     path     id                                drive_resource   
#>   <chr>    <chr>    <drv_id>                          <list>           
#> 1 broccoli broccoli 1ApQm5SCID26G5U4FyH5fZ5JJo2tB5wx3 <named list [43]>
...
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ApQm5S… <named list [43]>
drive_get("~/alfalfa/broccoli")
#> ✔ The input `path` resolved to exactly 1 file.
#> # A dribble: 1 × 4
#>   name     path               id       drive_resource   
#>   <chr>    <chr>              <drv_id> <list>           
#> 1 broccoli ~/alfalfa/broccoli 1ApQm5S… <named list [44]>
...
#> 3 alfalfa  ~/alfalfa/         1y5cZ75… <named list [35]>
