...
#> Created Drive file:
#> • chicken_sheet <id: 1K06_8xk1y6w-iqLNGyO-3XiXci8QC7U4>
#> With MIME type:
...
#>   <id: 1DSYKAKObD3STxBgEWeZQPeRLmwKTQzUZ>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 105-Etba4wjYDkupnbzeompUZ-nw2JXTc>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1e8Ox5OQKBy-ldHtB5kq647yILIm493dZ>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1e8Ox5O… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1DSYKAK… <named list [34]>
#> 3 chicken_sheet                 1K06_8x… <named list [34]>
