...
#> Created Drive file:
#> • chicken_sheet <id: 18Gr9EQR_LK3FQuIXr2RtA7ge3ireXhnC>
#> With MIME type:
...
#>   <id: 1KLH9t8sr0MuyynSrhC0mmGl0R239A1IZ>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1Mtn7_KBZGZ3pl-FwTHa7xPd9SyE4KDtC>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 14-cn8JuqGHmvFfprTd7M3DPcff4OIUNe>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 14-cn8J… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1KLH9t8… <named list [34]>
#> 3 chicken_sheet                 18Gr9EQ… <named list [34]>
