...
#> Created Drive file:
#> • chicken_sheet <id: 1sjXUgeOAFClNs6BsQu_EBnmrjFacd-2G>
#> With MIME type:
...
#>   <id: 1Q7B4t_6HHy-FKiP18kyntxbV_xKeV-in>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 14PUMiPfa9iu-QglDvon16WiugLmqF374>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1wnLSfTFi74gCvmOgqRVGfbueL5xsev5j>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1wnLSfT… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1Q7B4t_… <named list [34]>
#> 3 chicken_sheet                 1sjXUge… <named list [34]>
