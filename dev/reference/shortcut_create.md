...
#> Created Drive file:
#> • chicken_sheet <id: 1Abpa-gVj0VRqSZK8aZEVv1SggDVPwNii>
#> With MIME type:
...
#>   <id: 16boAX59XJIuSRSIBzRrJBge3kWP8YRa8>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1XQPd1KhIBEgFYJiDEmBsrKW_P4jjmc6A>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 12OzfCSgldf5WrxqtFKOOACprN61zh0y7>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 12OzfCS… <named list [34]>
#> 2 chicken_sheet_second_shortcut 16boAX5… <named list [34]>
#> 3 chicken_sheet                 1Abpa-g… <named list [34]>
