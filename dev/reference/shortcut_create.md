...
#> Created Drive file:
#> • chicken_sheet <id: 1QOan1R2zKVoNTVwgWgHXptGzZmzQeiFo>
#> With MIME type:
...
#>   <id: 1rTrChpfMFtVGAq-Uaun_KJP0DEGpha1y>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 137zX_RQBkUQAXvIjPIiB0yFYCeaXwAOc>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1E3o80IQTdbgtFx7LxtQHEVMItG3nFtcD>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1E3o80I… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1rTrChp… <named list [35]>
#> 3 chicken_sheet                 1QOan1R… <named list [35]>
