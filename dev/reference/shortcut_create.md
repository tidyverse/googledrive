...
#> Created Drive file:
#> • chicken_sheet <id: 1NvKHBusQHiKdEQsk1gtv1j6C2-3_x3gg>
#> With MIME type:
...
#>   <id: 1uzN62sFhAc9a2gcbr0_c0V0xsc8AS9cm>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1juMDmhGo4G_8tR0i-LVY64eiN0Yq5Gbl>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1FdrjIaOsFCY0aFmbHh4bncXnaEqpHsV6>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1FdrjIa… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1uzN62s… <named list [34]>
#> 3 chicken_sheet                 1NvKHBu… <named list [34]>
