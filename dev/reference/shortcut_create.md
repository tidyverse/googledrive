...
#> Created Drive file:
#> • chicken_sheet <id: 1wgSshveTyWlmTL3WIjVN0bQqwfz5949H>
#> With MIME type:
...
#>   <id: 1ghMYVDnXXQD7O4vMSvxDrp3Y6YJhxHmT>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 182QX9bCbDiOVZs5mt1rJGJSizN6Ybix0>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1lddC6g3DBO1Z_uPaOnhX3LMiuoK584g9>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1lddC6g… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1ghMYVD… <named list [34]>
#> 3 chicken_sheet                 1wgSshv… <named list [34]>
