...
#> Created Drive file:
#> • chicken_sheet <id: 1PdeXayTwx2Xy423eH7mtx8hrwSNYVplg>
#> With MIME type:
...
#>   <id: 1VHFbVdODEDQT2qFidhUa7mGBuj6FIVM6>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1t1c-KLAXHPGZzYyYFLUR98Y7hEX-usGz>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1jWhhZOa-ju-Nxzr60wuMRI2vz7wApodh>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1jWhhZO… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1VHFbVd… <named list [35]>
#> 3 chicken_sheet                 1PdeXay… <named list [35]>
