...
#> Created Drive file:
#> • chicken_sheet <id: 17vRIpswxpBPqkH0uYHnjMYdl43Op1oYv>
#> With MIME type:
...
#>   <id: 1jkCzGivwT0YLOky7i5YfsSgvlH--SC6f>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1I2GSgvCCFA0Ols__dIMmHDLETS-M3FFE>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1yvlWQLG7_vHKbuKfTGAWkHevG_vhFrHG>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1yvlWQL… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1jkCzGi… <named list [35]>
#> 3 chicken_sheet                 17vRIps… <named list [35]>
