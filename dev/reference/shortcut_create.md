...
#> Created Drive file:
#> • chicken_sheet <id: 1cswiDlbk3C8rhfcTOfvLRqwM9FDuJytD>
#> With MIME type:
...
#>   <id: 1aGZDogGgBVqgr-kjeXuVXRumFaWSq7L9>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1j4lWrQJnB1mL5aeXOYZ2QhU97KwxdxRb>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 10LHb1vP-Syn-r33ICx2eTPV8eZjrq-rx>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 10LHb1v… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1aGZDog… <named list [35]>
#> 3 chicken_sheet                 1cswiDl… <named list [35]>
