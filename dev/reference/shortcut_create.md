...
#> Created Drive file:
#> • chicken_sheet <id: 1JFy2Ys_028Rj5ut12Ud917FFA1_vZd7V>
#> With MIME type:
...
#>   <id: 1z3thvC8qynEXamxp1KN762SSXgbRPfw4>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 14SBuLGCNUcwHFmJ-sFnoExUuB9x3fXnd>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1ShZ6uRYoHvcsTz3E2hz1VrEzu1CvxntF>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1ShZ6uR… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1z3thvC… <named list [34]>
#> 3 chicken_sheet                 1JFy2Ys… <named list [34]>
