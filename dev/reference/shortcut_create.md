...
#> Created Drive file:
#> • chicken_sheet <id: 18MtbxVRuYg8yRLKcHqcNmaaGeS4MERVP>
#> With MIME type:
...
#>   <id: 1ePIThIaTWpfUEzxog-byC6jnpi-giDFV>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1DXIEaVs1a0RMkDNr_3GVc9W6tGm8ZFLF>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 196mAm_lOGGrSRAq63FazNEyENKthEHMK>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 196mAm_… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1ePIThI… <named list [34]>
#> 3 chicken_sheet                 18MtbxV… <named list [34]>
