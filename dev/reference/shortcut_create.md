...
#> Created Drive file:
#> • chicken_sheet <id: 1z_FXYYfUo4tDpdED40dIrjgV1mVAQeU3>
#> With MIME type:
...
#>   <id: 18AbXggzsjvgB7OkQajVUic26IFzNnZHz>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 10IOP1WnqjH4w_1XTEeYTQWYpIjJkXzUA>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1LTRrGnlBY9-RTGQIAcnbnwtdjXoz16ye>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1LTRrGn… <named list [35]>
#> 2 chicken_sheet_second_shortcut 18AbXgg… <named list [35]>
#> 3 chicken_sheet                 1z_FXYY… <named list [35]>
