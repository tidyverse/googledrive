...
#> Created Drive file:
#> • chicken_sheet <id: 1iX-ezPvTePl8DVZY1ujZMxETnb_N_dJ7>
#> With MIME type:
...
#>   <id: 18CvpR0TyR4qaaixM6mPNHNP8us6_gx4V>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1xZHAElBZNSOqHbuFcBlG6W8d7qRzTdME>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1MZSOIC28rE9Vnx_MkgxyWiULhggVVwNA>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1MZSOIC… <named list [35]>
#> 2 chicken_sheet_second_shortcut 18CvpR0… <named list [35]>
#> 3 chicken_sheet                 1iX-ezP… <named list [35]>
