...
#> Created Drive file:
#> • chicken_sheet <id: 1-YIKZPMEmJueug3_esH1lUmdHbXUosf4>
#> With MIME type:
...
#>   <id: 1OoxISxctNkWpVuwvpGV9dtoaYbXLIaA1>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1mnYjSX4DBqvDnK2O01kwefPO7duPB12O>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 18mshSkkUe1bZsFX3VrEsc--yNdk1EMt_>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 18mshSk… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1OoxISx… <named list [34]>
#> 3 chicken_sheet                 1-YIKZP… <named list [34]>
