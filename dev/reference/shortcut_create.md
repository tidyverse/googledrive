...
#> Created Drive file:
#> • chicken_sheet <id: 1R0btR3p0Gwa6uPbXEioOtfy46OAAPIWY>
#> With MIME type:
...
#>   <id: 1oFsl0kPrjSaICMwVlC22mmjNQ3tBUoiU>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1QEoUTRjb3ldLpC7MGjZVCIVrMZ2SUJfz>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1FmwOOKjkUiT6c1yxV3QoOf3wJEfFUrtY>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1FmwOOK… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1oFsl0k… <named list [34]>
#> 3 chicken_sheet                 1R0btR3… <named list [34]>
