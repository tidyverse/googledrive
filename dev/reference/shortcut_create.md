...
#> Created Drive file:
#> • chicken_sheet <id: 1Xs17508sPg57MOiWB22ba98uJ48KPjzI>
#> With MIME type:
...
#>   <id: 1TBoHJr3ObvrXVaHk5Nt2zGiIjsKqs-d4>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1Li1DegPk6JFC2Kql1CNKgu2U_kOvy2cb>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1bi4tOstqkwhHWOit81gVYNcUjhHmNIrz>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1bi4tOs… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1TBoHJr… <named list [35]>
#> 3 chicken_sheet                 1Xs1750… <named list [35]>
