...
#> Created Drive file:
#> • chicken_sheet <id: 1ADQ4wJ0CPp9RgFDhvA8bQcQUsxIL0g7l>
#> With MIME type:
...
#>   <id: 19Lky_h-pBA8DHp154ekOF2shoxxZPgD5>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1QClGQEhNolfNqsx937DZemGMSaL3PkCS>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 102S8geeah06nsWOi0N-qi22FXIyIP1e1>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 102S8ge… <named list [35]>
#> 2 chicken_sheet_second_shortcut 19Lky_h… <named list [35]>
#> 3 chicken_sheet                 1ADQ4wJ… <named list [35]>
