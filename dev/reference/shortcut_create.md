...
#> Created Drive file:
#> • chicken_sheet <id: 1KYtr25lPdoLrEJaYBDrkaSOX3XKudu0k>
#> With MIME type:
...
#>   <id: 1Tu4daDfc-JmTa65-XwxXh255N4ZRHhLb>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1JDZuHKdtoD9P_nf_NmnxmyvdHrTrCjRH>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1Pi3avhuNnkU5_tjtJt-P1y_pvBvAHuyd>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1Pi3avh… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1Tu4daD… <named list [34]>
#> 3 chicken_sheet                 1KYtr25… <named list [34]>
