...
#> Created Drive file:
#> • chicken_sheet <id: 1eqOiwHtm6l-lZzpsM53CRgryxvO0vDnj>
#> With MIME type:
...
#>   <id: 1xoQiFp2Tqb6Xb8sk-_DLkAopYi1jZfTG>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 17qrQe6WYyDwwCASCs8QRzZQMfI4gQ8ON>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 11RUprXEV38gK9N-yIq0pQvMmXbQ23uI8>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 11RUprX… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1xoQiFp… <named list [34]>
#> 3 chicken_sheet                 1eqOiwH… <named list [34]>
