...
#> Created Drive file:
#> • chicken_sheet <id: 1z4mf52v7raoh6WxAPjcwcPvBye170W_W>
#> With MIME type:
...
#>   <id: 1FYHdMUA6RwmDUhD5hTnkzIaHQORbQwNp>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1R32qtpPtx6UciLTkAN6KNBFWsninQ4A4>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 182t67qxyCbShk-iwZJNKt0Cbpk-PrHOp>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 182t67q… <named list [35]>
#> 2 chicken_sheet_second_shortcut 1FYHdMU… <named list [35]>
#> 3 chicken_sheet                 1z4mf52… <named list [35]>
