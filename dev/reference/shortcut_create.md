...
#> Created Drive file:
#> • chicken_sheet <id: 1M-zhxNd2eTcBbxMOq47tBrNsvu8tk5_k>
#> With MIME type:
...
#>   <id: 1FuDzYUpUIz74uE3NZRdRe4yDG2QtSnpV>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   <id: 1CPW8vO2t0YFKlaGJmKcyBST8BWFsP8rH>
#> With MIME type:
#> • application/vnd.google-apps.folder
sc3 <- src_file |>
  shortcut_create(folder)
#> Created Drive file:
#> • chicken_sheet <id: 1GakG6usldXTUgeISd32bPZBkGOrYLToo>
#> With MIME type:
#> • application/vnd.google-apps.shortcut
...
#>   name                          id       drive_resource   
#>   <chr>                         <drv_id> <list>           
#> 1 chicken_sheet                 1GakG6u… <named list [34]>
#> 2 chicken_sheet_second_shortcut 1FuDzYU… <named list [34]>
#> 3 chicken_sheet                 1M-zhxN… <named list [34]>
