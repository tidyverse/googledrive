...
#> Created Drive file:
#> • drive-quiet-demo <id: 1_sWKmLd-zNZ3hRxrsosCNPcJSM45kjRDwWw-zTLCAXw>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1_sWKmL… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1_sWKmL… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 1_sWKmLd-zNZ3hRxrsosCNPcJSM45kjRDwWw-zTLCAXw>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1_sWKmL… <named list [38]>
