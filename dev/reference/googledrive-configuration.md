...
#> Created Drive file:
#> • drive-quiet-demo <id: 1f1RdKnfFJ2D5lGuZdmqLY1k966OtIKEXvBLkcw2xo3E>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1f1RdKn… <named list [38]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1f1RdKn… <named list [39]>
...
#> File updated:
#> • drive-quiet-works <id: 1f1RdKnfFJ2D5lGuZdmqLY1k966OtIKEXvBLkcw2xo3E>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1f1RdKn… <named list [39]>
