...
#> Created Drive file:
#> • drive-quiet-demo <id: 1VLR0BwrHoPCVQ9ifhRH1TkWkt_R1nEqThHuCJKEFHTw>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1VLR0Bw… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1VLR0Bw… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 1VLR0BwrHoPCVQ9ifhRH1TkWkt_R1nEqThHuCJKEFHTw>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1VLR0Bw… <named list [38]>
