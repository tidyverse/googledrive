...
#> Created Drive file:
#> • drive-quiet-demo <id: 1WcidmuDqbeIqLV2i5-mBmheiFcUoh2X_9fTAtm83iCc>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1Wcidmu… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1Wcidmu… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 1WcidmuDqbeIqLV2i5-mBmheiFcUoh2X_9fTAtm83iCc>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1Wcidmu… <named list [38]>
