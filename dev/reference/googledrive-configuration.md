...
#> Created Drive file:
#> • drive-quiet-demo <id: 1IQHTjFmZaFQVd3NXE-nQys3R0LjKpf88b3NgeSRuaAA>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1IQHTjF… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1IQHTjF… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 1IQHTjFmZaFQVd3NXE-nQys3R0LjKpf88b3NgeSRuaAA>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1IQHTjF… <named list [38]>
