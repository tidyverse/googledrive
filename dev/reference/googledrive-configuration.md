...
#> Created Drive file:
#> • drive-quiet-demo <id: 1x0D_jkYnzJMCAvVxijcczGTo5iBBNRz1jL4OuYDFDv4>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1x0D_jk… <named list [38]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1x0D_jk… <named list [39]>
...
#> File updated:
#> • drive-quiet-works <id: 1x0D_jkYnzJMCAvVxijcczGTo5iBBNRz1jL4OuYDFDv4>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1x0D_jk… <named list [39]>
