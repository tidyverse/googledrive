...
#> Created Drive file:
#> • drive-quiet-demo <id: 1oMNWrcgIwBA7T6jEi7hNLN3_ZlgWwyi1Hw-iqrJxJfM>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1oMNWrc… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1oMNWrc… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 1oMNWrcgIwBA7T6jEi7hNLN3_ZlgWwyi1Hw-iqrJxJfM>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1oMNWrc… <named list [38]>
