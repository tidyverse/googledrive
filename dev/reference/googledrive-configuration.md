...
#> Created Drive file:
#> • drive-quiet-demo <id: 148WTsKVMd9HSAKeYh8OOHJp6oSplGHruelHqdXQyPx4>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 148WTsK… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    148WTsK… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 148WTsKVMd9HSAKeYh8OOHJp6oSplGHruelHqdXQyPx4>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   148WTsK… <named list [38]>
