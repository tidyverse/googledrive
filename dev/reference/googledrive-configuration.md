...
#> Created Drive file:
#> • drive-quiet-demo <id: 12TiL9e91dFnd8YkXvEVyTOCp2Eee0AQy2w1Of7MUv-U>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 12TiL9e… <named list [38]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    12TiL9e… <named list [39]>
...
#> File updated:
#> • drive-quiet-works <id: 12TiL9e91dFnd8YkXvEVyTOCp2Eee0AQy2w1Of7MUv-U>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   12TiL9e… <named list [39]>
