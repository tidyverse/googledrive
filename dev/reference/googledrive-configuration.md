...
#> Created Drive file:
#> • drive-quiet-demo <id: 10FzDDD3crbmcXTAPXW4wyrwQ4nh9PKKvNV-e_gDBnFE>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 10FzDDD… <named list [37]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    10FzDDD… <named list [38]>
...
#> File updated:
#> • drive-quiet-works <id: 10FzDDD3crbmcXTAPXW4wyrwQ4nh9PKKvNV-e_gDBnFE>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   10FzDDD… <named list [38]>
