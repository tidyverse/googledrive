...
#> Created Drive file:
#> • drive-quiet-demo <id: 1XRRhWRoclFKFx0AOn292qO5PVwRdR8e3ZE94iKgtrSE>
#> With MIME type:
#> • application/vnd.google-apps.document
#> # A dribble: 1 × 3
#>   name             id       drive_resource   
#>   <chr>            <drv_id> <list>           
#> 1 drive-quiet-demo 1XRRhWR… <named list [38]>
...
#>   <chr>            <lgl>   <drv_id> <list>           
#> 1 drive-quiet-demo TRUE    1XRRhWR… <named list [39]>
...
#> File updated:
#> • drive-quiet-works <id: 1XRRhWRoclFKFx0AOn292qO5PVwRdR8e3ZE94iKgtrSE>
...
#>   name              starred id       drive_resource   
#>   <chr>             <lgl>   <drv_id> <list>           
#> 1 drive-quiet-works FALSE   1XRRhWR… <named list [39]>
