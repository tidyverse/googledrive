...
#> Copied to file:
#> • Copy of chicken.txt <id: 1-CYqcXy9WMPjgWljHk2hxB9dNX5U0Jow>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1xLouOBEJQvyWvQrOm31HdTRBShPcXYki>
#> With MIME type:
...
#>   <id: 1IiCS5r2lIcBYTtshGOqmsQNW00oq0Pqe>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1IiCS5r… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 14bBX4CdepuEnsUPJhm-abD0TN7v8Hi2P>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1-CYqcXy9WMPjgWljHk2hxB9dNX5U0Jow>
#> • chicken-cp.txt <id: 1IiCS5r2lIcBYTtshGOqmsQNW00oq0Pqe>
#> • Copy of chicken.txt <id: 14bBX4CdepuEnsUPJhm-abD0TN7v8Hi2P>
#> • drive-cp-folder <id: 1xLouOBEJQvyWvQrOm31HdTRBShPcXYki>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1ONjLUxPfmdQOee3jOnIL3pyyOwVjp_LunIuYdekx6qc>
