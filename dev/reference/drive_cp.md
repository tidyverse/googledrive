...
#> Copied to file:
#> • Copy of chicken.txt <id: 11KsOlIhaC1DzhT8cLqBqXCON_RTfFADT>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1QBmh26XEa88Z8Gb2Vw1zQVI8CeBaGQCf>
#> With MIME type:
...
#>   <id: 1YPB8pYQvGomEGCMrJpV5M6oTfRFaiyPP>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1YPB8pY… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1ubucdsHt7RpJ5ZLARv-HI7mnNS7ik0FR>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 11KsOlIhaC1DzhT8cLqBqXCON_RTfFADT>
#> • chicken-cp.txt <id: 1YPB8pYQvGomEGCMrJpV5M6oTfRFaiyPP>
#> • Copy of chicken.txt <id: 1ubucdsHt7RpJ5ZLARv-HI7mnNS7ik0FR>
#> • drive-cp-folder <id: 1QBmh26XEa88Z8Gb2Vw1zQVI8CeBaGQCf>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1XosTB-hLaVaPtK7lb1O-7yJqu9hGFhEN1TGH_vG3JBc>
