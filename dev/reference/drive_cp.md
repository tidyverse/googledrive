...
#> Copied to file:
#> • Copy of chicken.txt <id: 15LWVfEiXx--nOvkvp3fyIdaUlQ_sTpvd>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1xy-dr5EvSOyJ9_2tUE8MciexWh5iZBkI>
#> With MIME type:
...
#>   <id: 1mM5JxIuqNu-55A9tPKkZngES7gShOgPL>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1mM5JxI… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1zJMHjeH-scOwvdGrU5IwhMmZ5wtKKHOR>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 15LWVfEiXx--nOvkvp3fyIdaUlQ_sTpvd>
#> • chicken-cp.txt <id: 1mM5JxIuqNu-55A9tPKkZngES7gShOgPL>
#> • Copy of chicken.txt <id: 1zJMHjeH-scOwvdGrU5IwhMmZ5wtKKHOR>
#> • drive-cp-folder <id: 1xy-dr5EvSOyJ9_2tUE8MciexWh5iZBkI>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1Np4owzz5A5NgjOT_dOCMGjksK4M28ZVeSqNhOify-HM>
