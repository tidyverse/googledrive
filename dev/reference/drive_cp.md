...
#> Copied to file:
#> • Copy of chicken.txt <id: 18M6PGVRC4KywjoTpMxhkDzBRZyZlGJLy>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1yPifpXm2tI9TJyOpkifPwPYb1co07jqU>
#> With MIME type:
...
#>   <id: 1niCVDCXbqnSsnFJnqymDDcNNzomJy99q>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1niCVDC… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1hYJoV62zL0BJFNalohlsiAyXt-P_zIA0>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 18M6PGVRC4KywjoTpMxhkDzBRZyZlGJLy>
#> • chicken-cp.txt <id: 1niCVDCXbqnSsnFJnqymDDcNNzomJy99q>
#> • Copy of chicken.txt <id: 1hYJoV62zL0BJFNalohlsiAyXt-P_zIA0>
#> • drive-cp-folder <id: 1yPifpXm2tI9TJyOpkifPwPYb1co07jqU>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1-QbO8Tpm3Lx6jaUXMfzWNp0yam5XnOgJ-3YBQhcLWwc>
