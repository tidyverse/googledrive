...
#> Copied to file:
#> • Copy of chicken.txt <id: 11v6U7mOFeZ-RFgUuMnyBeu1NhLFfDOuq>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1KjBxoDTZT-Kl8fbsOVQKdIcS5adKl0w7>
#> With MIME type:
...
#>   <id: 1rt-NJZPQSwRTZqeM48IjIA_IuWUv5oOR>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1rt-NJZ… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1VyHEo_5FnLHv12FDb3Yzs2ntCgZd-ij3>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 11v6U7mOFeZ-RFgUuMnyBeu1NhLFfDOuq>
#> • chicken-cp.txt <id: 1rt-NJZPQSwRTZqeM48IjIA_IuWUv5oOR>
#> • Copy of chicken.txt <id: 1VyHEo_5FnLHv12FDb3Yzs2ntCgZd-ij3>
#> • drive-cp-folder <id: 1KjBxoDTZT-Kl8fbsOVQKdIcS5adKl0w7>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 17X4pqDYw9CPT73S_81IgecZOO4vqnpCd7wMOQyVhCnM>
