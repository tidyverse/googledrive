...
#> Copied to file:
#> • Copy of chicken.txt <id: 11eWddjrjoMm0vHo4w1INPJPXt-zLK_AJ>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1qTfAeH-oZ0m_Bit3IPzmmfBzLYOozpzZ>
#> With MIME type:
...
#>   <id: 1S1kMeUp9M--SGJGJGipxXP2A7cki2qqR>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1S1kMeU… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1TtkFaM4kN4iZFGCXEklHeY3EhSB_LMtL>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 11eWddjrjoMm0vHo4w1INPJPXt-zLK_AJ>
#> • chicken-cp.txt <id: 1S1kMeUp9M--SGJGJGipxXP2A7cki2qqR>
#> • Copy of chicken.txt <id: 1TtkFaM4kN4iZFGCXEklHeY3EhSB_LMtL>
#> • drive-cp-folder <id: 1qTfAeH-oZ0m_Bit3IPzmmfBzLYOozpzZ>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1vLHDCkhNAAPuflcV0YtiIsK47Fsp9O3NK6RytsNudpw>
