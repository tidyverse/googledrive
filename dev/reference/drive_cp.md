...
#> Copied to file:
#> • Copy of chicken.txt <id: 1_geSSXlJCyFc25BW2zfsUfSFeRm_VuAK>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1y1S6f0Fw5uZeefcIO_Vo-v4PtYwOTHUj>
#> With MIME type:
...
#>   <id: 1LGcbMVCk_LDi_RKnIyApYAsGAcs5kQWI>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1LGcbMV… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1tYVKXIKmt28kTREwjYj1MGiQT6H2lPmX>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1_geSSXlJCyFc25BW2zfsUfSFeRm_VuAK>
#> • chicken-cp.txt <id: 1LGcbMVCk_LDi_RKnIyApYAsGAcs5kQWI>
#> • Copy of chicken.txt <id: 1tYVKXIKmt28kTREwjYj1MGiQT6H2lPmX>
#> • drive-cp-folder <id: 1y1S6f0Fw5uZeefcIO_Vo-v4PtYwOTHUj>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1V-EhRq2ESPZq0i8tZChg0Mw0M5-MyYm8iPBXr76DbsQ>
