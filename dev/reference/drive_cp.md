...
#> Copied to file:
#> • Copy of chicken.txt <id: 1xa8WuZmXLORGS-gWbmvxoOLXtJOB1aVa>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1pK7GxqyjGvBQm-oDQntUXlzETyGYr8R5>
#> With MIME type:
...
#>   <id: 1bw2XikzBzMNd7oZUdHiu53L5saJHWRXI>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1bw2Xik… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1NMNPYMOwGvK-LKLLqG_fSrPim9_cfB8b>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1xa8WuZmXLORGS-gWbmvxoOLXtJOB1aVa>
#> • chicken-cp.txt <id: 1bw2XikzBzMNd7oZUdHiu53L5saJHWRXI>
#> • Copy of chicken.txt <id: 1NMNPYMOwGvK-LKLLqG_fSrPim9_cfB8b>
#> • drive-cp-folder <id: 1pK7GxqyjGvBQm-oDQntUXlzETyGYr8R5>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1asX9p5sxr3fjdF_fszMxVKclOXY_Ds8SkuxbenoHifU>
