...
#> Copied to file:
#> • Copy of chicken.txt <id: 160uF8auJ5Fm9dmmvcGltfyFSAuTcOzCd>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1UNh-4GHR0kZzNwrw7fGlMZ3gXYOk-fvT>
#> With MIME type:
...
#>   <id: 1FcJ8K9Izp2pPnUDtWKMvemaF2qyECaGw>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1FcJ8K9… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 15Al18nB-gwM7TYAADFJypdBNtIG-mb6F>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 160uF8auJ5Fm9dmmvcGltfyFSAuTcOzCd>
#> • chicken-cp.txt <id: 1FcJ8K9Izp2pPnUDtWKMvemaF2qyECaGw>
#> • Copy of chicken.txt <id: 15Al18nB-gwM7TYAADFJypdBNtIG-mb6F>
#> • drive-cp-folder <id: 1UNh-4GHR0kZzNwrw7fGlMZ3gXYOk-fvT>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1lx9RaZCob84YrPKiW3BZYM0BaMnCGC_tRv5yrV11iVA>
