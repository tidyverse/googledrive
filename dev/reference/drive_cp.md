...
#> Copied to file:
#> • Copy of chicken.txt <id: 1r4VPrnmxvd7-afETv_AsHQUGtJyezsuV>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1jv-Tk7vwRu1UImYuuwX57qCKq6D3VTRL>
#> With MIME type:
...
#>   <id: 1AyCHLDogWyj3nSUphG9HMPBG9YxPPkZN>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1AyCHLD… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1q0EYs4rVeW-f0WBzJEQtynVUWxiwM2-e>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1r4VPrnmxvd7-afETv_AsHQUGtJyezsuV>
#> • chicken-cp.txt <id: 1AyCHLDogWyj3nSUphG9HMPBG9YxPPkZN>
#> • Copy of chicken.txt <id: 1q0EYs4rVeW-f0WBzJEQtynVUWxiwM2-e>
#> • drive-cp-folder <id: 1jv-Tk7vwRu1UImYuuwX57qCKq6D3VTRL>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1joO6ktd8avxi-98FksowEXaTePODxzcuL6ClLfNjOCw>
