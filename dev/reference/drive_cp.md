...
#> Copied to file:
#> • Copy of chicken.txt <id: 1JoEzVtq4mCFbc89B_3jSUpn9u3-gSjJK>
...
#> Created Drive file:
#> • drive-cp-folder <id: 14O9bJb09eZaF1M4a6ULdzWonmmOFUsWC>
#> With MIME type:
...
#>   <id: 1niGXYhwYXAFtVX5zL1gN61qqAxJG_NMe>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1niGXYh… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1Iv7NksulhesMPtPKP99SrALro3Ubx91e>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1JoEzVtq4mCFbc89B_3jSUpn9u3-gSjJK>
#> • chicken-cp.txt <id: 1niGXYhwYXAFtVX5zL1gN61qqAxJG_NMe>
#> • Copy of chicken.txt <id: 1Iv7NksulhesMPtPKP99SrALro3Ubx91e>
#> • drive-cp-folder <id: 14O9bJb09eZaF1M4a6ULdzWonmmOFUsWC>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1GmBgWvPYDXMY3Rm-TOqL4X8skVu2yYW45spmS9nsogE>
