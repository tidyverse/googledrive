...
#> Copied to file:
#> • Copy of chicken.txt <id: 1cL7zdJa8-0igb3qsDAtE26y6uiT8ExqF>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1Sot2JKROzgWK-WwuOzY_vk9CrKyPEqJ->
#> With MIME type:
...
#>   <id: 1ZHhHH55Hc-WHelx4sj67p8GpgzX0SyBX>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1ZHhHH5… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1yJQQhhToNA2Irf3wEAefy6meVZLw2px5>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1cL7zdJa8-0igb3qsDAtE26y6uiT8ExqF>
#> • chicken-cp.txt <id: 1ZHhHH55Hc-WHelx4sj67p8GpgzX0SyBX>
#> • Copy of chicken.txt <id: 1yJQQhhToNA2Irf3wEAefy6meVZLw2px5>
#> • drive-cp-folder <id: 1Sot2JKROzgWK-WwuOzY_vk9CrKyPEqJ->
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1OeGyaKnzDUWWcWKVhuhVeWYiAQ4Nepv0CPTstKafOGY>
