...
#> Copied to file:
#> • Copy of chicken.txt <id: 1fnGkNgW93VnnLWmItMpliq4Ut8lJ5Vft>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1rfslu2i2PMxk2q1V3V0Qrbtbs1a6Zhsg>
#> With MIME type:
...
#>   <id: 1s_GPYS9xUFGRgFNVYCfe1ufQgSAUbb2u>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1s_GPYS… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1iuwTDlIDepHoLIqSLMWCEPhSlDdbVt5B>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1fnGkNgW93VnnLWmItMpliq4Ut8lJ5Vft>
#> • chicken-cp.txt <id: 1s_GPYS9xUFGRgFNVYCfe1ufQgSAUbb2u>
#> • Copy of chicken.txt <id: 1iuwTDlIDepHoLIqSLMWCEPhSlDdbVt5B>
#> • drive-cp-folder <id: 1rfslu2i2PMxk2q1V3V0Qrbtbs1a6Zhsg>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 19NYBtFa6qKz6wnfZOZ1vH1Cf4eTw-HZfZKiZKi41odo>
