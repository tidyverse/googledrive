...
#> Copied to file:
#> • Copy of chicken.txt <id: 1QSYFI7NGCBLak31jWrQQlMvsmopoTBP->
...
#> Created Drive file:
#> • drive-cp-folder <id: 1NZcMFjyzMLBx_OH7PMg575nCCmR6iOYb>
#> With MIME type:
...
#>   <id: 1xOjWfSuHzbbYt8KHF9-P-ehMHwdXG1Ny>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1xOjWfS… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 11XUyKl4CXkZ-Y69i1j2Tp1p_6kKn9O48>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1QSYFI7NGCBLak31jWrQQlMvsmopoTBP->
#> • chicken-cp.txt <id: 1xOjWfSuHzbbYt8KHF9-P-ehMHwdXG1Ny>
#> • Copy of chicken.txt <id: 11XUyKl4CXkZ-Y69i1j2Tp1p_6kKn9O48>
#> • drive-cp-folder <id: 1NZcMFjyzMLBx_OH7PMg575nCCmR6iOYb>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1Y4BejKsi62aurjOOtKB01pr5tY-KJisrZMonxpKbirM>
