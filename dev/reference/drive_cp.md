...
#> Copied to file:
#> • Copy of chicken.txt <id: 1E5IvMBkIZOjh0ZsaVSQVN3opVQb8y2Mc>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1HXOoMf02JEl_CmnPrt93hywfwuZPjd2U>
#> With MIME type:
...
#>   <id: 1UpwsZw9ft3Nas3HQ2hbmlGJYeyGlspP5>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1UpwsZw… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1cMg4cUKQXG-SEakt40noETsnR41MxTCF>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1E5IvMBkIZOjh0ZsaVSQVN3opVQb8y2Mc>
#> • chicken-cp.txt <id: 1UpwsZw9ft3Nas3HQ2hbmlGJYeyGlspP5>
#> • Copy of chicken.txt <id: 1cMg4cUKQXG-SEakt40noETsnR41MxTCF>
#> • drive-cp-folder <id: 1HXOoMf02JEl_CmnPrt93hywfwuZPjd2U>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1CH_lk9gnAnk70u93ic0jl2fv5u-jERe_aMAq8oAo9iA>
