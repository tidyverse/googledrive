...
#> Copied to file:
#> • Copy of chicken.txt <id: 1RkW3m2tmkpSm-z1phld-uOdF0XOCIAYM>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1np_xUn_CG6lGhaPutAx0oUCY7zLpm9-A>
#> With MIME type:
...
#>   <id: 1RZBHrtmlNLcO-Ze8tmAbgo-Zxyri9SZh>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1RZBHrt… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1GHmlTaVTMPDUjLCmmnlbIpMpfoPxY1me>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1RkW3m2tmkpSm-z1phld-uOdF0XOCIAYM>
#> • chicken-cp.txt <id: 1RZBHrtmlNLcO-Ze8tmAbgo-Zxyri9SZh>
#> • Copy of chicken.txt <id: 1GHmlTaVTMPDUjLCmmnlbIpMpfoPxY1me>
#> • drive-cp-folder <id: 1np_xUn_CG6lGhaPutAx0oUCY7zLpm9-A>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1CKbMBPh-1PKHIA1tjVc6W3hbEDh088fW5GQZKzrt4EU>
