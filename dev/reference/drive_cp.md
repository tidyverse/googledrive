...
#> Copied to file:
#> • Copy of chicken.txt <id: 1BTDByWSxA0ANLIIMHvWixPhF5uG02C-Z>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1IIrdc7zdYY8dp0OGhS-Um9p5wxHXbzOl>
#> With MIME type:
...
#>   <id: 1y1itwuv8gyu7C6kUwXmE4N6p9cVDcaUO>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1y1itwu… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1bnsUpHblmGy8C4s03wZDM1QCjXP9K_AE>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1BTDByWSxA0ANLIIMHvWixPhF5uG02C-Z>
#> • chicken-cp.txt <id: 1y1itwuv8gyu7C6kUwXmE4N6p9cVDcaUO>
#> • Copy of chicken.txt <id: 1bnsUpHblmGy8C4s03wZDM1QCjXP9K_AE>
#> • drive-cp-folder <id: 1IIrdc7zdYY8dp0OGhS-Um9p5wxHXbzOl>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1LFL12v8hmHaIlLWudOc9upcUhU-M-v_kyMB1jOXAbgY>
