...
#> Copied to file:
#> • Copy of chicken.txt <id: 1VJPqPPBu74U2ZIOD8OiPLJKAutX0LHgI>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1r1zkvkPbaTxM1G1ZwHz9-hbKHEEBWrTA>
#> With MIME type:
...
#>   <id: 1UtY8BTnwBFDeAQHEBMwsPgb7ZKvHQEIN>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1UtY8BT… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1bXaps1KTZizpLpv2SQmCxS1OqVQZwEEa>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1VJPqPPBu74U2ZIOD8OiPLJKAutX0LHgI>
#> • chicken-cp.txt <id: 1UtY8BTnwBFDeAQHEBMwsPgb7ZKvHQEIN>
#> • Copy of chicken.txt <id: 1bXaps1KTZizpLpv2SQmCxS1OqVQZwEEa>
#> • drive-cp-folder <id: 1r1zkvkPbaTxM1G1ZwHz9-hbKHEEBWrTA>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1aN3avxltc5iBVRmd0Wh5jDlwduVUtZARLr18yj3Xa4E>
