...
#> Copied to file:
#> • Copy of chicken.txt <id: 1yShiDZa3iPgagpDCAQWJfpWD-qpPjkge>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1e3frGkoVSut5WBaAdpJdA_WEvUsMmiOe>
#> With MIME type:
...
#>   <id: 1hCjyqrTovduJkylb8mAdFc7ginIidZyY>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1hCjyqr… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1oIn5WGak7kdjeKD7M47bp6jPn9KM2SuX>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1yShiDZa3iPgagpDCAQWJfpWD-qpPjkge>
#> • chicken-cp.txt <id: 1hCjyqrTovduJkylb8mAdFc7ginIidZyY>
#> • Copy of chicken.txt <id: 1oIn5WGak7kdjeKD7M47bp6jPn9KM2SuX>
#> • drive-cp-folder <id: 1e3frGkoVSut5WBaAdpJdA_WEvUsMmiOe>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1fuVipyrF4HnuP3J2TO558yowBeueINM_fph0GFaT0oc>
