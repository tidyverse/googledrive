...
#> Copied to file:
#> • Copy of chicken.txt <id: 1A4t_tvhmhqtpd6qR8JyAInvpbrj4-b5o>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1Jg1nHc08cjecOiUmonwkRtI1M0PBtinr>
#> With MIME type:
...
#>   <id: 1178t4s5niQr6TKe3gjNHQknG8VMnFZ-5>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1178t4s… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1VyaSeF0Bwi8fmkjnDIuSubrFBP173CZY>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1A4t_tvhmhqtpd6qR8JyAInvpbrj4-b5o>
#> • chicken-cp.txt <id: 1178t4s5niQr6TKe3gjNHQknG8VMnFZ-5>
#> • Copy of chicken.txt <id: 1VyaSeF0Bwi8fmkjnDIuSubrFBP173CZY>
#> • drive-cp-folder <id: 1Jg1nHc08cjecOiUmonwkRtI1M0PBtinr>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1REVER3ywZdHGJrRcx0URQYIz2LtMTlNx5QQDNw-jOKI>
