...
#> Copied to file:
#> • Copy of chicken.txt <id: 1_H9lrXjGAZzhQeG-MAb27oEew1xWhdbL>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1Ef7uOLDVrC4RgtpbLezSpYdqp8alCM9j>
#> With MIME type:
...
#>   <id: 1CR-q3D4hkJXUaOEygZ-VvbQGTLS53CIz>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1CR-q3D… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1BE1VhMmzb8j_vZukU_hAUNWUw3Vvalta>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1_H9lrXjGAZzhQeG-MAb27oEew1xWhdbL>
#> • chicken-cp.txt <id: 1CR-q3D4hkJXUaOEygZ-VvbQGTLS53CIz>
#> • Copy of chicken.txt <id: 1BE1VhMmzb8j_vZukU_hAUNWUw3Vvalta>
#> • drive-cp-folder <id: 1Ef7uOLDVrC4RgtpbLezSpYdqp8alCM9j>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 159OrXimbCrOC79e6_kTeo-A2N1tRnVmEmkeBNAp15ys>
