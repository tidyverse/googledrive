...
#> Copied to file:
#> • Copy of chicken.txt <id: 12re1TsxnpDbIa1G4AQ9sfB-VTC21Ulmq>
...
#> Created Drive file:
#> • drive-cp-folder <id: 18PMn7DzigEqT4_q5NiancD32emQQE05S>
#> With MIME type:
...
#>   <id: 1s7oVrq0ymHzlj0kSkNS3X6JZE-uxKhXv>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1s7oVrq… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 16sWXFWaQHLao5IZDLb-VvbdF9DWTq4c0>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 12re1TsxnpDbIa1G4AQ9sfB-VTC21Ulmq>
#> • chicken-cp.txt <id: 1s7oVrq0ymHzlj0kSkNS3X6JZE-uxKhXv>
#> • Copy of chicken.txt <id: 16sWXFWaQHLao5IZDLb-VvbdF9DWTq4c0>
#> • drive-cp-folder <id: 18PMn7DzigEqT4_q5NiancD32emQQE05S>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 15aHyCZ7ciBNwJqPtIUDyAa4pejwmB2stnm6EqXJ_jis>
