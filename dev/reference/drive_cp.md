...
#> Copied to file:
#> • Copy of chicken.txt <id: 1CrYlKyVKafGwCG2CA-oVzh1P7VIHZxqC>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1QS5BKCJq-Lte5oOoORDG68luLM2iQAj0>
#> With MIME type:
...
#>   <id: 1EByI60qoJQx602ahpDMFQ27Kd7K3tJN->
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1EByI60… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1YJ6Mlo58x7bSwo5e7zDh6b9eaX7OaRM->

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1CrYlKyVKafGwCG2CA-oVzh1P7VIHZxqC>
#> • chicken-cp.txt <id: 1EByI60qoJQx602ahpDMFQ27Kd7K3tJN->
#> • Copy of chicken.txt <id: 1YJ6Mlo58x7bSwo5e7zDh6b9eaX7OaRM->
#> • drive-cp-folder <id: 1QS5BKCJq-Lte5oOoORDG68luLM2iQAj0>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1At-9rPAgaIX421LBbjnWuv5SKmppCmosPSvEOdAXDkE>
