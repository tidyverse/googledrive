...
#> Copied to file:
#> • Copy of chicken.txt <id: 1xnwlREGcyyGA8dv8EjbIFfasU__np9gm>
...
#> Created Drive file:
#> • drive-cp-folder <id: 13WeKNAUDyz6E86nGrZN3eqoNVrZEh0Rc>
#> With MIME type:
...
#>   <id: 19nVLbseF0TX-D4mUU5kvqFQsKAqPQHN7>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    19nVLbs… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1UwvmRSUdfw3EkbCqjuaRZk1wnYSS_6MU>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1xnwlREGcyyGA8dv8EjbIFfasU__np9gm>
#> • chicken-cp.txt <id: 19nVLbseF0TX-D4mUU5kvqFQsKAqPQHN7>
#> • Copy of chicken.txt <id: 1UwvmRSUdfw3EkbCqjuaRZk1wnYSS_6MU>
#> • drive-cp-folder <id: 13WeKNAUDyz6E86nGrZN3eqoNVrZEh0Rc>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1mEpwcWq58cWTZqc1afGxkywYyTKH9GvOvSkzaRDNI-A>
