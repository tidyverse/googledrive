...
#> Copied to file:
#> • Copy of chicken.txt <id: 1gqbrO4CMVLEbKpCM1LU8QAqhG7C4W17Z>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1npUsu5na-ez3y7W-h_td_jBmwMLhWaoA>
#> With MIME type:
...
#>   <id: 10k7a57MOFLlstWwS0jax0l_7c33nSWun>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    10k7a57… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1e5Rx4viWfqmxegFudO__eWQ2k8B_la60>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1gqbrO4CMVLEbKpCM1LU8QAqhG7C4W17Z>
#> • chicken-cp.txt <id: 10k7a57MOFLlstWwS0jax0l_7c33nSWun>
#> • Copy of chicken.txt <id: 1e5Rx4viWfqmxegFudO__eWQ2k8B_la60>
#> • drive-cp-folder <id: 1npUsu5na-ez3y7W-h_td_jBmwMLhWaoA>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1xaLqS_dCwCchGAxTda18gGffo7caAOg4uhpa9s95-Iw>
