...
#> Copied to file:
#> • Copy of chicken.txt <id: 1e6n2xCMoUmwYkCajxLLOufM0jogZPro6>
...
#> Created Drive file:
#> • drive-cp-folder <id: 12WAeznJbbUBxZHR1VjA_WURb2JnfG_wO>
#> With MIME type:
...
#>   <id: 1PpkWdW_mZHgOAQN7BCCyfEZGsCwqEJWA>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1PpkWdW… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1WaZ0YYic6dy55w0aeUV2tdzHHCdoC_-q>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1e6n2xCMoUmwYkCajxLLOufM0jogZPro6>
#> • chicken-cp.txt <id: 1PpkWdW_mZHgOAQN7BCCyfEZGsCwqEJWA>
#> • Copy of chicken.txt <id: 1WaZ0YYic6dy55w0aeUV2tdzHHCdoC_-q>
#> • drive-cp-folder <id: 12WAeznJbbUBxZHR1VjA_WURb2JnfG_wO>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 13jxgsAwac3IvMZwpNxu_2C91ySbCj8R2cav3Z44gtRY>
