...
#> Copied to file:
#> • Copy of chicken.txt <id: 1Vw3qSOnSzB9kzeVoIUszVjpWPv9y_MbH>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1aBmntgn0FrtWCiMeodv6KGvD-WXtf77k>
#> With MIME type:
...
#>   <id: 1TAy5nEzAJvZNulrSW8bneRPcrtpYqdce>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1TAy5nE… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1ZanL-CF4RMPRLMzBnFIrzjDO4I7Dli8B>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1Vw3qSOnSzB9kzeVoIUszVjpWPv9y_MbH>
#> • chicken-cp.txt <id: 1TAy5nEzAJvZNulrSW8bneRPcrtpYqdce>
#> • Copy of chicken.txt <id: 1ZanL-CF4RMPRLMzBnFIrzjDO4I7Dli8B>
#> • drive-cp-folder <id: 1aBmntgn0FrtWCiMeodv6KGvD-WXtf77k>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1ox1NdPghWDM-_FigqtCZXGZYPUn4N9WeIpBs4_P1veY>
