...
#> Copied to file:
#> • Copy of chicken.txt <id: 1yyCfTxpEOx3HLrhMb18Scs8X8Fzbx7sY>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1ZMAjg98z630utnDhWJKEsWvwY1yMcmmf>
#> With MIME type:
...
#>   <id: 1eQPNiry8ShVPCJJorHmOaYJxclZcKRSP>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1eQPNir… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1pbzEXn7o4xLBJmWYZzmChT-uyOWTqi0M>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1yyCfTxpEOx3HLrhMb18Scs8X8Fzbx7sY>
#> • chicken-cp.txt <id: 1eQPNiry8ShVPCJJorHmOaYJxclZcKRSP>
#> • Copy of chicken.txt <id: 1pbzEXn7o4xLBJmWYZzmChT-uyOWTqi0M>
#> • drive-cp-folder <id: 1ZMAjg98z630utnDhWJKEsWvwY1yMcmmf>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1Wpq3nFZSWL_d807oEuAflwJr8bVOr_ykelgEidpbW8k>
