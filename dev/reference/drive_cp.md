...
#> Copied to file:
#> • Copy of chicken.txt <id: 17FMRHQHmCg8nF1bIRaJ8jqSoU91WYM-d>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1SiTxZf-ZmH34JlGv51AJOxiVVTiq_GtT>
#> With MIME type:
...
#>   <id: 1QLzwAeA1fxSiYuDEeqhkWKrj7cQDZBxc>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1QLzwAe… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1Lzu4kr8_LOr7LDJTkm3vEnjg8y0J3lc1>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 17FMRHQHmCg8nF1bIRaJ8jqSoU91WYM-d>
#> • chicken-cp.txt <id: 1QLzwAeA1fxSiYuDEeqhkWKrj7cQDZBxc>
#> • Copy of chicken.txt <id: 1Lzu4kr8_LOr7LDJTkm3vEnjg8y0J3lc1>
#> • drive-cp-folder <id: 1SiTxZf-ZmH34JlGv51AJOxiVVTiq_GtT>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1cVg4ZByvHUjJdtE5fird0-YJXryZVuMBFSMppnoZ77s>
