...
#> Copied to file:
#> • Copy of chicken.txt <id: 1vZcdWtRmbvCRk_KCjuomyr5t6up_K6MH>
...
#> Created Drive file:
#> • drive-cp-folder <id: 14_VLvw1M8yNYdW9PaDu6x8iYFA4y4sS5>
#> With MIME type:
...
#>   <id: 1MD9J9AXdL6g28oBvRKeH4xIlWXWsNC2C>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1MD9J9A… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1md39ulIpbOhmIJsYzf5CQgO-kpKsYCr2>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1vZcdWtRmbvCRk_KCjuomyr5t6up_K6MH>
#> • chicken-cp.txt <id: 1MD9J9AXdL6g28oBvRKeH4xIlWXWsNC2C>
#> • Copy of chicken.txt <id: 1md39ulIpbOhmIJsYzf5CQgO-kpKsYCr2>
#> • drive-cp-folder <id: 14_VLvw1M8yNYdW9PaDu6x8iYFA4y4sS5>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1Qf0_79eZDPOO1vioXjIviTCmAoGFMKo-Kgr74wNbqlM>
