...
#> Copied to file:
#> • Copy of chicken.txt <id: 1tPpk9NYOMgvtd9BCDKpwObmSWlu2RV4V>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1WHs132bmBgCdd97Guvfab-nlFaCNwu8X>
#> With MIME type:
...
#>   <id: 1OascofyLjar1RZ-ApW8vwyvaV6dyBRVX>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1Oascof… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1OID1MtijYs-Jt7YvPWI6ndk-_-ag-bhb>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1tPpk9NYOMgvtd9BCDKpwObmSWlu2RV4V>
#> • chicken-cp.txt <id: 1OascofyLjar1RZ-ApW8vwyvaV6dyBRVX>
#> • Copy of chicken.txt <id: 1OID1MtijYs-Jt7YvPWI6ndk-_-ag-bhb>
#> • drive-cp-folder <id: 1WHs132bmBgCdd97Guvfab-nlFaCNwu8X>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 12yS08WsoMLQIy6WRkR6k1VSj28AZxcQYHKnCRx0PrNM>
