...
#> Copied to file:
#> • Copy of chicken.txt <id: 1dNvBe5rNFd_cDEmI7iI-BwFGy1XD9xy6>
...
#> Created Drive file:
#> • drive-cp-folder <id: 18aZMyVj1wfyXyrVBtwDlC5dTS_qHOw1j>
#> With MIME type:
...
#>   <id: 1CVmEnk57GLQa6vDwOwSCfz_oVlXTBNB_>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1CVmEnk… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1ug9-NohEITcUFKFpIM3N1FpFBXXeyYsz>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1dNvBe5rNFd_cDEmI7iI-BwFGy1XD9xy6>
#> • chicken-cp.txt <id: 1CVmEnk57GLQa6vDwOwSCfz_oVlXTBNB_>
#> • Copy of chicken.txt <id: 1ug9-NohEITcUFKFpIM3N1FpFBXXeyYsz>
#> • drive-cp-folder <id: 18aZMyVj1wfyXyrVBtwDlC5dTS_qHOw1j>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1BnVXWyT81_zw0FcJMjBLihCGUtrwTevnGofyoCaNFyE>
