...
#> Copied to file:
#> • Copy of chicken.txt <id: 1n7GgYtDg9com6UVA752pabUiLVL6T-by>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1W1jUncNCCyL_f2FvZvFcNS6ZH5UH1gBM>
#> With MIME type:
...
#>   <id: 1EHpma4W6FwbIjFdjKcVIG4zrg2gsrPzP>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1EHpma4… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1Kq4J0obbQE6FZIqGmHVR0Hg5kUy5D2Tw>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1n7GgYtDg9com6UVA752pabUiLVL6T-by>
#> • chicken-cp.txt <id: 1EHpma4W6FwbIjFdjKcVIG4zrg2gsrPzP>
#> • Copy of chicken.txt <id: 1Kq4J0obbQE6FZIqGmHVR0Hg5kUy5D2Tw>
#> • drive-cp-folder <id: 1W1jUncNCCyL_f2FvZvFcNS6ZH5UH1gBM>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1GKqPYHngbMvZyzGcue4qDc63V6apkeLYhTtxYZQKxjM>
