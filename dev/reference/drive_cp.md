...
#> Copied to file:
#> • Copy of chicken.txt <id: 14u04xyacFL2W3RtORXLAYMuCkh8TCQm8>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1wCkKgsvhiZS_yfgq43hZg26ToWRX288A>
#> With MIME type:
...
#>   <id: 1yZ6vtjCLctWl_cQpoOihqqev2_vwjRJQ>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1yZ6vtj… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 14CtgvbN3KEjKcLNwQIhyZHQ9up3qmqdg>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 14u04xyacFL2W3RtORXLAYMuCkh8TCQm8>
#> • chicken-cp.txt <id: 1yZ6vtjCLctWl_cQpoOihqqev2_vwjRJQ>
#> • Copy of chicken.txt <id: 14CtgvbN3KEjKcLNwQIhyZHQ9up3qmqdg>
#> • drive-cp-folder <id: 1wCkKgsvhiZS_yfgq43hZg26ToWRX288A>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1aBEDnnet4cU_fO0krKc3fwYuQYDM6n0ilYK4Omfxk08>
