...
#> Copied to file:
#> • Copy of chicken.txt <id: 1Ou-Yg7hS8bxzm-vW3xeWwRAN5N5O5ZZk>
...
#> Created Drive file:
#> • drive-cp-folder <id: 10OgYajXAUJLH7_kJA_8qfArs9RKhMNGK>
#> With MIME type:
...
#>   <id: 1DYQReQd2jwKbR1CVUKBilgfb8wfwqM6b>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1DYQReQ… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1MRDt7xOjd905xCBjolEfQKlGPTUefltI>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1Ou-Yg7hS8bxzm-vW3xeWwRAN5N5O5ZZk>
#> • chicken-cp.txt <id: 1DYQReQd2jwKbR1CVUKBilgfb8wfwqM6b>
#> • Copy of chicken.txt <id: 1MRDt7xOjd905xCBjolEfQKlGPTUefltI>
#> • drive-cp-folder <id: 10OgYajXAUJLH7_kJA_8qfArs9RKhMNGK>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1WcrE-sfTrww4bWAiqtOHDsNW8BNBl9KIUPg5F--hgrw>
