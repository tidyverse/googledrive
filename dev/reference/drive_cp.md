...
#> Copied to file:
#> • Copy of chicken.txt <id: 1jdADdb8iNJq68iU_oCbZwhGb7O5G_fLO>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1E4-wShSYxnskB8Ixnhv9okVZGSbQyS-R>
#> With MIME type:
...
#>   <id: 13_Pd51oCS257IDhVAfYx7pxE6CGNS9Ae>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    13_Pd51… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1oWXNehwHJMR5Ct7ryMUEbjxgXPcDzYy1>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1jdADdb8iNJq68iU_oCbZwhGb7O5G_fLO>
#> • chicken-cp.txt <id: 13_Pd51oCS257IDhVAfYx7pxE6CGNS9Ae>
#> • Copy of chicken.txt <id: 1oWXNehwHJMR5Ct7ryMUEbjxgXPcDzYy1>
#> • drive-cp-folder <id: 1E4-wShSYxnskB8Ixnhv9okVZGSbQyS-R>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1ZAl9m0i757vSfmaGpGIZfPCeWljvvli18F4c3k9x6U8>
