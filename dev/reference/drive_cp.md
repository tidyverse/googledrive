...
#> Copied to file:
#> • Copy of chicken.txt <id: 1IHhQgiANJAXGsHOzIfVYo2FDbCS-STUK>
...
#> Created Drive file:
#> • drive-cp-folder <id: 121Y6nlGLBVNtiMHo76VbYydEZG5Ftzx8>
#> With MIME type:
...
#>   <id: 1S67s8HNlov7lYxnYQrz1VT-KyxqhnaBf>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1S67s8H… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1j0r9nzQXb0OdLB-Ng7op8f3mc6J8ngV0>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1IHhQgiANJAXGsHOzIfVYo2FDbCS-STUK>
#> • chicken-cp.txt <id: 1S67s8HNlov7lYxnYQrz1VT-KyxqhnaBf>
#> • Copy of chicken.txt <id: 1j0r9nzQXb0OdLB-Ng7op8f3mc6J8ngV0>
#> • drive-cp-folder <id: 121Y6nlGLBVNtiMHo76VbYydEZG5Ftzx8>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1Y9DTTwVlCkPvrpum_A7giwBmvw8zt2pkNTJoEPBdeSY>
