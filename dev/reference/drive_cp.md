...
#> Copied to file:
#> • Copy of chicken.txt <id: 1HuyKkhS8-iNUlzJJqIDDpeYKk6yjioyR>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1RMkVvAZyYFnROz1bARJvhNA3AJGrCQcH>
#> With MIME type:
...
#>   <id: 1l3YRp3uaZQMuk5T10UWktn51ntSnAvqD>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1l3YRp3… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 154_xq1ez7Q9eCudraWMhDOAQX7V8og8n>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1HuyKkhS8-iNUlzJJqIDDpeYKk6yjioyR>
#> • chicken-cp.txt <id: 1l3YRp3uaZQMuk5T10UWktn51ntSnAvqD>
#> • Copy of chicken.txt <id: 154_xq1ez7Q9eCudraWMhDOAQX7V8og8n>
#> • drive-cp-folder <id: 1RMkVvAZyYFnROz1bARJvhNA3AJGrCQcH>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1_y50JOXhzUGoANNJqBYZjzoSoQFdYCpmINuAmRmygUI>
