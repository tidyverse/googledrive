...
#> Copied to file:
#> • Copy of chicken.txt <id: 1UQ0EGHLzMVEvKt1OrGuuYc6071RdI1fI>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1ezw-yV-xNqxWHFgUmDl5rk8a8yuFcV-1>
#> With MIME type:
...
#>   <id: 1wUiDSjgYj0QQlN7HyCiMxIYCl3IiC22q>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1wUiDSj… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1OpRWhgrATueXCKIveNXPByulc8n4WSTx>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1UQ0EGHLzMVEvKt1OrGuuYc6071RdI1fI>
#> • chicken-cp.txt <id: 1wUiDSjgYj0QQlN7HyCiMxIYCl3IiC22q>
#> • Copy of chicken.txt <id: 1OpRWhgrATueXCKIveNXPByulc8n4WSTx>
#> • drive-cp-folder <id: 1ezw-yV-xNqxWHFgUmDl5rk8a8yuFcV-1>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1R8Sza-rtJqJYsXmpRkFxvoCz_ibHV7n1E2b8JY-CHXg>
