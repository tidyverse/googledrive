...
#> Copied to file:
#> • Copy of chicken.txt <id: 1fMj4Re5bUZpZiFSx-bnaV5X0PuKKXe3K>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1PWtY2KJ72fxe8LPOO2oNZPVm4fLlNgXj>
#> With MIME type:
...
#>   <id: 1J2lnOBdST1xyrpRFe6f0RAzwS1dQSVWu>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1J2lnOB… <named list [43]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1YkRXSSw9Wi6qDeC_Hth5DbJwIbyLpunx>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1fMj4Re5bUZpZiFSx-bnaV5X0PuKKXe3K>
#> • chicken-cp.txt <id: 1J2lnOBdST1xyrpRFe6f0RAzwS1dQSVWu>
#> • Copy of chicken.txt <id: 1YkRXSSw9Wi6qDeC_Hth5DbJwIbyLpunx>
#> • drive-cp-folder <id: 1PWtY2KJ72fxe8LPOO2oNZPVm4fLlNgXj>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1JVAaXAFkYBEEl6xisGDbhWFckFYBx88qu8gU5OLPhAo>
