...
#> Copied to file:
#> • Copy of chicken.txt <id: 1BRZEU5IhQs_GjyprRsy_lUrGILLUdVjv>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1-RpMP9H7pZtPxd0jbq1VWpiqytIambT9>
#> With MIME type:
...
#>   <id: 1Hy4UuosFuU3oSGPQM6pis0Ndxgqg2fG->
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    1Hy4Uuo… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1-T0UdcCEgWWtiyJ8WRHRK8M3CuxHWh0I>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1BRZEU5IhQs_GjyprRsy_lUrGILLUdVjv>
#> • chicken-cp.txt <id: 1Hy4UuosFuU3oSGPQM6pis0Ndxgqg2fG->
#> • Copy of chicken.txt <id: 1-T0UdcCEgWWtiyJ8WRHRK8M3CuxHWh0I>
#> • drive-cp-folder <id: 1-RpMP9H7pZtPxd0jbq1VWpiqytIambT9>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 100SDbsfwb8SJq8-Z9pymwehS1E0ebZ3lrUErFaHUucE>
