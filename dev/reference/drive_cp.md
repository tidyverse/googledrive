...
#> Copied to file:
#> • Copy of chicken.txt <id: 1ST9oQPwIOprd3DpSAQuD8R_94KA5MM5t>
...
#> Created Drive file:
#> • drive-cp-folder <id: 1gu1QaM4_9l4BfMyyUYaM8AeCy8j4v67b>
#> With MIME type:
...
#>   <id: 12MFlXESic9eST-QM2IXvXCXTjWWXLBTb>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    12MFlXE… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 1XMxuZzu_-y1unzpEXxrCMZunrKHmBIm7>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1ST9oQPwIOprd3DpSAQuD8R_94KA5MM5t>
#> • chicken-cp.txt <id: 12MFlXESic9eST-QM2IXvXCXTjWWXLBTb>
#> • Copy of chicken.txt <id: 1XMxuZzu_-y1unzpEXxrCMZunrKHmBIm7>
#> • drive-cp-folder <id: 1gu1QaM4_9l4BfMyyUYaM8AeCy8j4v67b>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1XGO267nxudAVKm4_MYvNzeHoXnfCeChnvieLtSDhmK8>
