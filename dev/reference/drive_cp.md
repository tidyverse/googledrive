...
#> Copied to file:
#> • Copy of chicken.txt <id: 1Nahipgi3HX3G0cKih7zSqBivWSSbCpSp>
...
#> Created Drive file:
#> • drive-cp-folder <id: 14qbCD3QHRJoWgXb4de60k5w4sTZ2MQUT>
#> With MIME type:
...
#>   <id: 17ucXeGhZ3clMKZn1cAthxgY8XIn7CK0H>
drive_reveal(cp2, "starred")
#> # A dribble: 1 × 4
#>   name           starred id       drive_resource   
#>   <chr>          <lgl>   <drv_id> <list>           
#> 1 chicken-cp.txt TRUE    17ucXeG… <named list [44]>
...
#> • chicken.txt <id: 1wOLeWVRkTb6lDmLRiOhg9iKM7DlN762Y>
#> Copied to file:
#> • Copy of chicken.txt <id: 18EyIQrtHUb7E5Kgigto9wUlw9h12MGxn>

# Delete all of our copies and the new folder!
drive_rm(cp1, cp2, cp3, folder)
#> Files deleted:
#> • Copy of chicken.txt <id: 1Nahipgi3HX3G0cKih7zSqBivWSSbCpSp>
#> • chicken-cp.txt <id: 17ucXeGhZ3clMKZn1cAthxgY8XIn7CK0H>
#> • Copy of chicken.txt <id: 18EyIQrtHUb7E5Kgigto9wUlw9h12MGxn>
#> • drive-cp-folder <id: 14qbCD3QHRJoWgXb4de60k5w4sTZ2MQUT>
...
#> Copied to file:
#> • chicken-sheet-copy
#>   <id: 1mflBNt7dz1STmVJT9cfz5-H5yHszIlUmeHGu8mCF4g0>
