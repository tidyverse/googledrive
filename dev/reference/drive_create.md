...
#> Created Drive file:
#> • WordStar <id: 15HhGNu4Qiy_A-igZ9bXm9xC_QtTZ-np7u2xKVgF2xNM>
#> With MIME type:
...
#> Created Drive file:
#> • ExecuVision <id: 1cAJnbciq5cjxWToLkYNfVr8G6bxiNp_7mZu9KZBVPys>
#> With MIME type:
...
#> Created Drive file:
#> • b4xl <id: 1QpwuaPw_AImBygvOzvc6GOrnSce20BCn>
#> With MIME type:
#> • application/vnd.google-apps.folder
drive_create("VisiCalc", path = b4xl, type = "spreadsheet")
#> Created Drive file:
#> • VisiCalc <id: 1DgJKwG42Lz_FoVRVsc7hM_tkszCuKIeBYCKPS81FXnw>
#> With MIME type:
...
#> Created Drive file:
#> • SuperCalc <id: 1grLaIGichMtcn9XQgeIxLx8vVmTeEaDdC1HaM4d0aPo>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
...
#> Created Drive file:
#> • Lotus 1-2-3 <id: 1bYPPFXPDMpn4y7NFfOgwrSe4w_m1G4HQVe65xV8TLf0>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
...
#>   <chr>       <drv_id> <list>           
#> 1 Lotus 1-2-3 1bYPPFX… <named list [37]>
#> 2 SuperCalc   1grLaIG… <named list [38]>
#> 3 VisiCalc    1DgJKwG… <named list [38]>
...
#> • VisiCalc <id: 1DgJKwG42Lz_FoVRVsc7hM_tkszCuKIeBYCKPS81FXnw>
#> Created Drive file:
#> • VisiCalc <id: 19ISYp41w4gnhEsu4Te1K-3eMA53f8CS_>
#> With MIME type:
