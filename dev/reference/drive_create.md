...
#> Created Drive file:
#> • WordStar <id: 15_Muybh60fc3UynbI8Y15wLd9IYlO4BE7eb4trXYxn4>
#> With MIME type:
...
#> Created Drive file:
#> • ExecuVision <id: 1l_A4HeWeP6x-V_KjRiV5Gnh-VxVONDhe39mMTesqg7o>
#> With MIME type:
...
#> Created Drive file:
#> • b4xl <id: 1AICcg897zcNpTZHyNgMt3sGTsPUQGnjj>
#> With MIME type:
#> • application/vnd.google-apps.folder
drive_create("VisiCalc", path = b4xl, type = "spreadsheet")
#> Created Drive file:
#> • VisiCalc <id: 1ZhxfQiAuTCxxlLo_HhQsLLtsLeBXpUm3K2K7KlNBhO4>
#> With MIME type:
...
#> Created Drive file:
#> • SuperCalc <id: 1XPj3U5UPJ1kCleo5Bcv_2ECbi1B3oH07u_IPx8ve6x4>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
...
#> Created Drive file:
#> • Lotus 1-2-3 <id: 1W7A5yfzBEQykjyVlOYRaDSFbSEigiQtriz6W5qijKd0>
#> With MIME type:
#> • application/vnd.google-apps.spreadsheet
...
#>   <chr>       <drv_id> <list>           
#> 1 Lotus 1-2-3 1W7A5yf… <named list [38]>
#> 2 SuperCalc   1XPj3U5… <named list [38]>
#> 3 VisiCalc    1ZhxfQi… <named list [38]>
...
#> • VisiCalc <id: 1ZhxfQiAuTCxxlLo_HhQsLLtsLeBXpUm3K2K7KlNBhO4>
#> Created Drive file:
#> • VisiCalc <id: 1ebX7-mEoCViuZaFWO4l22_4n1TIIlqua>
#> With MIME type:
